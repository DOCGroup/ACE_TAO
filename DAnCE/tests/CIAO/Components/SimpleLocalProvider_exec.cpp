...
namespace CIAO_Simple_SimpleLocalProvider_Impl
{
  ...
  SimpleLocalProvider_exec_i::SimpleLocalProvider_exec_i (void)
    : triggered_ (false)
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::SimpleLocalProvider_exec_i (void)");
  }
  ...
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::get_trig ()");
  ...
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::set_session_context ()");
    this->context_ =
  ...
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::configuration_complete ()");
    // Your code here.
  }
  ...
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::ccm_activate ()");
    // Your code here.
  }
  ...
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::ccm_passivate ()");
    // Your code here.
  }
  ...
  {
    DANCE_TRACE ("SimpleLocalProvider_exec_i::ccm_remove ()");
    if (!triggered_)
  ...
  {
    DANCE_TRACE ("SimpleLocalProviderHome_exec_i::SimpleLocalProviderHome_exec_i (void)");
  }
  ...
  {
    DANCE_TRACE ("SimpleLocalProviderHome_exec_i::create ()");
  ...
  {
    DANCE_TRACE ("create_Simple_SimpleLocalProviderHome_Impl (void)");
