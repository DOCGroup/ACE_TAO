...
#if defined (ACE_AS_STATIC_LIBS) && !defined (INTERACTIVE_INPUT_ADAPTER_STUB_HAS_DLL)
#  define INTERACTIVE_INPUT_ADAPTER_STUB_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && INTERACTIVE_INPUT_ADAPTER_STUB_HAS_DLL */
