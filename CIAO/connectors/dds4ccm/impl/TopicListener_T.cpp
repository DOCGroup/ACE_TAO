...
CIAO::DDS4CCM::TopicListener_T<DDS_TYPE>::TopicListener_T (
...
template <typename DDS_TYPE>
CIAO::DDS4CCM::TopicListener_T<DDS_TYPE>::~TopicListener_T (void)
{
  DDS4CCM_TRACE ("CIAO::DDS4CCM::TopicListener_T::~TopicListener_T");
}
...
template <typename DDS_TYPE>
void
CIAO::DDS4CCM::TopicListener_T<DDS_TYPE>::on_inconsistent_topic (
...
template <typename DDS_TYPE>
::DDS::StatusMask
CIAO::DDS4CCM::TopicListener_T<DDS_TYPE>::get_mask (
  CCM_DDS::ConnectorStatusListener_ptr error_listener)
{
