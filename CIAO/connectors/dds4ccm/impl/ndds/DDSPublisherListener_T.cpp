...
namespace CIAO
{
  namespace DDS4CCM
  {
    ...
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::DDS_PublisherListener_T ( ::DDS::PublisherListener_ptr p)
      : impl_ (::DDS::PublisherListener::_duplicate (p))
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::DDS_PublisherListener_T");
    }

    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::~DDS_PublisherListener_T (void)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::~DDS_PublisherListener_T");
    }
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    ::DDS::DataWriter_ptr
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::get_datawriter_proxy (::DDSDataWriter * the_writer)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::get_datawriter_proxy");
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    void
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_offered_deadline_missed (
      ::DDSDataWriter* the_writer,
      const ::DDS_OfferedDeadlineMissedStatus & status)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_offered_deadline_missed");
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    void
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_offered_incompatible_qos (
      ::DDSDataWriter* the_writer,
      const ::DDS_OfferedIncompatibleQosStatus & status)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_offered_incompatible_qos");
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    void
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_liveliness_lost (
      ::DDSDataWriter* the_writer,
      const ::DDS_LivelinessLostStatus & status)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_liveliness_lost");
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    void
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_publication_matched (
      ::DDSDataWriter* the_writer,
      const ::DDS_PublicationMatchedStatus & status)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_publication_matched");
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    void
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_reliable_reader_activity_changed (
      ::DDSDataWriter *the_writer,
      const ::DDS_ReliableReaderActivityChangedStatus & status)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_reliable_reader_activity_changed");
    ...
    template <typename DDS_TYPE, DDS4CCM_Vendor VENDOR_TYPE>
    void
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_reliable_writer_cache_changed (
      ::DDSDataWriter* the_writer,
      const ::DDS_ReliableWriterCacheChangedStatus & status)
    {
      DDS4CCM_TRACE ("DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::on_reliable_writer_cache_changed");
    ...
    DDS_PublisherListener_T<DDS_TYPE, VENDOR_TYPE>::get_publisher_listener (void)
    {
