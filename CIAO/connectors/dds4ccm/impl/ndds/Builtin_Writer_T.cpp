  ...
  : impl_ (0)
{
  ...
  if (rdw == 0)
    {
      CIAO_ERROR ((LM_ERROR, CLINFO "CIAO::DDS4CCM::RTI::Builtin_Writer_T::Builtin_Writer_T - "
...
CIAO::DDS4CCM::RTI::Builtin_Writer_T<NDDS_TYPE, CCM_TYPE>::write (const typename NDDS_TYPE::value_type & an_instance)
{
  ...
  if (CORBA::is_nil (an_instance))
    {
      CIAO_DEBUG ((LM_TRACE, CLINFO "CIAO::DDS4CCM::RTI::Builtin_Writer_T::write - "
  ...
  */
  ...
  if (retval != DDS_RETCODE_OK)
    {
      CIAO_ERROR ((LM_ERROR, CLINFO "CIAO::DDS4CCM::RTI::Builtin_Writer_T::write - "
