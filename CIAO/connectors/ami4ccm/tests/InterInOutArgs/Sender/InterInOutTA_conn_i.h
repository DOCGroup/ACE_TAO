...
#ifndef CIAO_INTERINOUTTA_CONN_I_A9SI3Q_H_
#define CIAO_INTERINOUTTA_CONN_I_A9SI3Q_H_
...
namespace CIAO_InterInOutT_AMI4CCM_MyFoo_Connector_AMI4CCM_Connector_Impl
{
  ...
  class AMI4CCM_MyFooReplyHandler_i
    : public ::InterInOutT::AMI4CCM_MyFooReplyHandler
  {
  public:
