...
#ifndef CIAO_NOREPLYHA_CONN_I_TQ5EIR_H_
#define CIAO_NOREPLYHA_CONN_I_TQ5EIR_H_
...
namespace CIAO_NoReplyH_Sender_Impl
{
  ...
  class AMI4CCM_MyFooReplyHandler_i
    : public ::NoReplyH::AMI4CCM_MyFooReplyHandler
  {
  public:
    AMI4CCM_MyFooReplyHandler_i (Atomic_UShort &);
