...
namespace TSCE
{
  ...
  {
    Effector_Secondary_Context::Effector_Secondary_Context (
    ...
    Effector_Secondary_Context::~Effector_Secondary_Context (void)
    {
    }
    ...
    void
    Effector_Secondary_Context::push_status (
    ...
    ::Components::Cookie *
    Effector_Secondary_Context::subscribe_status (
    ...
    ::Components::Cookie *
    Effector_Secondary_Context::subscribe_status_generic (
    ...
    Effector_Secondary_Context::unsubscribe_status (
    ...
    Effector_Secondary_Context::get_connection_cuts_testing_service (
    ...
    void
    Effector_Secondary_Context::connect_cuts_testing_service (
    ...
    ::CUTS::Testing_Service_ptr
    Effector_Secondary_Context::disconnect_cuts_testing_service (
    ...
    Effector_Secondary_Context::_narrow (
      ::Components::SessionContext_ptr p
      ACE_ENV_ARG_DECL_NOT_USED)
    {
      return dynamic_cast<Effector_Secondary_Context *> (p);
    }

    Effector_Secondary_Servant::Effector_Secondary_Servant (
      ::TSCE::CCM_Effector_Secondary_ptr exe,
      ::Components::CCMHome_ptr h,
      const char *ins_name,
        ...
        ins_name_ (ins_name)
    {
      ACE_NEW (this->context_,
               Effector_Secondary_Context (h, c, this));
    ...
    Effector_Secondary_Servant::~Effector_Secondary_Servant (void)
    {
    }

    void
    Effector_Secondary_Servant::set_attributes (
    ...
    ::Components::Cookie *
    Effector_Secondary_Servant::subscribe_status (
      ::TSCE::Status_EventConsumer_ptr c
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
                     ::Components::ExceededConnectionLimit))
    ...
    ::Components::Cookie *
    Effector_Secondary_Servant::subscribe_status_generic (
      ::Components::EventConsumerBase_ptr c
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
                     ::Components::ExceededConnectionLimit))
    ...
    ::TSCE::Status_EventConsumer_ptr
    Effector_Secondary_Servant::unsubscribe_status (
      ::Components::Cookie *ck
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
                     ::Components::InvalidConnection))
    ...
    Effector_Secondary_Servant::Command_EventConsumer_command_Servant::Command_EventConsumer_command_Servant (
      ::TSCE::CCM_Effector_Secondary_ptr executor,
      ::TSCE::CCM_Effector_Secondary_Context_ptr c)
      : executor_ ( ::TSCE::CCM_Effector_Secondary::_duplicate (executor)),
        ctx_ ( ::TSCE::CCM_Effector_Secondary_Context::_duplicate (c))
    {
    }

    Effector_Secondary_Servant::Command_EventConsumer_command_Servant::~Command_EventConsumer_command_Servant (void)
    {
    }

    ::CORBA::Object_ptr
    Effector_Secondary_Servant::Command_EventConsumer_command_Servant::_get_component (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    void
    Effector_Secondary_Servant::Command_EventConsumer_command_Servant::push_Command_Event (
    ...
    void
    Effector_Secondary_Servant::Command_EventConsumer_command_Servant::push_event (
    ...
    CORBA::Boolean
    Effector_Secondary_Servant::Command_EventConsumer_command_Servant::ciao_is_substitutable (
    ...
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
      ...
      Effector_Secondary_Context *ctx =
        Effector_Secondary_Context::_narrow (
          this->ctx_.in ()
          ACE_ENV_ARG_PARAMETER);
    ...
    Effector_Secondary_Servant::get_consumer_command (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    Effector_Secondary_Servant::get_consumer_command_i (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
      ...
      Effector_Secondary_Servant::Command_EventConsumer_command_Servant,
      ::TSCE::CCM_Effector_Secondary,
      ::TSCE::CCM_Effector_Secondary_Context,
      Effector_Secondary_Servant > *tmp = 0;
    ...
    ::Components::Cookie *
    Effector_Secondary_Servant::connect (
      const char *name,
    ...
    ::CORBA::Object_ptr
    Effector_Secondary_Servant::disconnect (
      const char *name,
      ::Components::Cookie * ck
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
    ...
    Effector_Secondary_Servant::get_all_receptacles (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    void
    Effector_Secondary_Servant::connect_cuts_testing_service (
      ::CUTS::Testing_Service_ptr c
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
                     ::Components::AlreadyConnected,
    ...
    ::CUTS::Testing_Service_ptr
    Effector_Secondary_Servant::disconnect_cuts_testing_service (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
                     ::Components::NoConnection))
    {
    ...
    ::CUTS::Testing_Service_ptr
    Effector_Secondary_Servant::get_connection_cuts_testing_service (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    void
    Effector_Secondary_Servant::connect_consumer (
    ...
    ::Components::EventConsumerBase_ptr
    Effector_Secondary_Servant::disconnect_consumer (
    ...
    Effector_Secondary_Servant::get_all_publishers (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    Effector_Secondary_Servant::get_all_emitters (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    ::Components::Cookie *
    Effector_Secondary_Servant::subscribe (
    ...
    ::Components::EventConsumerBase_ptr
    Effector_Secondary_Servant::unsubscribe (
      const char *publisher_name,
      ::Components::Cookie *ck
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException,
    ...
    ::CORBA::Object_ptr
    Effector_Secondary_Servant::get_facet_executor (
      const char *name
      ACE_ENV_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    void
    Effector_Secondary_Servant::populate_port_tables (
      ACE_ENV_SINGLE_ARG_DECL)
    ACE_THROW_SPEC (( ::CORBA::SystemException))
    {
    ...
    Effector_Secondary_Factory_Servant::Effector_Secondary_Factory_Servant (
    ...
    Effector_Secondary_Factory_Servant::~Effector_Secondary_Factory_Servant (void)
    {
    }
      ...
      ACE_ENV_ARG_DECL)
    {
      ...
      ::TSCE::CCM_Effector_Secondary_Factory_var x =
      ::TSCE::CCM_Effector_Secondary_Factory::_narrow (
        p
        ACE_ENV_ARG_PARAMETER);
      ACE_CHECK_RETURN (0);
