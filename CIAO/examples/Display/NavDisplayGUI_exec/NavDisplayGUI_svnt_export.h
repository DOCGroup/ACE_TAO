...
#if defined (ACE_AS_STATIC_LIBS) && !defined (NAVDISPLAYGUI_SVNT_HAS_DLL)
#  define NAVDISPLAYGUI_SVNT_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && NAVDISPLAYGUI_SVNT_HAS_DLL */
