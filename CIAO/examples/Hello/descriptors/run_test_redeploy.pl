...
$E = $tg_executor->CreateProcess ("$DANCE_ROOT/bin/dance_plan_launcher",
                                  "-x $cdp_file -k file://$ior_emfile -l -o Hello");
...
print "Stopping initial deployment of the hellow application\n";

$E = $tg_executor->CreateProcess ("$DANCE_ROOT/bin/dance_plan_launcher",
                                  "-k file://$ior_emfile --stop-application -a file://Hello_Deployment_1_APP.ior -m file://Hello_Deployment_1_AM.ior");
$E->SpawnWaitKill (2*$tg_executor->ProcessStartWaitInterval ());

print "Starting second deployment of the hello application\n";

$E = $tg_executor->CreateProcess ("$DANCE_ROOT/bin/dance_plan_launcher",
                                  "-k file://$ior_emfile --start-application -u Hello_Deployment_1 -m file://Hello_Deployment_1_AM.ior");
$E->SpawnWaitKill (2*$tg_executor->ProcessStartWaitInterval ());
