...
namespace CIAO
{
  namespace RACE
  {
    ...
    {
      ImportanceBinPacker_Context::ImportanceBinPacker_Context (
      ...
      ImportanceBinPacker_Context::~ImportanceBinPacker_Context (void)
      {
      }
      ...
      ImportanceBinPacker_Context::get_connection_target_mgr (
      ...
      void
      ImportanceBinPacker_Context::connect_target_mgr (
      ...
      ::Deployment::TargetManager_ptr
      ImportanceBinPacker_Context::disconnect_target_mgr (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
      ...
      {
        return dynamic_cast<ImportanceBinPacker_Context *> (p);
      }

      ImportanceBinPacker_Servant::ImportanceBinPacker_Servant (
        ::CIAO::RACE::CCM_ImportanceBinPacker_ptr exe,
        ::Components::CCMHome_ptr h,
        const char *ins_name,
          ...
          ins_name_ (ins_name)
      {
        ACE_NEW (this->context_,
                 ImportanceBinPacker_Context (h, c, this));
      ...
      ImportanceBinPacker_Servant::~ImportanceBinPacker_Servant (void)
      {
      }

      void
      ImportanceBinPacker_Servant::set_attributes (
      ...
      ImportanceBinPacker_Servant::provide_planner_i (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::CORBA::Object_ptr
      ImportanceBinPacker_Servant::provide_planner_i_i (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::Components::Cookie *
      ImportanceBinPacker_Servant::connect (
        const char *name,
      ...
      ::CORBA::Object_ptr
      ImportanceBinPacker_Servant::disconnect (
        const char *name,
      ...
      ImportanceBinPacker_Servant::get_all_receptacles (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      ImportanceBinPacker_Servant::connect_target_mgr (
        ::Deployment::TargetManager_ptr c
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
                       ::Components::AlreadyConnected,
      ...
      ::Deployment::TargetManager_ptr
      ImportanceBinPacker_Servant::disconnect_target_mgr (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
                       ::Components::NoConnection))
      {
      ...
      ::Deployment::TargetManager_ptr
      ImportanceBinPacker_Servant::get_connection_target_mgr (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      ImportanceBinPacker_Servant::connect_consumer (
      ...
      ImportanceBinPacker_Servant::disconnect_consumer (
      ...
      ImportanceBinPacker_Servant::get_all_publishers (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ImportanceBinPacker_Servant::get_all_emitters (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::Components::Cookie *
      ImportanceBinPacker_Servant::subscribe (
      ...
      ::Components::EventConsumerBase_ptr
      ImportanceBinPacker_Servant::unsubscribe (
        const char *publisher_name,
        ::Components::Cookie *ck
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
      ...
      ::CORBA::Object_ptr
      ImportanceBinPacker_Servant::get_facet_executor (
        const char *name
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      char *
      ImportanceBinPacker_Servant::name (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
        return this->executor_->name (
      ...
      char *
      ImportanceBinPacker_Servant::type (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      ImportanceBinPacker_Servant::populate_port_tables (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ImportanceBinPacker_Home_Servant::ImportanceBinPacker_Home_Servant (
      ...
      ImportanceBinPacker_Home_Servant::~ImportanceBinPacker_Home_Servant (void)
      {
      }
        ...
        ACE_ENV_ARG_DECL)
      {
        ...
        ::CIAO::RACE::CCM_ImportanceBinPacker_Home_var x =
        ::CIAO::RACE::CCM_ImportanceBinPacker_Home::_narrow (
          p
          ACE_ENV_ARG_PARAMETER);
        ACE_CHECK_RETURN (0);
