...
namespace CIAO
{
  namespace RACE
  {
    ...
    {
      SimpleBinPacker_Context::SimpleBinPacker_Context (
      ...
      SimpleBinPacker_Context::~SimpleBinPacker_Context (void)
      {
      }
      ...
      SimpleBinPacker_Context::get_connection_target_mgr (
      ...
      void
      SimpleBinPacker_Context::connect_target_mgr (
      ...
      ::Deployment::TargetManager_ptr
      SimpleBinPacker_Context::disconnect_target_mgr (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
      ...
      {
        return dynamic_cast<SimpleBinPacker_Context *> (p);
      }

      SimpleBinPacker_Servant::SimpleBinPacker_Servant (
        ::CIAO::RACE::CCM_SimpleBinPacker_ptr exe,
        ::Components::CCMHome_ptr h,
        const char *ins_name,
          ...
          ins_name_ (ins_name)
      {
        ACE_NEW (this->context_,
                 SimpleBinPacker_Context (h, c, this));
      ...
      SimpleBinPacker_Servant::~SimpleBinPacker_Servant (void)
      {
      }

      void
      SimpleBinPacker_Servant::set_attributes (
      ...
      SimpleBinPacker_Servant::provide_planner_i (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::CORBA::Object_ptr
      SimpleBinPacker_Servant::provide_planner_i_i (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::Components::Cookie *
      SimpleBinPacker_Servant::connect (
        const char *name,
      ...
      ::CORBA::Object_ptr
      SimpleBinPacker_Servant::disconnect (
        const char *name,
      ...
      SimpleBinPacker_Servant::get_all_receptacles (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      SimpleBinPacker_Servant::connect_target_mgr (
        ::Deployment::TargetManager_ptr c
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
                       ::Components::AlreadyConnected,
      ...
      ::Deployment::TargetManager_ptr
      SimpleBinPacker_Servant::disconnect_target_mgr (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
                       ::Components::NoConnection))
      {
      ...
      ::Deployment::TargetManager_ptr
      SimpleBinPacker_Servant::get_connection_target_mgr (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      SimpleBinPacker_Servant::connect_consumer (
      ...
      SimpleBinPacker_Servant::disconnect_consumer (
      ...
      SimpleBinPacker_Servant::get_all_publishers (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      SimpleBinPacker_Servant::get_all_emitters (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::Components::Cookie *
      SimpleBinPacker_Servant::subscribe (
      ...
      ::Components::EventConsumerBase_ptr
      SimpleBinPacker_Servant::unsubscribe (
        const char *publisher_name,
        ::Components::Cookie *ck
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
      ...
      ::CORBA::Object_ptr
      SimpleBinPacker_Servant::get_facet_executor (
        const char *name
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      SimpleBinPacker_Servant::populate_port_tables (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      SimpleBinPacker_Home_Servant::SimpleBinPacker_Home_Servant (
      ...
      SimpleBinPacker_Home_Servant::~SimpleBinPacker_Home_Servant (void)
      {
      }
        ...
        ACE_ENV_ARG_DECL)
      {
        ...
        ::CIAO::RACE::CCM_SimpleBinPacker_Home_var x =
        ::CIAO::RACE::CCM_SimpleBinPacker_Home::_narrow (
          p
          ACE_ENV_ARG_PARAMETER);
        ACE_CHECK_RETURN (0);
