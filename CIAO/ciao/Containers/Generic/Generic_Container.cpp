...
#include "ciao/Containers/Generic/ClientContainerInterceptorRegistration_Impl.h"
#include "ciao/Containers/Generic/ServantContainerInterceptorRegistration_Impl.h"
#include "ciao/Containers/Generic/ServerContainerInterceptorRegistration_Impl.h"
#include "ciao/Containers/Generic/StubContainerInterceptorRegistration_Impl.h"
...
namespace CIAO
{
  ...
  Generic_Container_i::Generic_Container_i (
    ...
    : Container_i < ::CIAO::Generic_Container> (o, poa),
  ...
  Generic_Container_i::~Generic_Container_i (void)
  {
  }

  void
  Generic_Container_i::init (const char *name)
  {
    CIAO_TRACE ("Generic_Container_i::init");
    ...
    Container_i < ::CIAO::Generic_Container>::init (name);
  }

  void
  Generic_Container_i::fini (void)
  {
    CIAO_TRACE ("Generic_Container_i::fini");
    ...
    Container_i < ::CIAO::Generic_Container>::fini ();
  }
  ...
  Generic_Container_i::install_home (const char *primary_artifact,
                                     const char *entry_point,
                                     const char *servant_artifact,
                                     const char *servant_entrypoint,
                                     const char *name)
  {
    CIAO_TRACE ("Generic_Container_i::install_home");

    ACE_DLL executor_dll;
    ACE_DLL servant_dll;

    Container_i < ::CIAO::Generic_Container>::prepare_installation ("Generic Home",
                                                                    primary_artifact,
                                                                    entry_point,
                                                                    servant_artifact,
                                                                    servant_entrypoint,
    ...
    if (!hcreator)
      {
        CIAO_ERROR (1,
                    (LM_ERROR,
                     CLINFO
                     "Generic_Container_i::install_home "
                     "- Error: Entry point [%C] "
                     "invalid in dll [%C]\n",
                     entry_point,
                     primary_artifact));
  ...
  Generic_Container_i::install_component (const char *primary_artifact,
                                          const char *entry_point,
                                          const char *servant_artifact,
                                          const char *servant_entrypoint,
                                          const char *name)
  {
    CIAO_TRACE ("Generic_Container_i::install_component");

    ACE_DLL executor_dll;
    ACE_DLL servant_dll;

    Container_i < ::CIAO::Generic_Container>::prepare_installation ("Generic Component",
                                                                    primary_artifact,
                                                                    entry_point,
                                                                    servant_artifact,
                                                                    servant_entrypoint,
    ...
    if (ccreator == 0)
      {
        CIAO_ERROR (1,
                    (LM_ERROR,
                     CLINFO
                     "Generic_Container_i::install_component "
                     "- Error: Entry point [%C] "
                     "invalid in dll [%C]\n",
                     entry_point,
                     primary_artifact));
  ...
  Components::Cookie *
  Generic_Container_i::install_service_reference (const char * service_id,
                                                    CORBA::Object_ptr objref)
  {
    CIAO_TRACE ("Generic_Container_i::install_service_reference");
  ...
  CORBA::Object_ptr
  Generic_Container_i::uninstall_service_reference (Components::Cookie * ck)
  {
    CIAO_TRACE ("Generic_Container_i::uninstall_service_reference");
  ...
  CORBA::Object_ptr
  Generic_Container_i::resolve_service_reference (const char *service_id)
  {
    CIAO_TRACE ("Generic_Container_i::resolve_service_reference");
    //search
    ...
    return Container_i< CIAO::Generic_Container >::resolve_service_reference (service_id);
  }

  Components::ContainerPortableInterceptor::ClientContainerInterceptorRegistration_ptr
  Generic_Container_i::get_client_interceptor_registration (void)
  {
    CIAO_TRACE ("Generic_Container_i::get_client_interceptor_registration");
  ...
  Generic_Container_i::get_servant_interceptor_registration (void)
  {
    CIAO_TRACE ("Generic_Container_i::get_servant_interceptor_registration");
  ...
  Generic_Container_i::get_server_interceptor_registration (void)
  {
    CIAO_TRACE ("Generic_Container_i::get_server_interceptor_registration");
  ...
  Generic_Container_i::get_stub_interceptor_registration (void)
  {
    CIAO_TRACE ("Generic_Container_i::get_stub_interceptor_registration");
