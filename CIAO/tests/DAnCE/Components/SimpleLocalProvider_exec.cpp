...
namespace CIAO_Simple_SimpleLocalProvider_Impl
{
  ...
  SimpleLocalProvider_exec_i::SimpleLocalProvider_exec_i (void)
    : triggered_ (false)
  {
    ACE_TRACE ("SimpleLocalProvider_exec_i::SimpleLocalProvider_exec_i (void)");
  }
  ...
  {
    ACE_TRACE ("SimpleLocalProvider_exec_i::set_session_context ()");
    this->context_ =
  ...
  {
    ACE_TRACE ("SimpleLocalProvider_exec_i::configuration_complete ()");
    // Your code here.
  }
  ...
  {
    ACE_TRACE ("SimpleLocalProvider_exec_i::ccm_activate ()");
    // Your code here.
  }
  ...
  {
    ACE_TRACE ("SimpleLocalProvider_exec_i::ccm_passivate ()");
    // Your code here.
  }
  ...
  {
    ACE_TRACE ("SimpleLocalProvider_exec_i::ccm_remove ()");
    if (!triggered_)
  ...
  {
    ACE_TRACE ("SimpleLocalProviderHome_exec_i::SimpleLocalProviderHome_exec_i (void)");
  }
  ...
  {
    ACE_TRACE ("SimpleLocalProviderHome_exec_i::create ()");
  ...
  {
    ACE_TRACE ("create_Simple_SimpleLocalProviderHome_Impl (void)");
