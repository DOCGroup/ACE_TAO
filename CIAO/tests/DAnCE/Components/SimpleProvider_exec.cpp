...
namespace CIAO_Simple_SimpleProvider_Impl
{
  ...
  SimpleProvider_exec_i::SimpleProvider_exec_i (void)
    : triggered_ (false)
  {
    ACE_TRACE ("SimpleProvider_exec_i::SimpleProvider_exec_i (void)");
  }
  ...
  {
    ACE_TRACE ("SimpleProvider_exec_i::set_session_context ()");
    this->context_ =
  ...
  {
    ACE_TRACE ("SimpleProvider_exec_i::configuration_complete ()");
    // Your code here.
  }
  ...
  {
    ACE_TRACE ("SimpleProvider_exec_i::ccm_activate ()");
    // Your code here.
  }
  ...
  {
    ACE_TRACE ("SimpleProvider_exec_i::ccm_passivate ()");
    // Your code here.
  }
  ...
  {
    ACE_TRACE ("SimpleProviderHome_exec_i::SimpleProviderHome_exec_i (void)");
  }
  ...
  {
    ACE_TRACE ("SimpleProviderHome_exec_i::create ()");
  ...
  {
    ACE_TRACE ("create_Simple_SimpleProviderHome_Impl (void)");
