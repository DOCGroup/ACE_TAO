...
#ifndef CIAO_GLUE_SESSION_XML_OUTPUT_ADAPTER_SVNT_H
#define CIAO_GLUE_SESSION_XML_OUTPUT_ADAPTER_SVNT_H

#include /**/ "ace/pre.h"

#include "XML_Output_AdapterEC.h"
...
namespace CIAO
{
  namespace RACE
  {
    ...
    {
      class XML_Output_Adapter_Servant;

      class XML_OUTPUT_ADAPTER_SVNT_Export XML_Output_Adapter_Context
          ...
          >
      {
        ...
        friend class XML_Output_Adapter_Servant;
        ...
        virtual ~XML_Output_Adapter_Context (void);
        ...
        static XML_Output_Adapter_Context *
        _narrow (
      ...
      class XML_OUTPUT_ADAPTER_SVNT_Export XML_Output_Adapter_Servant
          ...
          >
      {
        ...
        typedef ::CIAO::RACE::CCM_XML_Output_Adapter _exec_type;

        XML_Output_Adapter_Servant (
          ::CIAO::RACE::CCM_XML_Output_Adapter_ptr executor,
          ::Components::CCMHome_ptr h,
          const char *ins_name,
        ...
        virtual ~XML_Output_Adapter_Servant (void);
      ...
      class XML_OUTPUT_ADAPTER_SVNT_Export XML_Output_Adapter_Home_Servant
        : public virtual
              ...
              >
      {
        ...
        virtual ~XML_Output_Adapter_Home_Servant (void);
...
#endif /* CIAO_GLUE_SESSION_XML_OUTPUT_ADAPTER_SVNT_H */
