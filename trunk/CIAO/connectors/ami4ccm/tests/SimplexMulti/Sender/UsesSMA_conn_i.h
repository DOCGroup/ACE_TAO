...
#ifndef CIAO_USESSMA_CONN_I_XFAJTT_H_
#define CIAO_USESSMA_CONN_I_XFAJTT_H_
...
namespace CIAO_UsesSM_AMI4CCM_One_Connector_AMI4CCM_Connector_Impl
{
  ...
  class AMI4CCM_OneReplyHandler_i
    : public ::UsesSM::AMI4CCM_OneReplyHandler
  {
  public:
...
namespace CIAO_UsesSM_AMI4CCM_Two_Connector_AMI4CCM_Connector_Impl
{
  ...
  class AMI4CCM_TwoReplyHandler_i
    : public ::UsesSM::AMI4CCM_TwoReplyHandler
  {
  public:
    AMI4CCM_TwoReplyHandler_i (Atomic_UShort  &nr_of_received);
