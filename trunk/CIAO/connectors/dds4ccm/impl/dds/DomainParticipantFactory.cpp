...
namespace CIAO
{
  namespace DDS4CCM
  {
    ...
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::CCM_DDS_DomainParticipantFactory_i (void)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::CCM_DDS_DomainParticipantFactory_i");
    }
    ...
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::create_participant (::DDS::DomainId_t domain_id,
                                                        const ::DDS::DomainParticipantQos & qos,
                                                        ::DDS::DomainParticipantListener_ptr a_listener,
                                                        ::DDS::StatusMask mask)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::create_participant");

#if (CIAO_DDS4CCM_NDDS==1)
      ACE_UNUSED_ARG (qos);

      DDS4CCM_DEBUG (9, (LM_TRACE, CLINFO "CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::create_participant - "
        ...
        if (!ccm_dds_dp)
          {
            ...
            if (!part)
              {
                DDS4CCM_ERROR (1, (LM_ERROR, CLINFO "CCM_DDS_DomainParticipantFactory_i"
          ...
          {
            DDS4CCM_DEBUG (6, (LM_DEBUG, CLINFO "CCM_DDS_DomainParticipantFactory_i"
                        "<DDS_TYPE, CCM_TYPE>::create_participant - "
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::DomainParticipant_ptr
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::create_participant_with_profile (
      ...
      ::DDS::StatusMask mask)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::"
                     "create_participant_with_profile");

      DDS4CCM_DEBUG (9, (LM_TRACE, CLINFO "CCM_DDS_DomainParticipantFactory_i"
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    bool
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::remove_participant (
      DomainParticipant_type * part)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::remove_participant");
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::ReturnCode_t
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::delete_participant (
      ::DDS::DomainParticipant_ptr a_participant)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::delete_participant");
      ...
      if (this->remove_participant (part))
        {
          ...
          else DDS4CCM_DEBUG (6, (LM_INFO, CLINFO "CCM_DDS_DomainParticipantFactory_i"
                            "<DDS_TYPE, CCM_TYPE>::delete_participant - "
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::DomainParticipant_ptr
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::lookup_participant (::DDS::DomainId_t domain_id)
    {
      ::DDS::DomainParticipant_var retval = ::DDS::DomainParticipant::_nil ();
#if (CIAO_DDS4CCM_NDDS==1)
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::ReturnCode_t
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::set_default_participant_qos (
      const ::DDS::DomainParticipantQos & qos)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::set_default_participant_qos");
#if (CIAO_DDS4CCM_NDDS==1)
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::ReturnCode_t
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::get_default_participant_qos (
      ::DDS::DomainParticipantQos & qos)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::get_default_participant_qos");
#if (CIAO_DDS4CCM_NDDS==1)
      DDS_DomainParticipantQos ccm_dds_qos;
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::ReturnCode_t
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::set_qos (
      const ::DDS::DomainParticipantFactoryQos & qos)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::set_qos");
#if (CIAO_DDS4CCM_NDDS==1)
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::ReturnCode_t
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::get_qos (
      ::DDS::DomainParticipantFactoryQos & qos)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::get_qos");
#if (CIAO_DDS4CCM_NDDS==1)
      DDS_DomainParticipantFactoryQos ccm_dds_qos;
      ::DDS::ReturnCode_t retcode =
    ...
    template <typename DDS_TYPE, typename CCM_TYPE>
    ::DDS::ReturnCode_t
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::set_default_participant_qos_with_profile (
                                                        const char * library_name,
                                                        const char * profile_name)
    {
      DDS4CCM_TRACE ("CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::"
    ...
    CCM_DDS_DomainParticipantFactory_i<DDS_TYPE, CCM_TYPE>::get_instance (void)
    {
      return 0;
    }
#endif
