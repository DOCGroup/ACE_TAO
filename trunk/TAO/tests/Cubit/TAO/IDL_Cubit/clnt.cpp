...
Cubit_Client::cube_union_stub (void)
{
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "from cube_union");
      this->error_count_++;
    }
  else
    {
...
Cubit_Client::cube_union_dii (void)
{
  ...
  if (this->env_.exception () != 0)
    {
      ...
      print_exception (this->env_.exception (), "cube_union_dii request create");
      return;
    }
  ...
  if (this->env_.exception () != 0)
    {
      this->error_count_++;
      print_exception (this->env_.exception (), "cube_union_dii request arg add");
      CORBA::release (req);
      return;
    }
  ...
  if (this->env_.exception () != 0)
    {
      this->error_count_++;
      print_exception (this->env_.exception (), "cube_union_dii result type");
      CORBA::release (req);
      return;
    }
...
Cubit_Client::cube_short (int i)
{
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (),
		       "from cube_short");
      this->error_count_++;
    }
  else
...
Cubit_Client::cube_octet (int i)
{
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "from cube_octet");
      this->error_count_++;
    }
  else
    {
...
Cubit_Client::cube_long (int i)
{
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "from cube_long");
      this->error_count_++;
    }
  else
    {
...
Cubit_Client::cube_struct (int i)
{
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "from cube_struct");
      this->error_count_++;
    }
  else
    {
...
Cubit_Client::cube_struct_dii (void)
{
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "DII request create");
      return;
    }
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "DII request arg add");
      CORBA::release (req);
      return;
    }
  ...
  if (this->env_.exception () != 0)
    {
      print_exception (this->env_.exception (), "DII request result type");
      CORBA::release (req);
      return;
    }
  ...
  if (req->env ()->exception () != 0)
    {
      print_exception (req->env ()->exception (), "DII invoke sending struct");
      CORBA::release (req);
      return;
    }
