...
// Since we don't yet have an interface repository or dynamic-Any, we just get
// the info from the IDL-generated files, since we're mainly interested in
// timing comparisons anyway.
...
class DII_Cubit_Client 
  ...
  //
  // = DESCRIPTION
  //    This class declares an interface to run the example client for a
