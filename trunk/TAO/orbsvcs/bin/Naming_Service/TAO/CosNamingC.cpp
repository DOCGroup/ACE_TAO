...
static CORBA::TypeCode _tc__tc_CosNaming_Istring (CORBA::tk_struct, sizeof (_oc_CosNaming_Istring), (unsigned char *) &_oc_CosNaming_Istring, CORBA::B_FALSE);
...
static CORBA::TypeCode _tc__tc_CosNaming_Name (CORBA::tk_struct, sizeof (_oc_CosNaming_Name), (unsigned char *) &_oc_CosNaming_Name, CORBA::B_FALSE);
...
static CORBA::TypeCode _tc__tc_CosNaming_BindingList (CORBA::tk_struct, sizeof (_oc_CosNaming_BindingList), (unsigned char *) &_oc_CosNaming_BindingList, CORBA::B_FALSE);
...
CosNaming::NamingContext_ptr CosNaming::NamingContext::_narrow (CORBA::Object_ptr obj)
{
...
CosNaming::NamingContext_ptr CosNaming::NamingContext::_bind (const char *host, CORBA::ULong port, const char *key, CORBA::Environment &env)
{
  CORBA::ORB_ptr orb = 0;
  CORBA::Object_ptr objref = CORBA::Object::_nil ();
  
  static char IOR [256];
  orb =  TAO_ORB_Core_instance ()->orb (); // access the ORB
  if (!orb) return CosNaming::NamingContext::_nil (); // return null obj
  
  ACE_OS::memset (IOR, '\0', 256);
  ACE_OS::sprintf (IOR, "iiop:1.0//%s:%d/%s", host, port, key);
  objref = orb->string_to_object (IOR, env);
  if (CORBA::is_nil (objref))
  	return CosNaming::NamingContext::_nil ();
  else // narrow it
  	return CosNaming::NamingContext::_narrow (objref);
  }
...
CosNaming::NamingContext_ptr  CosNaming::NamingContext::new_context (CORBA::Environment &env)
{
  ...
  return CosNaming::NamingContext::_narrow (retval);
  }
...
CosNaming::BindingIterator_ptr CosNaming::BindingIterator::_narrow (CORBA::Object_ptr obj)
{
  CORBA::Environment env;
...
CosNaming::BindingIterator_ptr CosNaming::BindingIterator::_bind (const char *host, CORBA::ULong port, const char *key, CORBA::Environment &env)
{
  CORBA::ORB_ptr orb = 0;
  CORBA::Object_ptr objref = CORBA::Object::_nil ();
  ...
  static char IOR [256];
  orb =  TAO_ORB_Core_instance ()->orb (); // access the ORB
  if (!orb) return CosNaming::BindingIterator::_nil (); // return null obj
  ...
  if (CORBA::is_nil (objref))
  	...
  	return CosNaming::BindingIterator::_narrow (objref);
  }
