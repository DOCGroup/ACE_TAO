...
IOP::TaggedComponent *
TAO_ClientRequest_Info::get_effective_component (
    IOP::ComponentId
...
CORBA::Policy_ptr
TAO_ClientRequest_Info::get_request_policy (
    CORBA::PolicyType
    TAO_ENV_ARG_DECL_NOT_USED)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
...
void
TAO_ClientRequest_Info::add_request_service_context (
...
// with the spec.
CORBA::Any *
TAO_ServerRequest_Info::sending_exception (
...
CORBA::OctetSeq *
TAO_ServerRequest_Info::object_id (
    TAO_ENV_SINGLE_ARG_DECL_NOT_USED)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  return 0;
...
CORBA::OctetSeq *
TAO_ServerRequest_Info::adapter_id (
    TAO_ENV_SINGLE_ARG_DECL_NOT_USED)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
 return 0;
...
char *
TAO_ServerRequest_Info::target_most_derived_interface (
    TAO_ENV_SINGLE_ARG_DECL_NOT_USED)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
 return 0;
...
void
TAO_ServerRequest_Info::set_slot (
...
void
TAO_ServerRequest_Info::add_reply_service_context (
    const IOP::ServiceContext & service_context,
    CORBA::Boolean
    TAO_ENV_ARG_DECL_NOT_USED)
  ACE_THROW_SPEC ((CORBA::SystemException))
