  ...
  while (arg_shifter.is_anything_left ())
    {
      ...
      if ((offset = arg_shifter.cur_arg_strncasecmp
	  ("-ORBSvcConf")) != -1)
        {
      ...
      else if ((offset = arg_shifter.cur_arg_strncasecmp
	       ("-ORBDaemon")) != -1)
        {
          // Be a daemon
          svc_config_argv[svc_config_argc++] =
