...
be_visitor_interface_ami_exception_holder_ch::be_visitor_interface_ami_exception_holder_ch (be_visitor_context *ctx)
  : be_visitor_interface (ctx)
{
}

be_visitor_interface_ami_exception_holder_ch::~be_visitor_interface_ami_exception_holder_ch (void)
{
}
