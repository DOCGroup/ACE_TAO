...
public:
  ...
  void register_name ();
  // after calling init(), this method will register the server 
  // with the TAO Naming  Service using the servant_name passed to init().
...
protected:
  ...
  // The ORB manager - a helper class for accessing the POA and registering 
  // objects.
