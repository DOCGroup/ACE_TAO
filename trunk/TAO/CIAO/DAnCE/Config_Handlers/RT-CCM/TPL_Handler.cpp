...
namespace CIAO
{
    ...
    {
      bool TPL_Handler::threadpool_with_lanes (
	    ...
	    ::CIAO::DAnCE::ORS_ThreadpoolWithLanes &dest)
	{
	    ...
	    for(ThreadpoolWithLanesDef::threadpoolLane_const_iterator loc = src.begin_threadpoolLane();
	    ...
	    const ::CIAO::DAnCE::ORS_ThreadpoolWithLanes &src)
	{
	    ...
	    {
              ThreadpoolLaneDef new_tplane (XMLSchema::unsignedLong  (src.threadpool_lanes[i].static_threads),
