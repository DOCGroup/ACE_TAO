...
#define FRAMEWORK_COMPONENT_DLL_LIB_NAME ACE_TEXT("Framework_Component_DLL")
#define FRAMEWORK_COMPONENT_DLL_DLL_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_DLL_SINGLETON_DECLARE(FRAMEWORK_COMPONENT_DLL_LIB_NAME, SINGLETON_TYPE, CLASS, LOCK)
