...
print "#      define $ucname"."_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)\n";
print "#    else\n";
...
print "#      define $ucname"."_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)\n";
print "#    endif /* $ucname"."_BUILD_DLL */\n";
print "#  else\n";
print "#    define $name"."_Export\n";
print "#    define $ucname"."_SINGLETON_DECLARATION(T)\n";
print "#    define $ucname"."_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)\n";
