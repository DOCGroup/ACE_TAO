...
#if defined (ACE_AS_STATIC_LIBS) && !defined (NAVDISPLAYGUI_EXEC_STUB_HAS_DLL)
#  define NAVDISPLAYGUI_EXEC_STUB_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && NAVDISPLAYGUI_EXEC_STUB_HAS_DLL */
