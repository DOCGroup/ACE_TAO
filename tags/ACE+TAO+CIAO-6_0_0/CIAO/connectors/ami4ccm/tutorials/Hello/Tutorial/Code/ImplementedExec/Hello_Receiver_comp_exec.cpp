...
{
  MyFoo_obj_exec_i::MyFoo_obj_exec_i (void)
  {
  }
  ...
  ::CORBA::Long
  MyFoo_obj_exec_i::foo (const char * in_str, ::CORBA::String_out answer)
  {
    /* Your code here. */
  ...
  void
  MyFoo_obj_exec_i::hello (::CORBA::Long_out answer)
  {
    /* Your code here. */
    ACE_OS::sleep (ACE_OS::rand () % 2);
  ...
  void
  MyFoo_obj_exec_i::rw_attrib (::CORBA::Short /*new_value*/)
  {
    /* Your code here.*/
  }

  CORBA::Short
  MyFoo_obj_exec_i::ro_attrib ()
  {
    /* Your code here. */
    return ACE_OS::rand () % 100;
  }
  ...
  {
    this->context_ = ::Hello::CCM_Receiver_comp_Context::_narrow (ctx);
