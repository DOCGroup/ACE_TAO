...
public:
  ...
  enum CG_STATE
  {
    ...
    TAO_AMI_HANDLER_OPERATION_COLLOCATED_ARG_UPCALL_SS, // Argument list for the upcall
    ...
    TAO_AMI_HANDLER_ARGUMENT_COLLOCATED_UPCALL_SS,
    ...
    TAO_AMI_EXCEPTION_HOLDER_INTERFACE_CH,
    TAO_AMI_EXCEPTION_HOLDER_INTERFACE_CI,
    TAO_AMI_EXCEPTION_HOLDER_INTERFACE_CS,
    TAO_AMI_EXCEPTION_HOLDER_ATTRIBUTE_CH,
