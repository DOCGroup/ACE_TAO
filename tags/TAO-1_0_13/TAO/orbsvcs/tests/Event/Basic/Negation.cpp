  ...
  ACE_TRY
    {
      ...
      first_supplier.connect (event_channel.in (),
                              milliseconds,
                              event_source,
                              event_type,
                              event_source,
      ...
      second_supplier.connect (event_channel.in (),
                               milliseconds,
                               event_source,
                               event_type + 1,
                               event_source,
      ...
      third_supplier.connect (event_channel.in (),
                              milliseconds,
                              event_source,
                              event_type + 1,
                              event_source,
      ...
      Consumer negation_consumer ("Consumer/negation");
      // Create a consumer, intialize its RT_Info structures, and
      // connnect to the event channel....
