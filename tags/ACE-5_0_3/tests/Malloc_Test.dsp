...
!MESSAGE "Malloc_Test - Win32 PharLap ETS Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "Malloc_Test - Win32 PharLap ETS Debug"
...
# ADD LINK32 acesd.lib /nologo /subsystem:console /debug /machine:I386 /out:"Malloc_Test_ETS.exe" /pdbtype:sept /libpath:"..\ace" /ETS:tests_pharlap_msvc.lnk
...
# Name "Malloc_Test - Win32 PharLap ETS Debug"
