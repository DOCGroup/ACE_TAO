...
#define __TAO_UNBOUNDED_SEQUENCE_TAO_SCIOPENDPOINTSEQUENCE_CI_
    ...
    : TAO_Unbounded_Base_Sequence (rhs)
  {
    if (rhs.buffer_ != 0)
    {
      ...
      TAO_SCIOP_Endpoint_Info * const tmp2 = reinterpret_cast<TAO_SCIOP_Endpoint_Info * ACE_CAST_CONST> (rhs.buffer_);
  ...
  // Assignment operator.
  {
    ...
    TAO_SCIOP_Endpoint_Info *tmp1 = reinterpret_cast<TAO_SCIOP_Endpoint_Info *> (this->buffer_);
    TAO_SCIOP_Endpoint_Info * const tmp2 = reinterpret_cast<TAO_SCIOP_Endpoint_Info * ACE_CAST_CONST> (rhs.buffer_);
  ...
  {
    ACE_ASSERT (i < this->maximum_);
    TAO_SCIOP_Endpoint_Info * const tmp = reinterpret_cast<TAO_SCIOP_Endpoint_Info* ACE_CAST_CONST> (this->buffer_);
    return tmp[i];
  }
  ...
  _TAO_Unbounded_Sequence_TAO_SCIOPEndpointSequence::get_buffer (CORBA::Boolean orphan)
  {
    ...
    if (orphan == 0)
    {
      ...
      {
        result = reinterpret_cast<TAO_SCIOP_Endpoint_Info*> (this->buffer_);
      }
    }
    else // if (orphan == 1)
    {
  ...
  {
    return reinterpret_cast<const TAO_SCIOP_Endpoint_Info * ACE_CAST_CONST> (this->buffer_);
  }
