...
#if !defined (_PORTABLEINTERCEPTOR_OCTETSEQ_CH_)
#define _PORTABLEINTERCEPTOR_OCTETSEQ_CH_
...
#if !defined (_PORTABLEINTERCEPTOR_OCTETSEQ___VAR_CH_)
#define _PORTABLEINTERCEPTOR_OCTETSEQ___VAR_CH_

  // *************************************************************
  // class PortableInterceptor::OctetSeq_var
  // *************************************************************
...
#if !defined (_PORTABLEINTERCEPTOR_OCTETSEQ___OUT_CH_)
#define _PORTABLEINTERCEPTOR_OCTETSEQ___OUT_CH_
...
#if !defined (_PORTABLEINTERCEPTOR_STRINGSEQ_CH_)
#define _PORTABLEINTERCEPTOR_STRINGSEQ_CH_
...
#if !defined (_PORTABLEINTERCEPTOR_STRINGSEQ___VAR_CH_)
#define _PORTABLEINTERCEPTOR_STRINGSEQ___VAR_CH_

  // *************************************************************
  // class PortableInterceptor::StringSeq_var
  // *************************************************************
...
#if !defined (_PORTABLEINTERCEPTOR_STRINGSEQ___OUT_CH_)
#define _PORTABLEINTERCEPTOR_STRINGSEQ___OUT_CH_
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO_DUPLICATENAME_CH_
  ...
  public:
    ...
    DuplicateName (void); // default ctor
    DuplicateName (const DuplicateName &); // copy ctor
    ~DuplicateName (void);
    static void _tao_any_destructor (void*);
...
TAO_Export void operator<<= (CORBA::Any &, const PortableInterceptor::OctetSeq &); // copying version
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::OctetSeq*); // noncopying version
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::OctetSeq *&); // deprecated
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::OctetSeq *&);
TAO_Export void operator<<= (CORBA::Any &, const PortableInterceptor::StringSeq &); // copying version
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::StringSeq*); // noncopying version
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::StringSeq *&); // deprecated
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::StringSeq *&);
extern TAO_Export PortableInterceptor::Interceptor_ptr (*_TAO_collocation_PortableInterceptor_Interceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
...
extern TAO_Export PortableInterceptor::Current_ptr (*_TAO_collocation_PortableInterceptor_Current_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::Current
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::Current_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::Current *&);
extern TAO_Export PortableInterceptor::RequestInfo_ptr (*_TAO_collocation_PortableInterceptor_RequestInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
...
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::RequestInfo *&);
extern TAO_Export PortableInterceptor::ClientRequestInfo_ptr (*_TAO_collocation_PortableInterceptor_ClientRequestInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ClientRequestInfo
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::ClientRequestInfo_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ClientRequestInfo *&);
extern TAO_Export PortableInterceptor::ServerRequestInfo_ptr (*_TAO_collocation_PortableInterceptor_ServerRequestInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ServerRequestInfo
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::ServerRequestInfo_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ServerRequestInfo *&);
extern TAO_Export PortableInterceptor::ClientRequestInterceptor_ptr (*_TAO_collocation_PortableInterceptor_ClientRequestInterceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
...
extern TAO_Export PortableInterceptor::ServerRequestInterceptor_ptr (*_TAO_collocation_PortableInterceptor_ServerRequestInterceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
...
extern TAO_Export PortableInterceptor::IORInfo_ptr (*_TAO_collocation_PortableInterceptor_IORInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::IORInfo
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::IORInfo_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::IORInfo *&);
extern TAO_Export PortableInterceptor::IORInterceptor_ptr (*_TAO_collocation_PortableInterceptor_IORInterceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::IORInterceptor
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::IORInterceptor_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::IORInterceptor *&);
extern TAO_Export PortableInterceptor::PolicyFactory_ptr (*_TAO_collocation_PortableInterceptor_PolicyFactory_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::PolicyFactory
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::PolicyFactory_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::PolicyFactory *&);
extern TAO_Export PortableInterceptor::ORBInitInfo_ptr (*_TAO_collocation_PortableInterceptor_ORBInitInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ORBInitInfo
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo *&);
...
extern TAO_Export PortableInterceptor::ORBInitializer_ptr (*_TAO_collocation_PortableInterceptor_ORBInitializer_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ORBInitializer
TAO_Export void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitializer_ptr);
TAO_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitializer *&);

#ifndef __ACE_INLINE__


#if !defined _TAO_CDR_OP_PortableInterceptor_OctetSeq_H_
#define _TAO_CDR_OP_PortableInterceptor_OctetSeq_H_
...
#endif /* _TAO_CDR_OP_PortableInterceptor_OctetSeq_H_ */


#if !defined _TAO_CDR_OP_PortableInterceptor_StringSeq_H_
#define _TAO_CDR_OP_PortableInterceptor_StringSeq_H_
...
#endif /* _TAO_CDR_OP_PortableInterceptor_StringSeq_H_ */

TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::Interceptor_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::Interceptor_ptr &);
...
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::Current_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::Current_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::RequestInfo_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::RequestInfo_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ClientRequestInfo_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ClientRequestInfo_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ServerRequestInfo_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ServerRequestInfo_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ClientRequestInterceptor_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ClientRequestInterceptor_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ServerRequestInterceptor_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ServerRequestInterceptor_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::IORInfo_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::IORInfo_ptr &);
...
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::PolicyFactory_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::PolicyFactory_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitInfo_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitInfo_ptr &);
TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitInfo::DuplicateName &);
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitInfo::DuplicateName &);

TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitInfo::InvalidName &);
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitInfo::InvalidName &);

TAO_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitializer_ptr );
TAO_Export CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitializer_ptr &);
