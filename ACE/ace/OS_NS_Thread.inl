...
#if !(defined (ACE_HAS_VXTHREADS) || (defined (INTEGRITY) && !defined (ACE_HAS_PTHREADS)))
ACE_INLINE int
...
#endif /* ! ((VXWORKS || INTEGRITY) && !ACE_HAS_PTHREADS)  */
...
# elif defined (ACE_HAS_PTHREADS) || defined (ACE_VXWORKS) || defined (INTEGRITY)
