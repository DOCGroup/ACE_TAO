...
#  endif
#  ifdef ACE_MONOTONIC_CONDITIONS
#    undef ACE_MONOTONIC_CONDITIONS
#  endif
#endif

#ifndef ACE_MONOTONIC_CONDITIONS
#  define ACE_MONOTONIC_TIME_CONDITIONS -1
#endif

#ifndef ACE_MONOTONIC_TIME_POLICY
#  if defined (ACE_HAS_CLOCK_GETTIME_MONOTONIC) && !defined (ACE_LACKS_CLOCK_MONOTONIC)
#    define ACE_MONOTONIC_TIME_POLICY 0
#  else
#    define ACE_MONOTONIC_TIME_POLICY -1
#  endif
#endif
