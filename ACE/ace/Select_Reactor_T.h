...
public:
   ...
   */
  int notify (ACE_Event_Handler * = nullptr,
  ...
  int owner (ACE_thread_t n_id, ACE_thread_t *o_id = nullptr) override;
  ...
  int handler (ACE_HANDLE handle,
                       ACE_Reactor_Mask mask,
                       ACE_Event_Handler **eh = nullptr) override;
  ...
  int handler (int signum,
                       ACE_Event_Handler ** = nullptr) override;
