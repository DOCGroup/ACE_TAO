...
ACE_RCSID(ace, SOCK_SCTP_STREAM_Acceptor, "SOCK_SCTP_STREAM_Acceptor.cpp,v 4.30 2002/03/08 23:18:09 spark Exp")

ACE_BEGIN_VERSIONED_NAMESPACE_DECL

ACE_ALLOC_HOOK_DEFINE(ACE_SOCK_SCTP_STREAM_Acceptor)

// Do nothing routine for constructor.

ACE_SOCK_SCTP_STREAM_Acceptor::ACE_SOCK_SCTP_STREAM_Acceptor (void)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::ACE_SOCK_SCTP_STREAM_Acceptor");
}

// Performs the timed accept operation.

int
ACE_SOCK_SCTP_STREAM_Acceptor::shared_accept_start (ACE_Time_Value *timeout,
                                        int restart,
                                        int &in_blocking_mode) const
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::shared_accept_start");
...
int
ACE_SOCK_SCTP_STREAM_Acceptor::shared_accept_finish (ACE_SOCK_SCTP_STREAM new_association,
                                         int in_blocking_mode,
                                         int reset_new_handle) const
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::shared_accept_finish ()");
...
int
ACE_SOCK_SCTP_STREAM_Acceptor::accept (ACE_SOCK_SCTP_STREAM &new_association,
                           ACE_Addr *remote_addr,
                           ACE_Time_Value *timeout,
                           int restart,
                           int reset_new_handle) const
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::accept");
...
void
ACE_SOCK_SCTP_STREAM_Acceptor::dump (void) const
{
#if defined (ACE_HAS_DUMP)
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::dump");
#endif /* ACE_HAS_DUMP */
}

int
ACE_SOCK_SCTP_STREAM_Acceptor::shared_open (const ACE_Addr &local_sap,
                                int protocol_family,
                                int backlog)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::shared_open");
  int error = 0;
...
int
ACE_SOCK_SCTP_STREAM_Acceptor::shared_open (const ACE_Multihomed_INET_Addr &local_sap,
                                        int protocol_family,
                                        int backlog)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::shared_open");
...
//  off, because this class, ACE_SOCK_SCTP_STREAM_Acceptor, is currently
...
int
ACE_SOCK_SCTP_STREAM_Acceptor::open (const ACE_Addr &local_sap,
                         ...
                         int protocol)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Acceptor::open");
...
ACE_SOCK_SCTP_STREAM_Acceptor::ACE_SOCK_SCTP_STREAM_Acceptor (const ACE_Addr &local_sap,
                                      ACE_Protocol_Info *protocolinfo,
                                      ACE_SOCK_GROUP g,
                                      u_long flags,
                                      int reuse_addr,
                                      ...
                                      int protocol)
{
  ...
  if (this->open (local_sap,
    ...
    ACE_ERROR ((LM_ERROR,
                ACE_LIB_TEXT ("%p\n"),
                ACE_LIB_TEXT ("ACE_SOCK_SCTP_STREAM_Acceptor")));
}
...
int
ACE_SOCK_SCTP_STREAM_Acceptor::open (const ACE_Multihomed_INET_Addr &local_sap,
                         int reuse_addr,
                         int protocol_family,
                         int backlog,
                         int protocol)
...
ACE_SOCK_SCTP_STREAM_Acceptor::ACE_SOCK_SCTP_STREAM_Acceptor (const ACE_Multihomed_INET_Addr &local_sap,
                                      int reuse_addr,
                                      int protocol_family,
                                      int backlog,
                                      int protocol)
...
int
ACE_SOCK_SCTP_STREAM_Acceptor::close (void)
{
