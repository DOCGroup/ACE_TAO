...
# something like this:
#
# find . -type f \( -name "*.inl" -o -name "*.h" -o -name "*.c"  -o -name "*.cpp" -o -name "*.mpc" -o -name "*.idl" -o -name "*.conf" -o -name "*.mpb" -o -name "*.hpp" -o -name "*.pl"  -o -name "*.mpt"   -o -name "*.pm" -o -name "*.html" \) -print | xargs $ACE_ROOT/bin/zap_svn_id.pl
