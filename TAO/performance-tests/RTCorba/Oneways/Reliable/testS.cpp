...
#ifndef _TAO_IDL_TESTS_LVGPDQ_CPP_
#define _TAO_IDL_TESTS_LVGPDQ_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"twoway_work_test", &POA_Test::twoway_work_test_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"oneway_work_test", &POA_Test::oneway_work_test_skel, 0},
      {"",0,0},{"",0,0},
      {"oneway_payload_test", &POA_Test::oneway_payload_test_skel, 0},
    };
...
class oneway_payload_test_Test
  : public TAO::Upcall_Command
{
public:
  inline oneway_payload_test_Test (
    POA_Test * servant,
  ...
  {
    TAO::SArg_Traits< ::Test::data>::in_arg_type arg_1 =
      TAO::Portable_Server::get_in_arg< ::Test::data> (
        this->operation_details_,
        this->args_,
        1);

    this->servant_->oneway_payload_test (
      arg_1);
  }
...
void POA_Test::oneway_payload_test_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  oneway_payload_test_Test command (
    impl,
...
class oneway_work_test_Test
  : public TAO::Upcall_Command
{
public:
  inline oneway_work_test_Test (
    POA_Test * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
  ...
  virtual void execute (void)
  {
    ...
    this->servant_->oneway_work_test (
      arg_1);
  }
...
void POA_Test::oneway_work_test_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
class twoway_work_test_Test
  : public TAO::Upcall_Command
{
public:
  inline twoway_work_test_Test (
    POA_Test * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
  ...
  virtual void execute (void)
  {
    ...
    this->servant_->twoway_work_test (
      arg_1);
  }
...
void POA_Test::twoway_work_test_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
