...
#ifndef _TAO_IDL_TESTC_58YXXQ_H_
#define _TAO_IDL_TESTC_58YXXQ_H_
...
#define _TEST_DATA_CH_
  ...
  virtual void oneway_payload_test (
    const ::Test::data & d);

  virtual void oneway_work_test (
    ::CORBA::ULong work);

  virtual void twoway_work_test (
    ::CORBA::ULong work);
