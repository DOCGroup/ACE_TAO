...
#ifndef _TAO_IDL_TESTS_7I4UIC_H_
#define _TAO_IDL_TESTS_7I4UIC_H_
...
public:
  ...
  static void oneway_payload_test_skel (
  ...
  static void oneway_work_test_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
  ...
  static void twoway_work_test_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
