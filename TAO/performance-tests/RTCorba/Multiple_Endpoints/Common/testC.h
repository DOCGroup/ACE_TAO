...
#ifndef _TAO_IDL_TESTC_16OLD4_H_
#define _TAO_IDL_TESTC_16OLD4_H_
...
#include /**/ "rtcorba_common_export.h"
#include "tao/ORB.h"
...
#endif
#define TAO_EXPORT_MACRO RTCORBA_COMMON_Export
...
class RTCORBA_COMMON_Export Test
...
#define _TEST__TRAITS_
  ...
  template<>
  struct RTCORBA_COMMON_Export Objref_Traits< ::Test>
  {
...
RTCORBA_COMMON_Export ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test_ptr );
RTCORBA_COMMON_Export ::CORBA::Boolean operator>> (TAO_InputCDR &, Test_ptr &);
