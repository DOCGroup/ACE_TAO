...
void
Test::Roundtrip::sendc_test_octet_method (
  ...
  ::Test::Timestamp send_time)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &Test::AMI_RoundtripHandler::test_octet_method_reply_stub
    );
}
...
void
Test::Roundtrip::sendc_test_long_method (
  ::Test::AMI_RoundtripHandler_ptr ami_handler,
  const ::Test::long_load & ol,
  ::Test::Timestamp send_time)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &Test::AMI_RoundtripHandler::test_long_method_reply_stub
    );
}
...
void
Test::Roundtrip::sendc_test_short_method (
  ::Test::AMI_RoundtripHandler_ptr ami_handler,
  const ::Test::short_load & ol,
  ::Test::Timestamp send_time)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &Test::AMI_RoundtripHandler::test_short_method_reply_stub
    );
}
...
void
Test::Roundtrip::sendc_test_char_method (
  ::Test::AMI_RoundtripHandler_ptr ami_handler,
  const ::Test::char_load & ol,
  ::Test::Timestamp send_time)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &Test::AMI_RoundtripHandler::test_char_method_reply_stub
    );
}
...
void
Test::Roundtrip::sendc_test_longlong_method (
  ::Test::AMI_RoundtripHandler_ptr ami_handler,
  const ::Test::longlong_load & ol,
  ::Test::Timestamp send_time)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &Test::AMI_RoundtripHandler::test_longlong_method_reply_stub
    );
}
...
void
Test::Roundtrip::sendc_test_double_method (
  ::Test::AMI_RoundtripHandler_ptr ami_handler,
  const ::Test::double_load & ol,
  ::Test::Timestamp send_time)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &Test::AMI_RoundtripHandler::test_double_method_reply_stub
    );
}
...
void
Test::AMI_RoundtripHandler::test_octet_method (
...
void
Test::AMI_RoundtripHandler::test_octet_method_excep (
...
void
Test::AMI_RoundtripHandler::test_long_method (
  ::Test::Timestamp ami_return_val)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_long_method_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_short_method (
  ::Test::Timestamp ami_return_val)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_short_method_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_char_method (
  ::Test::Timestamp ami_return_val)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_char_method_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_longlong_method (
  ::Test::Timestamp ami_return_val)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_longlong_method_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_double_method (
  ::Test::Timestamp ami_return_val)
{
  if (!this->is_evaluated ())
    {
...
void
Test::AMI_RoundtripHandler::test_double_method_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
