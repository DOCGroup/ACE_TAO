...
#ifndef _TAO_IDL_TESTC_TBOGF2_H_
#define _TAO_IDL_TESTC_TBOGF2_H_
...
#define _TEST_ROUNDTRIP__VAR_OUT_CH_
  ...
  public:
    ...
    virtual void sendc_test_octet_method (
      ::Test::AMI_RoundtripHandler_ptr ami_handler,
      const ::Test::octet_load & ol,
      ::Test::Timestamp send_time);

    virtual void sendc_test_long_method (
      ::Test::AMI_RoundtripHandler_ptr ami_handler,
      const ::Test::long_load & ol,
      ::Test::Timestamp send_time);

    virtual void sendc_test_short_method (
      ::Test::AMI_RoundtripHandler_ptr ami_handler,
      const ::Test::short_load & ol,
      ::Test::Timestamp send_time);

    virtual void sendc_test_char_method (
      ::Test::AMI_RoundtripHandler_ptr ami_handler,
      const ::Test::char_load & ol,
      ::Test::Timestamp send_time);

    virtual void sendc_test_longlong_method (
      ::Test::AMI_RoundtripHandler_ptr ami_handler,
      const ::Test::longlong_load & ol,
      ::Test::Timestamp send_time);

    virtual void sendc_test_double_method (
      ::Test::AMI_RoundtripHandler_ptr ami_handler,
      const ::Test::double_load & ol,
      ::Test::Timestamp send_time);
...
#define _TEST_AMI_ROUNDTRIPHANDLER__VAR_OUT_CH_
  ...
  public:
    ...
    static void
    test_octet_method_reply_stub (
      TAO_InputCDR &_tao_reply_cdr,
      ::Messaging::ReplyHandler_ptr _tao_reply_handler,
      ::CORBA::ULong reply_status);

    virtual void test_octet_method_excep (
    ...
    static void
    test_long_method_reply_stub (
      TAO_InputCDR &_tao_reply_cdr,
      ::Messaging::ReplyHandler_ptr _tao_reply_handler,
      ::CORBA::ULong reply_status);

    virtual void test_long_method_excep (
      ::Messaging::ExceptionHolder * excep_holder);
    ...
    static void
    test_short_method_reply_stub (
      TAO_InputCDR &_tao_reply_cdr,
      ::Messaging::ReplyHandler_ptr _tao_reply_handler,
      ::CORBA::ULong reply_status);

    virtual void test_short_method_excep (
      ::Messaging::ExceptionHolder * excep_holder);
    ...
    static void
    test_char_method_reply_stub (
      TAO_InputCDR &_tao_reply_cdr,
      ::Messaging::ReplyHandler_ptr _tao_reply_handler,
      ::CORBA::ULong reply_status);

    virtual void test_char_method_excep (
      ::Messaging::ExceptionHolder * excep_holder);
    ...
    static void
    test_longlong_method_reply_stub (
      TAO_InputCDR &_tao_reply_cdr,
      ::Messaging::ReplyHandler_ptr _tao_reply_handler,
      ::CORBA::ULong reply_status);

    virtual void test_longlong_method_excep (
      ::Messaging::ExceptionHolder * excep_holder);
    ...
    static void
    test_double_method_reply_stub (
      TAO_InputCDR &_tao_reply_cdr,
      ::Messaging::ReplyHandler_ptr _tao_reply_handler,
      ::CORBA::ULong reply_status);

    virtual void test_double_method_excep (
      ::Messaging::ExceptionHolder * excep_holder);
