...
#ifndef _TAO_IDL_TESTS_IOWTLF_H_
#define _TAO_IDL_TESTS_IOWTLF_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Test::octet_load>
    : public
  ...
  template<>
  class SArg_Traits< ::Test::long_load>
    : public
        Var_Size_SArg_Traits_T<
            ::Test::long_load,
            TAO::Any_Insert_Policy_Stream
  ...
  template<>
  class SArg_Traits< ::Test::char_load>
    : public
        Var_Size_SArg_Traits_T<
            ::Test::char_load,
            TAO::Any_Insert_Policy_Stream
  ...
  template<>
  class SArg_Traits< ::Test::short_load>
    : public
        Var_Size_SArg_Traits_T<
            ::Test::short_load,
            TAO::Any_Insert_Policy_Stream
  ...
  template<>
  class SArg_Traits< ::Test::longlong_load>
    : public
        Var_Size_SArg_Traits_T<
            ::Test::longlong_load,
            TAO::Any_Insert_Policy_Stream
  ...
  template<>
  class SArg_Traits< ::Test::double_load>
    : public
        Var_Size_SArg_Traits_T<
            ::Test::double_load,
            TAO::Any_Insert_Policy_Stream
...
namespace POA_Test
{
  ...
  public:
    ...
    static void test_octet_method_skel (
    ...
    static void test_long_method_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void test_short_method_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void test_char_method_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void test_longlong_method_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void test_double_method_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
