...
#ifndef _TAO_IDL_TESTS_AP5VOF_CPP_
#define _TAO_IDL_TESTS_AP5VOF_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"send_objref", &POA_Test::Memory_Growth::send_objref_skel, 0},
      {"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
...
namespace POA_Test
{
  ...
  class send_objref_Memory_Growth
    : public TAO::Upcall_Command
  {
  public:
    inline send_objref_Memory_Growth (
...
void POA_Test::Memory_Growth::send_objref_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Test::PayLoad>::in_arg_val _tao_p;
  ...
  send_objref_Memory_Growth command (
    impl,
