...
ACE_INLINE
void
TAO::Array_Traits<Param_Test::short32_forany>::free (
    Param_Test::short32_slice * _tao_slice)
{
  Param_Test::short32_free (_tao_slice);
}

ACE_INLINE
Param_Test::short32_slice *
TAO::Array_Traits<Param_Test::short32_forany>::dup (
    const Param_Test::short32_slice * _tao_slice)
{
  return Param_Test::short32_dup (_tao_slice);
}

ACE_INLINE
void
TAO::Array_Traits<Param_Test::short32_forany>::copy (
    Param_Test::short32_slice * _tao_to,
    const Param_Test::short32_slice * _tao_from)
{
  Param_Test::short32_copy (_tao_to, _tao_from);
}

ACE_INLINE
void
TAO::Array_Traits<Param_Test::short32_forany>::zero (
    Param_Test::short32_slice * _tao_slice)
{
  // Zero each individual element.
...
ACE_INLINE
Param_Test::short32_slice *
TAO::Array_Traits<Param_Test::short32_forany>::alloc (void)
{
  return Param_Test::short32_alloc ();
}
...
ACE_INLINE
void
Param_Test::Big_Union::another_array (Param_Test::short32 val)
{
  // Set the discriminant value.
  this->_reset ();
  this->disc_ = 3;
  // Set the value.
  this->u_.another_array_ = Param_Test::short32_dup (val);
}
...
ACE_INLINE
void
Param_Test::Big_Union::the_sequence (const Param_Test::Short_Seq &val)
{
  // Set the discriminant value.
  this->_reset ();
  this->disc_ = 5;
...
ACE_INLINE
void
Param_Test::nested_rec_union::nested_rec_member (const Param_Test::Nested_Rec_Seq &val)
{
  // Set the discriminant value.
  this->_reset ();
  this->disc_ = 1;
...
ACE_INLINE
void
Param_Test::Recursive_Union::rec_member (const Param_Test::Recursive_Union_Seq &val)
{
  // Set the discriminant value.
  this->_reset ();
  this->disc_ = 0;
  ACE_NEW (
      this->u_.rec_member_,
      Param_Test::Recursive_Union_Seq (val)
    );
}
