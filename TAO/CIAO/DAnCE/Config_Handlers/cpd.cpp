...
namespace Deployment
{
  ...
  referencedImplementation_ (new ::Deployment::ComponentImplementationDescription (referencedImplementation__)),
  regulator__ ()
  {
  ...
  PackagedComponentImplementation::
  PackagedComponentImplementation (::Deployment::PackagedComponentImplementation const& s)
  :
  name_ (new ::XMLSchema::string< char > (*s.name_)),
  referencedImplementation_ (new ::Deployment::ComponentImplementationDescription (*s.referencedImplementation_)),
  regulator__ ()
  {
    name_->container (this);
    referencedImplementation_->container (this);
  ...
  ::Deployment::PackagedComponentImplementation& PackagedComponentImplementation::
  operator= (::Deployment::PackagedComponentImplementation const& s)
  {
    name (s.name ());
  ...
  // PackagedComponentImplementation
  // 
  ::Deployment::ComponentImplementationDescription const& PackagedComponentImplementation::
  referencedImplementation () const
  {
    return *referencedImplementation_;
  }

  ::Deployment::ComponentImplementationDescription& PackagedComponentImplementation::
  ...
  void PackagedComponentImplementation::
  referencedImplementation (::Deployment::ComponentImplementationDescription const& e)
  {
  ...
  ComponentPackageDescription::
  ComponentPackageDescription (::Deployment::ComponentPackageDescription const& s)
  :
  label_ (s.label_.get () ? new ::XMLSchema::string< char > (*s.label_) : 0),
  UUID_ (s.UUID_.get () ? new ::XMLSchema::string< char > (*s.UUID_) : 0),
  realizes_ (s.realizes_.get () ? new ::Deployment::ComponentInterfaceDescription (*s.realizes_) : 0),
  configProperty_ (s.configProperty_.get () ? new ::Deployment::Property (*s.configProperty_) : 0),
  implementation_ (s.implementation_.get () ? new ::Deployment::PackagedComponentImplementation (*s.implementation_) : 0),
  ...
  ::Deployment::ComponentPackageDescription& ComponentPackageDescription::
  operator= (::Deployment::ComponentPackageDescription const& s)
  {
    ...
    else realizes_ = ::std::auto_ptr< ::Deployment::ComponentInterfaceDescription > (0);
    ...
    else implementation_ = ::std::auto_ptr< ::Deployment::PackagedComponentImplementation > (0);
  ...
  ::Deployment::ComponentInterfaceDescription const& ComponentPackageDescription::
  realizes () const
  {
    return *realizes_;
  }

  ::Deployment::ComponentInterfaceDescription& ComponentPackageDescription::
  realizes ()
  {
    return *realizes_;
  }
  ...
  ::Deployment::Property const& ComponentPackageDescription::
  configProperty () const
  {
    return *configProperty_;
  }

  ::Deployment::Property& ComponentPackageDescription::
  configProperty ()
  {
    return *configProperty_;
  }
  ...
  ::Deployment::PackagedComponentImplementation const& ComponentPackageDescription::
  implementation () const
  {
    return *implementation_;
  }

  ::Deployment::PackagedComponentImplementation& ComponentPackageDescription::
  implementation ()
  {
    return *implementation_;
  }
  ...
  void ComponentPackageDescription::
  implementation (::Deployment::PackagedComponentImplementation const& e)
  {
    ...
    {
      implementation_ = ::std::auto_ptr< ::Deployment::PackagedComponentImplementation > (new ::Deployment::PackagedComponentImplementation (e));
...
namespace Deployment
{
  ...
  :Base__ (e), regulator__ ()
  {
    ...
    while (p.more_elements ())
    {
      ...
      {
        referencedImplementation_ = ::std::auto_ptr< ::Deployment::ComponentImplementationDescription > (new ::Deployment::ComponentImplementationDescription (e));
        referencedImplementation_->container (this);
      }
  ...
  :Base__ (e), regulator__ ()
  {
    ...
    while (p.more_elements ())
    {
      ...
      {
        ::Deployment::PackagedComponentImplementation t (e);
        implementation (t);
      }
