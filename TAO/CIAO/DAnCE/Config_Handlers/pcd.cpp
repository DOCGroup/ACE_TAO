...
namespace Deployment
{
  ...
  PackageConfiguration::
  PackageConfiguration (::Deployment::PackageConfiguration const& s)
  :
  label_ (s.label_.get () ? new ::XMLSchema::string< char > (*s.label_) : 0),
  UUID_ (s.UUID_.get () ? new ::XMLSchema::string< char > (*s.UUID_) : 0),
  basePackage_ (s.basePackage_.get () ? new ::Deployment::ComponentPackageDescription (*s.basePackage_) : 0),
  ...
  ::Deployment::PackageConfiguration& PackageConfiguration::
  operator= (::Deployment::PackageConfiguration const& s)
  {
    ...
    else basePackage_ = ::std::auto_ptr< ::Deployment::ComponentPackageDescription > (0);
  ...
  ::Deployment::ComponentPackageDescription const& PackageConfiguration::
  basePackage () const
  {
    return *basePackage_;
  }

  ::Deployment::ComponentPackageDescription& PackageConfiguration::
  basePackage ()
  {
    return *basePackage_;
  }
  ...
  void PackageConfiguration::
  basePackage (::Deployment::ComponentPackageDescription const& e)
  {
    if (basePackage_.get ())
    {
      *basePackage_ = e;
    ...
    {
      basePackage_ = ::std::auto_ptr< ::Deployment::ComponentPackageDescription > (new ::Deployment::ComponentPackageDescription (e));
  ...
  ::Deployment::ComponentPackageReference const& PackageConfiguration::
  reference () const
  {
    return *reference_;
  }

  ::Deployment::ComponentPackageReference& PackageConfiguration::
  reference ()
  {
    return *reference_;
  }
  ...
  ::Deployment::Requirement const& PackageConfiguration::
  selectRequirement () const
  {
    return *selectRequirement_;
  }

  ::Deployment::Requirement& PackageConfiguration::
  selectRequirement ()
  {
    return *selectRequirement_;
  }
  ...
  ::Deployment::Property const& PackageConfiguration::
  configProperty () const
  {
    return *configProperty_;
  }

  ::Deployment::Property& PackageConfiguration::
  configProperty ()
  {
    return *configProperty_;
  }
...
namespace Deployment
{
  ...
  :Base__ (e), regulator__ ()
  {
    ...
    while (p.more_elements ())
    {
      ...
      {
        ::Deployment::ComponentPackageDescription t (e);
        basePackage (t);
      }
