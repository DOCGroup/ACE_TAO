...
//@@ This utility class is a copy of Config_Handler/XercesString.h
//   The implementation of Config_Handlers::XStr does not seem to
//   be compiled into the XSC_Config_Handlers, so i had to have
//   my own copy
...
namespace CIAO
{
  namespace Component_Packager
  {
    ...
    * @class XStr
    *
    * @brief facade to XMLString
    *
    * Utility class that provides a std::string like facade
    * to XMLString
    */
    class XStr
    {
