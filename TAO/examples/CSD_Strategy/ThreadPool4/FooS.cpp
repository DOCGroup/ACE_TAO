...
#ifndef _TAO_IDL_FOOS_09PVK7_CPP_
#define _TAO_IDL_FOOS_09PVK7_CPP_
...
public:
  ...
  virtual void execute (void)
  {
    TAO::SArg_Traits< ::TAO::Bounded_String20_20>::in_arg_type arg_1 =
      TAO::Portable_Server::get_in_arg< ::TAO::Bounded_String20_20> (
        this->operation_details_,
        this->args_,
        1);
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::TAO::Bounded_String20_20>::in_arg_val _tao_message;
