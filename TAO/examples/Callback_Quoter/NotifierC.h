...
#ifndef _TAO_IDL_NOTIFIERC_NTOSE0_H_
#define _TAO_IDL_NOTIFIERC_NTOSE0_H_
...
#if !defined (_NOTIFIER__VAR_OUT_CH_)
#define _NOTIFIER__VAR_OUT_CH_
...
#if !defined (_NOTIFIER__ARG_TRAITS_)
#define _NOTIFIER__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::Notifier>
    : public
        Object_Arg_Traits_T<
            ::Notifier_ptr,
            ::Notifier_var,
            ::Notifier_out,
            TAO::Objref_Traits<Notifier>,
...
#if !defined (_NOTIFIER__TRAITS_)
#define _NOTIFIER__TRAITS_

  template<>
  struct  Objref_Traits< ::Notifier>
  {
    static ::Notifier_ptr duplicate (
        ::Notifier_ptr p);
    static void release (
        ::Notifier_ptr p);
    static ::Notifier_ptr nil (void);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Notifier_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Notifier_ptr &);
