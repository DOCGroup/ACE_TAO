...
#ifndef _TAO_IDL_LOAD_BALANCERS_UZ4CWI_CPP_
#define _TAO_IDL_LOAD_BALANCERS_UZ4CWI_CPP_
  ...
  static const unsigned char asso_values[] =
    {
     ...
     29, 29, 29, 29, 29,  0, 29,  0, 29, 29,
      0,  5, 29, 29, 29, 29, 29, 29, 29,  0,
     10, 29, 29, 29,  0,  4, 10,  0, 29, 29,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"unbind_random", &POA_Load_Balancer::Object_Group_Factory::unbind_random_skel, 0},
      ...
      {"",0,0},
      {"unbind_round_robin", &POA_Load_Balancer::Object_Group_Factory::unbind_round_robin_skel, 0},
    };
...
namespace POA_Load_Balancer
{
  ...
  class unbind_round_robin_Object_Group_Factory
    : public TAO::Upcall_Command
  {
  public:
    inline unbind_round_robin_Object_Group_Factory (
      POA_Load_Balancer::Object_Group_Factory * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
    ...
    virtual void execute (void)
    {
      ...
      this->servant_->unbind_round_robin (
        arg_1);
    }
...
void POA_Load_Balancer::Object_Group_Factory::unbind_round_robin_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  unbind_round_robin_Object_Group_Factory command (
    impl,
    server_request.operation_details (),
    args);
...
namespace POA_Load_Balancer
{
  ...
  class unbind_random_Object_Group_Factory
    : public TAO::Upcall_Command
  {
  public:
    inline unbind_random_Object_Group_Factory (
      POA_Load_Balancer::Object_Group_Factory * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_Load_Balancer::Object_Group_Factory::unbind_random_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  unbind_random_Object_Group_Factory command (
    impl,
    server_request.operation_details (),
    args);
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::Load_Balancer::Member>::in_arg_val _tao_mem;
