...
#ifndef _TAO_IDL_LOAD_BALANCERS_CXJJDN_H_
#define _TAO_IDL_LOAD_BALANCERS_CXJJDN_H_
...
namespace POA_Load_Balancer
{
  ...
  public:
    ...
    virtual void unbind_round_robin (
      const char * id) = 0;

    static void unbind_round_robin_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    virtual void unbind_random (
      const char * id) = 0;

    static void unbind_random_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
  ...
  public:
    ...
    virtual void bind (
      const ::Load_Balancer::Member & mem) = 0;
