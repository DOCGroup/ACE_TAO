...
#ifndef _TAO_IDL_TESTS_GG1AFN_H_
#define _TAO_IDL_TESTS_GG1AFN_H_
...
public:
  ...
  virtual void sendCharSeq (
    const ::Char_Seq & charSeq) = 0;

  static void sendCharSeq_skel (
  ...
  virtual void sendOctetSeq (
    const ::Octet_Seq & charSeq) = 0;

  static void sendOctetSeq_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
