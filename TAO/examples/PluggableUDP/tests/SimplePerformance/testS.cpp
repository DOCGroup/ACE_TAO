...
#ifndef _TAO_IDL_TESTS_SSTODJ_CPP_
#define _TAO_IDL_TESTS_SSTODJ_CPP_
  ...
  static const unsigned char asso_values[] =
    {
     ...
     21, 21, 21, 21, 21,  0, 21,  0, 21, 21,
      0,  5, 21, 10, 21, 21, 21, 21, 21, 21,
      0, 21, 21,  0,  0,  0,  0, 21, 21, 21,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"sendCharSeq", &POA_Simple_Server::sendCharSeq_skel, 0},
      {"sendOctetSeq", &POA_Simple_Server::sendOctetSeq_skel, 0},
      {"_non_existent", &TAO_ServantBase::_non_existent_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"get_number", &POA_Simple_Server::get_number_skel, 0},
    };
...
class sendCharSeq_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline sendCharSeq_Simple_Server (
...
void POA_Simple_Server::sendCharSeq_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Char_Seq>::in_arg_val _tao_charSeq;
...
class sendOctetSeq_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline sendOctetSeq_Simple_Server (
    POA_Simple_Server * servant,
    TAO::Argument * const args[])
    : servant_ (servant)
      , args_ (args)
...
void POA_Simple_Server::sendOctetSeq_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::Octet_Seq>::in_arg_val _tao_charSeq;
...
class get_number_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline get_number_Simple_Server (
    POA_Simple_Server * servant,
    TAO::Argument * const args[])
    : servant_ (servant)
      , args_ (args)
...
void POA_Simple_Server::get_number_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_num;
