...
#ifndef _TAO_IDL_PUSH_WEB_SERVERC_SRZKKK_H_
#define _TAO_IDL_PUSH_WEB_SERVERC_SRZKKK_H_
...
#if !defined (_WEB_SERVER_CALLBACK__VAR_OUT_CH_)
#define _WEB_SERVER_CALLBACK__VAR_OUT_CH_
...
#if !defined (_WEB_SERVER_AMI_CALLBACKHANDLER__VAR_OUT_CH_)
#define _WEB_SERVER_AMI_CALLBACKHANDLER__VAR_OUT_CH_
  ...
  typedef
    TAO_Objref_Var_T<
        AMI_CallbackHandler
      >
    AMI_CallbackHandler_var;

  typedef
    TAO_Objref_Out_T<
        AMI_CallbackHandler
      >
    AMI_CallbackHandler_out;
  ...
  {
  public:
    friend class TAO::Narrow_Utils<AMI_CallbackHandler>;

    // TAO_IDL - Generated from
    // be/be_type.cpp:304

    typedef AMI_CallbackHandler_ptr _ptr_type;
    typedef AMI_CallbackHandler_var _var_type;
    typedef AMI_CallbackHandler_out _out_type;

    static void _tao_any_destructor (void *);

    // The static operations.
    static AMI_CallbackHandler_ptr _duplicate (AMI_CallbackHandler_ptr obj);

    static void _tao_release (AMI_CallbackHandler_ptr obj);

    static AMI_CallbackHandler_ptr _narrow (::CORBA::Object_ptr obj);
    static AMI_CallbackHandler_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
    static AMI_CallbackHandler_ptr _nil (void);
  ...
  private:
    // Private and unimplemented for concrete interfaces.
    AMI_CallbackHandler (const AMI_CallbackHandler &);

    void operator= (const AMI_CallbackHandler &);
  };

  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:34

  extern  ::CORBA::TypeCode_ptr const _tc_AMI_CallbackHandler;
...
#define _WEB_SERVER_ITERATOR_FACTORY__VAR_OUT_CH_
  ...
  public:
    ...
    virtual void sendc_register_callback (
...
#if !defined (_WEB_SERVER_CALLBACK__ARG_TRAITS_)
#define _WEB_SERVER_CALLBACK__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::Web_Server::Callback>
    : public
        Object_Arg_Traits_T<
            ::Web_Server::Callback_ptr,
            ::Web_Server::Callback_var,
            ::Web_Server::Callback_out,
            TAO::Objref_Traits<Web_Server::Callback>,
            TAO::Any_Insert_Policy_Stream
          >
  {
  };
...
#if !defined (_WEB_SERVER_AMI_CALLBACKHANDLER__ARG_TRAITS_)
#define _WEB_SERVER_AMI_CALLBACKHANDLER__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::Web_Server::AMI_CallbackHandler>
    : public
        Object_Arg_Traits_T<
            ::Web_Server::AMI_CallbackHandler_ptr,
            ::Web_Server::AMI_CallbackHandler_var,
            ::Web_Server::AMI_CallbackHandler_out,
            TAO::Objref_Traits<Web_Server::AMI_CallbackHandler>,
            TAO::Any_Insert_Policy_Stream
          >
  {
  };
...
#if !defined (_WEB_SERVER_CALLBACK__TRAITS_)
#define _WEB_SERVER_CALLBACK__TRAITS_

  template<>
  struct  Objref_Traits< ::Web_Server::Callback>
  {
    static ::Web_Server::Callback_ptr duplicate (
        ::Web_Server::Callback_ptr p);
    static void release (
        ::Web_Server::Callback_ptr p);
    static ::Web_Server::Callback_ptr nil (void);
...
#if !defined (_WEB_SERVER_AMI_CALLBACKHANDLER__TRAITS_)
#define _WEB_SERVER_AMI_CALLBACKHANDLER__TRAITS_

  template<>
  struct  Objref_Traits< ::Web_Server::AMI_CallbackHandler>
  {
    static ::Web_Server::AMI_CallbackHandler_ptr duplicate (
        ::Web_Server::AMI_CallbackHandler_ptr p);
    static void release (
        ::Web_Server::AMI_CallbackHandler_ptr p);
    static ::Web_Server::AMI_CallbackHandler_ptr nil (void);
    static ::CORBA::Boolean marshal (
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, Web_Server::Callback_ptr); // copying
 void operator<<= (::CORBA::Any &, Web_Server::Callback_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Web_Server::Callback_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
namespace Web_Server
{
   void operator<<= ( ::CORBA::Any &, AMI_CallbackHandler_ptr); // copying
   void operator<<= ( ::CORBA::Any &, AMI_CallbackHandler_ptr *); // non-copying
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, AMI_CallbackHandler_ptr &);
}
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, Web_Server::AMI_CallbackHandler_ptr); // copying
 void operator<<= (::CORBA::Any &, Web_Server::AMI_CallbackHandler_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Web_Server::AMI_CallbackHandler_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Web_Server::Callback_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Web_Server::Callback_ptr &);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Web_Server::AMI_CallbackHandler_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Web_Server::AMI_CallbackHandler_ptr &);
