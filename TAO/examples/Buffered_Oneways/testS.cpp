...
#ifndef _TAO_IDL_TESTS_BCG2YY_CPP_
#define _TAO_IDL_TESTS_BCG2YY_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::ULong>::in_arg_val _tao_request_number;
