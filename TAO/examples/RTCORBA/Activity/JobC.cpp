...
void
Job::_tao_any_destructor (void *_tao_void_pointer)
{
  Job *_tao_tmp_pointer =
    static_cast<Job *> (_tao_void_pointer);
...
::CORBA::TypeCode_ptr const _tc_Job =
  &_tao_tc_Job;
...
operator<<= (
    ...
    Job_ptr *_tao_elem)
{
  TAO::Any_Impl_T<Job>::insert (
      _tao_any,
      Job::_tao_any_destructor,
      _tc_Job,
      *_tao_elem);
}
