...
CORBA::Policy_ptr MIF_Sched_Param_Policy::copy ()
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  MIF_Sched_Param_Policy* tmp;
  ACE_NEW_THROW_EX (tmp, MIF_Sched_Param_Policy (*this),
...
void MIF_Sched_Param_Policy::destroy ()
  ACE_THROW_SPEC ((CORBA::SystemException))
{
}
