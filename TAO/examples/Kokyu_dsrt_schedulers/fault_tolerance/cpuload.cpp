...
//      if(iters%100000==0)
//	ACE_DEBUG((LM_DEBUG, "(%t|%T)I am now working in iter=%d, and exec_time=%d\n",iters, tv.tv_sec));
    }
}
...
void CPULoad::calibrate (int num_iters)
{
  ...
  ACE_DEBUG((LM_DEBUG,"calibrating ...\n"));
  ...
  ACE_DEBUG((LM_DEBUG,"calibration done and calibrated_loop_count is %d\n",calibrated_loop_count));
}
