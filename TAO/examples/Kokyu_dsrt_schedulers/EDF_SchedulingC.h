...
#ifndef _TAO_IDL_EDF_SCHEDULINGC_5IRUZD_H_
#define _TAO_IDL_EDF_SCHEDULINGC_5IRUZD_H_
...
#define _EDF_SCHEDULING_SCHEDULINGPARAMETERPOLICY__VAR_OUT_CH_
  ...
  public:
    ...
    virtual void value (
      const ::EDF_Scheduling::SchedulingParameter & value) = 0;
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::EDF_Scheduling::SchedulingParameter>
    : public
...
#if !defined (_EDF_SCHEDULING_SCHEDULINGPARAMETERPOLICY__TRAITS_)
#define _EDF_SCHEDULING_SCHEDULINGPARAMETERPOLICY__TRAITS_

  template<>
  struct Kokyu_DSRT_Schedulers_Export Objref_Traits< ::EDF_Scheduling::SchedulingParameterPolicy>
  {
    static ::EDF_Scheduling::SchedulingParameterPolicy_ptr duplicate (
        ::EDF_Scheduling::SchedulingParameterPolicy_ptr p);
    static void release (
        ::EDF_Scheduling::SchedulingParameterPolicy_ptr p);
    static ::EDF_Scheduling::SchedulingParameterPolicy_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::EDF_Scheduling::SchedulingParameterPolicy_ptr p,
        TAO_OutputCDR & cdr);
  };

#endif /* end #if !defined */

#if !defined (_EDF_SCHEDULING_SCHEDULER__TRAITS_)
#define _EDF_SCHEDULING_SCHEDULER__TRAITS_

  template<>
  struct Kokyu_DSRT_Schedulers_Export Objref_Traits< ::EDF_Scheduling::Scheduler>
  {
    static ::EDF_Scheduling::Scheduler_ptr duplicate (
        ::EDF_Scheduling::Scheduler_ptr p);
    static void release (
        ::EDF_Scheduling::Scheduler_ptr p);
    static ::EDF_Scheduling::Scheduler_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::EDF_Scheduling::Scheduler_ptr p,
        TAO_OutputCDR & cdr);
  };
