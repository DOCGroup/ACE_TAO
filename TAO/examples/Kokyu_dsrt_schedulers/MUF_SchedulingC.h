...
#ifndef _TAO_IDL_MUF_SCHEDULINGC_BUTAAJ_H_
#define _TAO_IDL_MUF_SCHEDULINGC_BUTAAJ_H_
...
#define _MUF_SCHEDULING_SCHEDULINGPARAMETERPOLICY__VAR_OUT_CH_
  ...
  public:
    ...
    virtual void value (
      const ::MUF_Scheduling::SchedulingParameter & value) = 0;
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::MUF_Scheduling::SchedulingParameter>
    : public
...
#if !defined (_MUF_SCHEDULING_SCHEDULINGPARAMETERPOLICY__TRAITS_)
#define _MUF_SCHEDULING_SCHEDULINGPARAMETERPOLICY__TRAITS_

  template<>
  struct Kokyu_DSRT_Schedulers_Export Objref_Traits< ::MUF_Scheduling::SchedulingParameterPolicy>
  {
    static ::MUF_Scheduling::SchedulingParameterPolicy_ptr duplicate (
        ::MUF_Scheduling::SchedulingParameterPolicy_ptr p);
    static void release (
        ::MUF_Scheduling::SchedulingParameterPolicy_ptr p);
    static ::MUF_Scheduling::SchedulingParameterPolicy_ptr nil (void);
...
#if !defined (_MUF_SCHEDULING_SCHEDULER__TRAITS_)
#define _MUF_SCHEDULING_SCHEDULER__TRAITS_

  template<>
  struct Kokyu_DSRT_Schedulers_Export Objref_Traits< ::MUF_Scheduling::Scheduler>
  {
    static ::MUF_Scheduling::Scheduler_ptr duplicate (
        ::MUF_Scheduling::Scheduler_ptr p);
    static void release (
        ::MUF_Scheduling::Scheduler_ptr p);
    static ::MUF_Scheduling::Scheduler_ptr nil (void);
    static ::CORBA::Boolean marshal (
