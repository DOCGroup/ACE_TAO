// $Id$
// Automatically generated header file "chain_dsui_families.h"  by dsui-parse.py 
#ifndef _chain_DSUI_FAMILIES_H
#define _chain_DSUI_FAMILIES_H

#define chain_NUM_FAMILIES 3
