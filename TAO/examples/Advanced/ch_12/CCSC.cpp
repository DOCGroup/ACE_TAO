...
CCS::Controller::DuplicateAsset::DuplicateAsset (void)
  : ::CORBA::UserException (
...
CCS::Controller::DuplicateAsset::DuplicateAsset (const ::CCS::Controller::DuplicateAsset &_tao_excp)
  : ::CORBA::UserException (
        _tao_excp._rep_id (),
        _tao_excp._name ()
      )
...
CCS::Controller::DuplicateAsset::operator= (const ::CCS::Controller::DuplicateAsset &_tao_excp)
{
  this->::CORBA::UserException::operator= (_tao_excp);
  return *this;
}
...
CCS::Controller::DuplicateAsset *
CCS::Controller::DuplicateAsset::_downcast ( ::CORBA::Exception *_tao_excp)
{
  return dynamic_cast<DuplicateAsset *> (_tao_excp);
}

const CCS::Controller::DuplicateAsset *
CCS::Controller::DuplicateAsset::_downcast ( ::CORBA::Exception const *_tao_excp)
{
  return dynamic_cast<const DuplicateAsset *> (_tao_excp);
}

::CORBA::Exception *CCS::Controller::DuplicateAsset::_alloc (void)
{
  ::CORBA::Exception *retval = 0;
  ACE_NEW_RETURN (retval, ::CCS::Controller::DuplicateAsset, 0);
  return retval;
}

::CORBA::Exception *
CCS::Controller::DuplicateAsset::_tao_duplicate (void) const
{
  ::CORBA::Exception *result = 0;
  ACE_NEW_RETURN (
      result,
      ::CCS::Controller::DuplicateAsset (*this),
      0
    );
  return result;
}

void CCS::Controller::DuplicateAsset::_raise (void) const
{
  throw *this;
}

void CCS::Controller::DuplicateAsset::_tao_encode (TAO_OutputCDR &cdr) const
{
  if (!(cdr << *this))
    {
      throw ::CORBA::MARSHAL ();
...
void CCS::Controller::DuplicateAsset::_tao_decode (TAO_InputCDR &cdr)
{
  if (!(cdr >> *this))
    {
      throw ::CORBA::MARSHAL ();
...
::CCS::Thermometer_ptr
CCS::Controller::create_thermometer (
  ::CCS::AssetType anum,
  const char * loc)
{
  if (!this->is_evaluated ())
  ...
  _tao_CCS_Controller_create_thermometer_exceptiondata [] = 
    {
      {
        "IDL:acme.com/CCS/Controller/DuplicateAsset:1.0",
        CCS::Controller::DuplicateAsset::_alloc
#if TAO_HAS_INTERCEPTORS == 1
        , 0
#endif /* TAO_HAS_INTERCEPTORS */
      }
...
::CCS::Thermostat_ptr
CCS::Controller::create_thermostat (
  ::CCS::AssetType anum,
  const char * loc,
  ::CCS::TempType temp)
{
  ...
  TAO::Arg_Traits< ::CORBA::ULong>::in_arg_val _tao_anum (anum);
  TAO::Arg_Traits< char *>::in_arg_val _tao_loc (loc);
  TAO::Arg_Traits< ::CORBA::Short>::in_arg_val _tao_temp (temp);
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const CCS::Controller::DuplicateAsset &_tao_aggregate
  )
{
