  ...
  ::CORBA::ULong request_number)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &AMI_testHandler::method_reply_stub
    );
}
  ...
  ::AMI_testHandler_ptr ami_handler)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &AMI_testHandler::shutdown_reply_stub
    );
}
  ...
  ::CORBA::ULong reply_status)
{
  ...
  switch (reply_status)
  {
    case TAO_AMI_REPLY_OK:
    {
      ...
      ::CORBA::ULong reply_number;      // Demarshall all the arguments.
      if (!(
...
void
AMI_testHandler::shutdown_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
