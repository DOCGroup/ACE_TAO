...
#ifndef _TAO_IDL_TESTS_5ZRS74_CPP_
#define _TAO_IDL_TESTS_5ZRS74_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::ULong>::out_arg_val _tao_reply_number;
...
/* C++ code produced by gperf version 2.8 (ACE version) */
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_AMI_testHandler_Perfect_Hash_OpTable -N lookup  */
unsigned int
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_is_a", &TAO_ServantBase::_is_a_thru_poa_skel, 0},
      {"",0,0},{"",0,0},
      {"shutdown", &POA_AMI_testHandler::shutdown_skel, 0},
      {"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"method", &POA_AMI_testHandler::method_skel, 0},
      {"method_excep", &POA_AMI_testHandler::method_excep_skel, 0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"shutdown_excep", &POA_AMI_testHandler::shutdown_excep_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
    };
...
POA_AMI_testHandler::POA_AMI_testHandler (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_AMI_testHandler_optable;
}
...
class method_AMI_testHandler
  : public TAO::Upcall_Command
{
public:
  inline method_AMI_testHandler (
...
void POA_AMI_testHandler::method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::CORBA::ULong>::in_arg_val _tao_reply_number;
  ...
  method_AMI_testHandler command (
    impl,
    server_request.operation_details (),
    args);
...
class method_excep_AMI_testHandler
  : public TAO::Upcall_Command
{
public:
  inline method_excep_AMI_testHandler (
    POA_AMI_testHandler * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_AMI_testHandler::method_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  method_excep_AMI_testHandler command (
    impl,
    server_request.operation_details (),
    args);
...
class shutdown_AMI_testHandler
  : public TAO::Upcall_Command
{
public:
  inline shutdown_AMI_testHandler (
    POA_AMI_testHandler * servant)
    : servant_ (servant)
  {
  }
...
void POA_AMI_testHandler::shutdown_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  shutdown_AMI_testHandler command (
    impl);
...
class shutdown_excep_AMI_testHandler
  : public TAO::Upcall_Command
{
public:
  inline shutdown_excep_AMI_testHandler (
    POA_AMI_testHandler * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_AMI_testHandler::shutdown_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  shutdown_excep_AMI_testHandler command (
    impl,
    server_request.operation_details (),
    args);
...
const char* POA_AMI_testHandler::_interface_repository_id (void) const
{
...
AMI_testHandler *
POA_AMI_testHandler::_this (void)
{
  TAO_Stub *stub = this->_create_stub ();
  ...
  typedef ::AMI_testHandler STUB_SCOPED_NAME;
  return
    TAO::Narrow_Utils<STUB_SCOPED_NAME>::unchecked_narrow (
        obj.in ());
}
