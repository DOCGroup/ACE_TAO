...
#ifndef _TAO_IDL_QUOTERS_5FMWTY_H_
#define _TAO_IDL_QUOTERS_5FMWTY_H_
...
#define _QUOTER_STOCK__SARG_TRAITS_
  ...
  template<>
  class SArg_Traits< ::Quoter::Stock::StockHistory>
    : public
...
namespace POA_Quoter
{
  ...
  public:
    ...
    virtual ::Quoter::Stock::StockHistory * history (
      void) = 0;

    static void history_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
  };
