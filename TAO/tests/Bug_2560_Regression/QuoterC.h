...
#ifndef _TAO_IDL_QUOTERC_MP8QGN_H_
#define _TAO_IDL_QUOTERC_MP8QGN_H_
...
#if !defined (_QUOTER_STOCK_STOCKHISTORY_CH_)
#define _QUOTER_STOCK_STOCKHISTORY_CH_
    ...
    public:
      StockHistory (void);
      StockHistory ( ::CORBA::ULong max);
      StockHistory (
        ::CORBA::ULong max,
        ::CORBA::ULong length,
        ::CORBA::Double* buffer,
        ::CORBA::Boolean release = false);
      StockHistory (const StockHistory &);
      virtual ~StockHistory (void);
      ...
      typedef StockHistory_var _var_type;
      typedef StockHistory_out _out_type;
    };
...
#define _QUOTER_STOCK__ARG_TRAITS_
  ...
  template<>
  class Arg_Traits< ::Quoter::Stock::StockHistory>
    : public
...
#if !defined _TAO_CDR_OP_Quoter_Stock_StockHistory_H_
#define _TAO_CDR_OP_Quoter_Stock_StockHistory_H_
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
...
#endif /* _TAO_CDR_OP_Quoter_Stock_StockHistory_H_ */
