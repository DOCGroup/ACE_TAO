...
#ifndef _TAO_IDL_QUOTERS_GBSYZ6_CPP_
#define _TAO_IDL_QUOTERS_GBSYZ6_CPP_
  ...
  static const unsigned char asso_values[] =
    {
     ...
     21, 21, 21, 21, 21,  0, 21, 15, 21, 21,
      5,  0, 21, 21,  0, 21, 21, 21,  0, 21,
     21, 21,  0, 21, 21, 21,  5, 21, 21, 21,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"history", &POA_Quoter::Stock::history_skel, 0},
      {"",0,0},{"",0,0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
...
namespace POA_Quoter
{
  ...
  public:
    ...
    virtual void execute (void)
    {
      TAO::SArg_Traits< ::Quoter::Stock::StockHistory>::ret_arg_type retval =
        TAO::Portable_Server::get_ret_arg< ::Quoter::Stock::StockHistory> (
          this->operation_details_,
          this->args_);

      retval =
        this->servant_->history ();
    }
...
void POA_Quoter::Stock::history_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Quoter::Stock::StockHistory>::ret_val retval;
