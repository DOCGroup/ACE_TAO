...
A::DidTheRightThing::DidTheRightThing (
    ::CORBA::Long _tao_id,
    const ::CORBA::WChar * _tao_whatDidTheRightThing)
  : ::CORBA::UserException (
...
{
  this->id = _tao_id;
  this->whatDidTheRightThing = ::CORBA::wstring_dup (_tao_whatDidTheRightThing);
}
      ...
      )
{
  ...
  this->whatDidTheRightThing = ::CORBA::wstring_dup (_tao_excp.whatDidTheRightThing.in ());
}
...
static TAO::TypeCode::Struct_Field<
  ...
  ::CORBA::TypeCode_ptr const *> const
    _tao_fields_A_DidTheRightThing[] =
      {
        { "id", &CORBA::_tc_long },
        { "whatDidTheRightThing", &CORBA::_tc_wstring }
      };
