...
#ifndef _TAO_IDL_TESTS_K4VBB0_H_
#define _TAO_IDL_TESTS_K4VBB0_H_
...
public:
  ...
  virtual void one_way (
    const char * message) = 0;

  static void one_way_skel (
  ...
  virtual char * two_way (
    const char * message) = 0;

  static void two_way_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
