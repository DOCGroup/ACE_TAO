  ...
  ::CORBA::Short sleep_sec)
{
  ...
  TAO::Arg_Traits< ::CORBA::Short>::in_arg_val _tao_sleep_sec (sleep_sec);
  ...
  ::CORBA::Long cl)
{
  ...
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_cl (cl);
