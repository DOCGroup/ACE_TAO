...
#ifndef _TAO_IDL_TESTS_BJS2LR_H_
#define _TAO_IDL_TESTS_BJS2LR_H_
...
namespace POA_Test
{
  ...
  public:
    ...
    static void _get_sleep_sec_skel (
    ...
    virtual void sleep_sec (
      ::CORBA::Short sleep_sec) = 0;

    static void _set_sleep_sec_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
