...
#ifndef _TAO_IDL_TESTC_TWIO6P_H_
#define _TAO_IDL_TESTC_TWIO6P_H_
...
#if !defined (_TEST_CLIENT__VAR_OUT_CH_)
#define _TEST_CLIENT__VAR_OUT_CH_
...
#if !defined (_TEST_CLIENT__ARG_TRAITS_)
#define _TEST_CLIENT__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::Test::Client>
    : public
        Object_Arg_Traits_T<
            ::Test::Client_ptr,
            ::Test::Client_var,
            ::Test::Client_out,
            TAO::Objref_Traits<Test::Client>,
...
#if !defined (_TEST_CLIENT__TRAITS_)
#define _TEST_CLIENT__TRAITS_

  template<>
  struct  Objref_Traits< ::Test::Client>
  {
    static ::Test::Client_ptr duplicate (
        ::Test::Client_ptr p);
    static void release (
        ::Test::Client_ptr p);
    static ::Test::Client_ptr nil (void);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Client_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Client_ptr &);
