...
#ifndef _TAO_IDL_TESTS_APVHOO_CPP_
#define _TAO_IDL_TESTS_APVHOO_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"test_op", &POA_test::test_op_skel, 0},
      {"",0,0},{"",0,0},
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::in_arg_val _tao_in_arg;
