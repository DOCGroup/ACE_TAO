...
#ifndef _TAO_IDL_TESTC_MW7FLO_H_
#define _TAO_IDL_TESTC_MW7FLO_H_
...
public:
  ...
  class  Failure : public ::CORBA::UserException
  {
  public:
    ...
    static Failure *_downcast ( ::CORBA::Exception *);
    static const Failure *_downcast ( ::CORBA::Exception const *);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Simple_Server::Failure &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Simple_Server::Failure &);
