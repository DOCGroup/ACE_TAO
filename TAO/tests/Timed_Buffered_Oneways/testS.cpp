...
#ifndef _TAO_IDL_TESTS_BOJ9LN_CPP_
#define _TAO_IDL_TESTS_BOJ9LN_CPP_
...
public:
  ...
  virtual void execute (void)
  {
    ...
    TAO::SArg_Traits< ::test::data>::in_arg_type arg_3 =
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_start_time;
