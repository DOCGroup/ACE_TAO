...
#ifndef _TAO_IDL_TESTS_GZH4VV_H_
#define _TAO_IDL_TESTS_GZH4VV_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Test::MyAttRefValEnum>
    : public
        Basic_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::Test::MyAttRef>
    : public
  ...
  template<>
  class SArg_Traits< ::Test::MyAttRef::MyAttRefValue>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::Test::MyAttRefSequence>
    : public
        Var_Size_SArg_Traits_T<
