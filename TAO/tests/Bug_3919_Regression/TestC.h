...
#ifndef _TAO_IDL_TESTC_EDFMDH_H_
#define _TAO_IDL_TESTC_EDFMDH_H_
...
namespace Test
{
  ...
  typedef MyAttRefValEnum &MyAttRefValEnum_out;

  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:34

  extern  ::CORBA::TypeCode_ptr const _tc_MyAttRefValEnum;
  ...
  struct  MyAttRef
  {
    ...
    public:
      MyAttRefValue (void);
      MyAttRefValue (const MyAttRefValue &);
      ~MyAttRefValue (void);

      MyAttRefValue &operator= (const MyAttRefValue &);

      // TAO_IDL - Generated from
      // be/be_visitor_union/discriminant_ch.cpp:67

      void _d (Test::MyAttRefValEnum);
      Test::MyAttRefValEnum _d (void) const;
      ...
      void attrValue (char *);
      void attrValue (const char *);
      void attrValue (const ::CORBA::String_var&);
      const char *attrValue (void) const;

      // TAO_IDL - Generated from
      // be/be_visitor_union_branch/public_ch.cpp:449

      void intValue ( ::CORBA::Long);
      ::CORBA::Long intValue (void) const;
...
#define _TEST_MYATTREF_MYATTREFVALUE__TAO_SEQ_TEST_MYATTREF__CH_
      ...
      {
      public:
        _tao_seq_Test_MyAttRef_ (void);
        _tao_seq_Test_MyAttRef_ ( ::CORBA::ULong max);
        _tao_seq_Test_MyAttRef_ (
          ::CORBA::ULong max,
          ::CORBA::ULong length,
      ...
      // TAO_IDL - Generated from
      // be/be_visitor_union_branch/public_ch.cpp:537

      typedef _tao_seq_Test_MyAttRef_ _compValue_seq;

      // TAO_IDL - Generated from
      // be/be_visitor_union_branch/public_ch.cpp:548

      void compValue (const _tao_seq_Test_MyAttRef_ &);
      const _tao_seq_Test_MyAttRef_ &compValue (void) const;
      _tao_seq_Test_MyAttRef_ &compValue (void);
    ...
    private:
      ...
      union
      {
        ...
        ::CORBA::Long intValue_;
        // TAO_IDL - Generated from
        // be/be_visitor_union_branch/private_ch.cpp:444
        _tao_seq_Test_MyAttRef_ *compValue_;
      } u_;
    ...
    static ::CORBA::TypeCode_ptr const _tc_MyAttRefValue;

    Test::MyAttRef::MyAttRefValue attRefValue;
  };

  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:34

  extern  ::CORBA::TypeCode_ptr const _tc_MyAttRef;

  // TAO_IDL - Generated from
  // be/be_visitor_sequence/sequence_ch.cpp:99

#if !defined (_TEST_MYATTREFSEQUENCE_CH_)
#define _TEST_MYATTREFSEQUENCE_CH_

  class MyAttRefSequence;

  typedef
    ::TAO_VarSeq_Var_T<
        MyAttRefSequence
      >
    MyAttRefSequence_var;

  typedef
    ::TAO_Seq_Out_T<
        MyAttRefSequence
      >
    MyAttRefSequence_out;
  ...
  {
  public:
    MyAttRefSequence (void);
    MyAttRefSequence ( ::CORBA::ULong max);
    MyAttRefSequence (
      ::CORBA::ULong max,
      ::CORBA::ULong length,
      MyAttRef* buffer,
  ...
  extern  ::CORBA::TypeCode_ptr const _tc_MyAttRefSequence;
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::Test::MyAttRefValEnum>
    : public
        Basic_Arg_Traits_T<
  ...
  template<>
  class Arg_Traits< ::Test::MyAttRef>
    : public
  ...
  template<>
  class Arg_Traits< ::Test::MyAttRef::MyAttRefValue>
    : public
        Var_Size_Arg_Traits_T<
  ...
  template<>
  class Arg_Traits< ::Test::MyAttRefSequence>
    : public
        Var_Size_Arg_Traits_T<
...
namespace Test
{
   void operator<<= (::CORBA::Any &, const ::Test::MyAttRef &); // copying version
   void operator<<= (::CORBA::Any &, ::Test::MyAttRef*); // noncopying version
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::Test::MyAttRef *&); // deprecated
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const ::Test::MyAttRef *&);
}
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, const Test::MyAttRef::MyAttRefValue &); // copying version
 void operator<<= (::CORBA::Any &, Test::MyAttRef::MyAttRefValue*); // noncopying version
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Test::MyAttRef::MyAttRefValue *&); // deprecated
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const Test::MyAttRef::MyAttRefValue *&);
TAO_END_VERSIONED_NAMESPACE_DECL
...
namespace Test
{
   void operator<<= ( ::CORBA::Any &, const ::Test::MyAttRefSequence &); // copying version
   void operator<<= ( ::CORBA::Any &, ::Test::MyAttRefSequence*); // noncopying version
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::Test::MyAttRefSequence *&); // deprecated
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const ::Test::MyAttRefSequence *&);
}
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::MyAttRef &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::MyAttRef &);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::MyAttRef::MyAttRefValue &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::MyAttRef::MyAttRefValue &);
...
#if !defined _TAO_CDR_OP_Test_MyAttRef_MyAttRefValue__tao_seq_Test_MyAttRef__H_
#define _TAO_CDR_OP_Test_MyAttRef_MyAttRefValue__tao_seq_Test_MyAttRef__H_
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
...
#endif /* _TAO_CDR_OP_Test_MyAttRef_MyAttRefValue__tao_seq_Test_MyAttRef__H_ */

// TAO_IDL - Generated from
// be/be_visitor_sequence/cdr_op_ch.cpp:65

#if !defined _TAO_CDR_OP_Test_MyAttRefSequence_H_
#define _TAO_CDR_OP_Test_MyAttRefSequence_H_
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
...
#endif /* _TAO_CDR_OP_Test_MyAttRefSequence_H_ */
