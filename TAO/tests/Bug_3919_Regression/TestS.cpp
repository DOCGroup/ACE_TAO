...
#ifndef _TAO_IDL_TESTS_6PXY1K_CPP_
#define _TAO_IDL_TESTS_6PXY1K_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"get_any", &POA_Test::Hello::get_any_skel, 0},
...
void POA_Test::Hello::get_any_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Any>::in_arg_val _tao_the_any;
