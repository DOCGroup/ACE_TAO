...
#ifndef _TAO_IDL_TESTS_VNXNQV_CPP_
#define _TAO_IDL_TESTS_VNXNQV_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"send_stuff", &POA_test::send_stuff_skel, 0},
...
class send_stuff_test
  : public TAO::Upcall_Command
{
public:
  inline send_stuff_test (
    POA_test * servant,
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::in_arg_val _tao_foo;
