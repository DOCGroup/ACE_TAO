...
#ifndef _TAO_IDL_ABS_RCRD84_CPP_
#define _TAO_IDL_ABS_RCRD84_CPP_
...
public:
  ...
  {
    TAO::SArg_Traits< ::A>::ret_arg_type retval =
      TAO::Portable_Server::get_ret_arg< ::A> (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::A>::ret_val retval;
