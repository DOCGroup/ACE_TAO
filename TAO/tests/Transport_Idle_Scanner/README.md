...
Each thread-lane cache owns one scanner timer, takes a referenced transport
snapshot, and makes a nonblocking attempt to acquire each transport's output lock.
