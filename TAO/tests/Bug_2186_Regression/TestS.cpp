...
#ifndef _TAO_IDL_TESTS_URPY68_CPP_
#define _TAO_IDL_TESTS_URPY68_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"request_callback", &POA_Test::Hello::request_callback_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
...
namespace POA_Test
{
  ...
  class request_callback_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline request_callback_Hello (
      POA_Test::Hello * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
    ...
    virtual void execute (void)
    {
      ...
      this->servant_->request_callback (
        arg_1);
    }
...
void POA_Test::Hello::request_callback_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::Test::Hello>::in_arg_val _tao_call_me;
  ...
  request_callback_Hello command (
    impl,
    server_request.operation_details (),
    args);
