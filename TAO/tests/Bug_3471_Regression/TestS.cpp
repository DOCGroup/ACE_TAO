...
#ifndef _TAO_IDL_TESTS_TGJMBS_CPP_
#define _TAO_IDL_TESTS_TGJMBS_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_objects", &POA_Test::Hello::get_objects_skel, 0},
      {"",0,0},
...
namespace POA_Test
{
  ...
  class get_objects_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline get_objects_Hello (
    ...
    {
      TAO::SArg_Traits< ::Test::ObjectSeq>::ret_arg_type retval =
        static_cast<TAO::SArg_Traits< ::Test::ObjectSeq>::ret_val *> (this->args_[0])->arg ();

      retval =
        this->servant_->get_objects ();
    }
...
void POA_Test::Hello::get_objects_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Test::ObjectSeq>::ret_val retval;
