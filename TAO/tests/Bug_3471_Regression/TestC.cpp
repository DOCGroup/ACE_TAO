...
#if !defined (_TEST_OBJECTSEQ_CS_)
#define _TEST_OBJECTSEQ_CS_

Test::ObjectSeq::ObjectSeq (void)
{}

Test::ObjectSeq::ObjectSeq (
    ::CORBA::ULong max)
  ...
  void)
{
  ...
  TAO::Arg_Traits< ::Test::ObjectSeq>::ret_val _tao_retval;
...
#if !defined _TAO_CDR_OP_Test_ObjectSeq_CPP_
#define _TAO_CDR_OP_Test_ObjectSeq_CPP_
...
#endif /* _TAO_CDR_OP_Test_ObjectSeq_CPP_ */
