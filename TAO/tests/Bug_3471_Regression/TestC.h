...
#ifndef _TAO_IDL_TESTC_FAEVIE_H_
#define _TAO_IDL_TESTC_FAEVIE_H_
...
#if !defined (_TEST_OBJECTSEQ_CH_)
#define _TEST_OBJECTSEQ_CH_
  ...
  public:
    ...
    ObjectSeq (const ObjectSeq &);
    virtual ~ObjectSeq (void);
    ...
    typedef ObjectSeq_var _var_type;
    typedef ObjectSeq_out _out_type;
  };
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::Test::ObjectSeq>
    : public
...
#if !defined _TAO_CDR_OP_Test_ObjectSeq_H_
#define _TAO_CDR_OP_Test_ObjectSeq_H_
TAO_BEGIN_VERSIONED_NAMESPACE_DECL


 ::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const Test::ObjectSeq &_tao_sequence);
 ::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    Test::ObjectSeq &_tao_sequence);

TAO_END_VERSIONED_NAMESPACE_DECL



#endif /* _TAO_CDR_OP_Test_ObjectSeq_H_ */
