...
#ifndef _TAO_IDL_TESTS_E08GFM_CPP_
#define _TAO_IDL_TESTS_E08GFM_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"callback_method", &POA_Callback::callback_method_skel, 0},
    };
...
class callback_method_Callback
  : public TAO::Upcall_Command
{
public:
  inline callback_method_Callback (
    POA_Callback * servant)
    : servant_ (servant)
  {
  }
...
void POA_Callback::callback_method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"callback_object", &POA_Simple_Server::callback_object_skel, 0},
    };
...
class callback_object_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline callback_object_Simple_Server (
    POA_Simple_Server * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_Simple_Server::callback_object_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  callback_object_Simple_Server command (
    impl,
    server_request.operation_details (),
    args);
