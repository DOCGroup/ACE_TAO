...
#ifndef _TAO_IDL_TESTS_LD8BBJ_CPP_
#define _TAO_IDL_TESTS_LD8BBJ_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"system_exception_test", &POA_Test::Hello::system_exception_test_skel, 0},
      {"",0,0},
      {"user_exception_expected", &POA_Test::Hello::user_exception_expected_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"user_exception_not_expected", &POA_Test::Hello::user_exception_not_expected_skel, 0},
    };
...
namespace POA_Test
{
  ...
  class system_exception_test_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline system_exception_test_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
    ...
    virtual void execute (void)
    {
      this->servant_->system_exception_test ();
    }
...
void POA_Test::Hello::system_exception_test_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  system_exception_test_Hello command (
    impl);
...
namespace POA_Test
{
  ...
  class user_exception_expected_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline user_exception_expected_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
    ...
    virtual void execute (void)
    {
      this->servant_->user_exception_expected ();
    }
...
void POA_Test::Hello::user_exception_expected_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  user_exception_expected_Hello command (
    impl);
...
namespace POA_Test
{
  ...
  class user_exception_not_expected_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline user_exception_not_expected_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
    ...
    virtual void execute (void)
    {
      this->servant_->user_exception_not_expected ();
    }
...
void POA_Test::Hello::user_exception_not_expected_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  user_exception_not_expected_Hello command (
    impl);
