...
#ifndef _TAO_IDL_TESTC_H6DIR4_H_
#define _TAO_IDL_TESTC_H6DIR4_H_
...
#define _TEST_HELLO__VAR_OUT_CH_
  ...
  public:
    ...
    class  A : public ::CORBA::UserException
    {
    public:
      ...
      static A *_downcast ( ::CORBA::Exception *);
      static const A *_downcast ( ::CORBA::Exception const *);
    ...
    class  B : public ::CORBA::UserException
    {
    public:
      ...
      static B *_downcast ( ::CORBA::Exception *);
      static const B *_downcast ( ::CORBA::Exception const *);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Hello::A &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Hello::A &);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Hello::B &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Hello::B &);
