...
#ifndef _TAO_IDL_TESTS_BKQRIL_H_
#define _TAO_IDL_TESTS_BKQRIL_H_
...
namespace POA_Test
{
  ...
  public:
    ...
    static void system_exception_test_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void user_exception_expected_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void user_exception_not_expected_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
