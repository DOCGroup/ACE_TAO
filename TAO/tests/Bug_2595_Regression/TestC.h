...
#ifndef _TAO_IDL_TESTC_Z0VDOL_H_
#define _TAO_IDL_TESTC_Z0VDOL_H_
...
namespace Test
{
  ...
  struct  Fls
  {
    ...
    typedef Fls_var _var_type;
    typedef Fls_out _out_type;
  ...
  struct  Vls
  {
    ...
    typedef Vls_var _var_type;
    typedef Vls_out _out_type;

    ::CORBA::Double d_mem;
    ::TAO::String_Manager s_mem;
  };
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Fls &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Fls &);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Vls &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Vls &);
