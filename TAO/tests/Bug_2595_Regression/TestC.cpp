  ...
  ::Test::Vls_out vstruct)
{
  ...
  TAO::Arg_Traits< ::Test::Fls>::out_arg_val _tao_fstruct (fstruct);
  TAO::Arg_Traits< ::Test::Vls>::out_arg_val _tao_vstruct (vstruct);
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const Test::Fls &_tao_aggregate)
{
  return
    (strm << _tao_aggregate.l_mem) &&
    (strm << _tao_aggregate.d_mem);
}

::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    Test::Fls &_tao_aggregate)
{
  return
    (strm >> _tao_aggregate.l_mem) &&
    (strm >> _tao_aggregate.d_mem);
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const Test::Vls &_tao_aggregate)
{
  return
    (strm << _tao_aggregate.d_mem) &&
    (strm << _tao_aggregate.s_mem.in ());
}

::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    Test::Vls &_tao_aggregate)
{
  return
    (strm >> _tao_aggregate.d_mem) &&
    (strm >> _tao_aggregate.s_mem.out ());
}
