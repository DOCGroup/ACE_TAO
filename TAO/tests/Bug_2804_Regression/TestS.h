...
#ifndef _TAO_IDL_TESTS_OQLCT8_H_
#define _TAO_IDL_TESTS_OQLCT8_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Test::ValueSort3>
    : public
        Basic_SArg_Traits_T<
            ::Test::ValueSort3,
  ...
  template<>
  class SArg_Traits< ::Test::SymbolSeq>
    : public
  ...
  template<>
  class SArg_Traits< ::Test::NonRecursiveUnionWithStringStruct3>
    : public
        Var_Size_SArg_Traits_T<
