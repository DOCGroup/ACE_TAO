  ...
  const char * mystring)
{
  ...
  TAO::Arg_Traits< char *>::in_arg_val _tao_mystring (mystring);
  ...
  const ::Test::Octet_Seq & octet_in)
{
  ...
  TAO::Arg_Traits< ::Test::Octet_Seq>::in_arg_val _tao_octet_in (octet_in);
