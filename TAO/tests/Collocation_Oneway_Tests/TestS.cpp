...
#ifndef _TAO_IDL_TESTS_AWJQXJ_CPP_
#define _TAO_IDL_TESTS_AWJQXJ_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"onewayTest", &POA_Test::Hello::onewayTest_skel, 0},
...
namespace POA_Test
{
  ...
  class onewayTest_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline onewayTest_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
...
void POA_Test::Hello::onewayTest_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
