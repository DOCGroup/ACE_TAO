...
#ifndef _TAO_IDL_VB_BASICS_XRNFJF_CPP_
#define _TAO_IDL_VB_BASICS_XRNFJF_CPP_
...
class TAO_vb_basic_Test_Perfect_Hash_OpTable
...
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_vb_basic_Test_Perfect_Hash_OpTable -N lookup  */
unsigned int
TAO_vb_basic_Test_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
...
TAO_vb_basic_Test_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 6,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},
      {"basic_op1", &POA_vb_basic::Test::basic_op1_skel, 0},
...
static TAO_vb_basic_Test_Perfect_Hash_OpTable tao_vb_basic_Test_optable;

// TAO_IDL - Generated from
// be/be_visitor_interface/interface_ss.cpp:90

POA_vb_basic::Test::Test (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_vb_basic_Test_optable;
}

POA_vb_basic::Test::Test (const Test& rhs)
...
void POA_vb_basic::Test::basic_op1_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_vb_basic::Test * const impl =
    dynamic_cast<POA_vb_basic::Test *> (servant);
...
::CORBA::Boolean POA_vb_basic::Test::_is_a (const char* value)
{
  return
    (
      ACE_OS::strcmp (
...
const char* POA_vb_basic::Test::_interface_repository_id (void) const
{
...
void POA_vb_basic::Test::_dispatch (
...
POA_vb_basic::Test::_this (void)
{
  ...
  typedef ::vb_basic::Test STUB_SCOPED_NAME;
  return
