...
#ifndef _TAO_IDL_TREECONTROLLERS_QKMSLL_CPP_
#define _TAO_IDL_TREECONTROLLERS_QKMSLL_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"reflect", &POA_Test::reflect_skel, 0},
...
public:
  ...
  {
    TAO::SArg_Traits< ::TreeController>::ret_arg_type retval =
      TAO::Portable_Server::get_ret_arg< ::TreeController> (
        this->operation_details_,
        this->args_);

    TAO::SArg_Traits< ::TreeController>::in_arg_type arg_1 =
      TAO::Portable_Server::get_in_arg< ::TreeController> (
        this->operation_details_,
        this->args_,
        1);

    retval =
      this->servant_->reflect (
        arg_1);
  }
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::TreeController>::ret_val retval;
  TAO::SArg_Traits< ::TreeController>::in_arg_val _tao_tc;
