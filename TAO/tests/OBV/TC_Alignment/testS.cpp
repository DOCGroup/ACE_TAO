...
#ifndef _TAO_IDL_TESTS_8CZIBT_CPP_
#define _TAO_IDL_TESTS_8CZIBT_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_value", &POA_test::get_value_skel, 0},
...
class get_value_test
  : public TAO::Upcall_Command
{
public:
  inline get_value_test (
    POA_test * servant,
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_type;
