...
#ifndef _TAO_IDL_TESTS_OOW7XR_CPP_
#define _TAO_IDL_TESTS_OOW7XR_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"remote_call", &POA_Simple_Server::remote_call_skel, 0},
      {"",0,0},
...
class remote_call_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline remote_call_Simple_Server (
...
void POA_Simple_Server::remote_call_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  remote_call_Simple_Server command (
    impl);
