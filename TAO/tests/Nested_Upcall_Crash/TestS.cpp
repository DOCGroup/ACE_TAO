...
#ifndef _TAO_IDL_TESTS_AC1ZZK_CPP_
#define _TAO_IDL_TESTS_AC1ZZK_CPP_
...
TAO_Test_Peer_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"noop", &POA_Test::Peer::noop_skel, 0},
      {"crash", &POA_Test::Peer::crash_skel, 0},
      {"",0,0},
      {"_is_a", &TAO_ServantBase::_is_a_thru_poa_skel, 0},
      {"",0,0},{"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"callme", &POA_Test::Peer::callme_skel, 0},
      {"",0,0},
...
void POA_Test::Peer::callme_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Test::Peer>::in_arg_val _tao_callback;
  TAO::SArg_Traits< ::CORBA::ULong>::in_arg_val _tao_max_depth;
  TAO::SArg_Traits< ::Test::Payload>::in_arg_val _tao_extra_data;
