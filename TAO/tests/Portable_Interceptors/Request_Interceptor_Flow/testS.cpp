...
#ifndef _TAO_IDL_TESTS_E0GLXI_CPP_
#define _TAO_IDL_TESTS_E0GLXI_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"server_test", &POA_Test::server_test_skel, 0},
      {"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"client_test", &POA_Test::client_test_skel, 0},
    };
...
class client_test_Test
  : public TAO::Upcall_Command
{
public:
  inline client_test_Test (
    POA_Test * servant,
...
void POA_Test::client_test_skel (
...
class server_test_Test
  : public TAO::Upcall_Command
{
public:
  inline server_test_Test (
    POA_Test * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
