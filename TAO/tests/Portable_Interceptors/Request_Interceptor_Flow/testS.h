...
#ifndef _TAO_IDL_TESTS_HQD7UV_H_
#define _TAO_IDL_TESTS_HQD7UV_H_
...
public:
  ...
  virtual void client_test (
    ::Test::TestScenario scenario) = 0;

  static void client_test_skel (
  ...
  virtual void server_test (
    ...
    ::CORBA::ULongSeq_out myseq) = 0;

  static void server_test_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
