...
#ifndef _TAO_IDL_TESTC_XDKAEF_H_
#define _TAO_IDL_TESTC_XDKAEF_H_
...
public:
  ...
  typedef ::CORBA::Short TestScenario;
  typedef ::CORBA::Short_out TestScenario_out;

  // TAO_IDL - Generated from
  // be/be_visitor_typecode/typecode_decl.cpp:34

  static ::CORBA::TypeCode_ptr const _tc_TestScenario;

  // TAO_IDL - Generated from
  // be/be_visitor_exception/exception_ch.cpp:41

  class  X : public ::CORBA::UserException
  {
  public:
    ...
    static X *_downcast ( ::CORBA::Exception *);
    static const X *_downcast ( ::CORBA::Exception const *);
  ...
  static ::CORBA::TypeCode_ptr const _tc_X;

  // TAO_IDL - Generated from
  // be/be_visitor_exception/exception_ch.cpp:41

  class  UnknownScenario : public ::CORBA::UserException
  {
  public:
    Test::TestScenario scenario;

    UnknownScenario (void);
    UnknownScenario (const UnknownScenario &);
    ~UnknownScenario (void);

    UnknownScenario &operator= (const UnknownScenario &);

    static UnknownScenario *_downcast ( ::CORBA::Exception *);
    static const UnknownScenario *_downcast ( ::CORBA::Exception const *);
  ...
  static ::CORBA::TypeCode_ptr const _tc_UnknownScenario;

  virtual void client_test (
    ::Test::TestScenario scenario);

  virtual void server_test (
    ::Test::TestScenario scenario,
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::X &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::X &);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::UnknownScenario &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::UnknownScenario &);
