...
#ifndef _TAO_IDL_TESTS_XGHFGG_CPP_
#define _TAO_IDL_TESTS_XGHFGG_CPP_
  ...
  static const unsigned char asso_values[] =
    {
     ...
     24, 24, 24, 24, 24,  0, 24,  0, 24,  0,
      0,  0, 24, 24, 24, 24, 24, 24,  5,  0,
      0, 24, 24, 24,  0,  0, 10,  0, 24, 24,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},
      {"_get_the_structure", &POA_Test_Interceptors::Visual::_get_the_structure_skel, 0},
      {"",0,0},
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::out_arg_val _tao_msg;
...
namespace POA_Test_Interceptors
{
  ...
  class _get_the_structure_Visual
    : public TAO::Upcall_Command
  {
  public:
    inline _get_the_structure_Visual (
      POA_Test_Interceptors::Visual * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
    ...
    virtual void execute (void)
    {
      TAO::SArg_Traits< ::Test_Interceptors::Visual::VarLenStruct>::ret_arg_type retval =
...
void POA_Test_Interceptors::Visual::_get_the_structure_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Test_Interceptors::Visual::VarLenStruct>::ret_val retval;
  ...
  _get_the_structure_Visual command (
    impl,
    server_request.operation_details (),
    args);
