...
#ifndef _TAO_IDL_TESTS_UHDFDU_CPP_
#define _TAO_IDL_TESTS_UHDFDU_CPP_
...
class TAO_Tester_Perfect_Hash_OpTable
...
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_Tester_Perfect_Hash_OpTable -N lookup  */
unsigned int
TAO_Tester_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
...
TAO_Tester_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 7,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"test", &POA_Tester::test_skel, 0},
      {"_is_a", &TAO_ServantBase::_is_a_skel, 0},
      {"",0,0},
      {"test2", &POA_Tester::test2_skel, 0},
      {"",0,0},{"",0,0},
...
static TAO_Tester_Perfect_Hash_OpTable tao_Tester_optable;

// TAO_IDL - Generated from
// be/be_visitor_interface/interface_ss.cpp:90

POA_Tester::POA_Tester (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_Tester_optable;
}

POA_Tester::POA_Tester (const POA_Tester& rhs)
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_Tester * const impl =
    dynamic_cast<POA_Tester *> (servant);
...
::CORBA::Boolean POA_Tester::_is_a (const char* value)
{
  return
    (
      ACE_OS::strcmp (
...
const char* POA_Tester::_interface_repository_id (void) const
{
...
POA_Tester::_this (void)
{
  ...
  typedef ::Tester STUB_SCOPED_NAME;
  return
