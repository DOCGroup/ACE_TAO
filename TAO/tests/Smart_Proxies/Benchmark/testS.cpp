...
#ifndef _TAO_IDL_TESTS_OOZ93U_CPP_
#define _TAO_IDL_TESTS_OOZ93U_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"tickets", &POA_Test::tickets_skel, 0},
      {"shutdown", &POA_Test::shutdown_skel, 0},
      {"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"",0,0},
      {"box_prices", &POA_Test::box_prices_skel, 0},
...
class box_prices_Test
  : public TAO::Upcall_Command
{
public:
  inline box_prices_Test (
    POA_Test * servant,
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Short>::in_arg_val _tao_number;
