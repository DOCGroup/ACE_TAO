...
#ifndef _TAO_IDL_TESTS_JQC5QI_CPP_
#define _TAO_IDL_TESTS_JQC5QI_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_howmany;
