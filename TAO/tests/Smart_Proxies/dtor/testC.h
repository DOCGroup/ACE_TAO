...
#ifndef _TAO_IDL_TESTC_XITTOI_H_
#define _TAO_IDL_TESTC_XITTOI_H_
...
protected:
  TAO_Test_Proxy_Factory_Adapter (void);
  ~TAO_Test_Proxy_Factory_Adapter (void);
  TAO_Test_Proxy_Factory_Adapter &operator= (
      const TAO_Test_Proxy_Factory_Adapter &
    );
...
typedef TAO_Singleton<TAO_Test_Proxy_Factory_Adapter, TAO_SYNCH_RECURSIVE_MUTEX> TAO_Test_PROXY_FACTORY_ADAPTER;

class  TAO_Test_Smart_Proxy_Base
  : public virtual Test,
    public virtual TAO_Smart_Proxy_Base
{
public:
  TAO_Test_Smart_Proxy_Base (void);
  ~TAO_Test_Smart_Proxy_Base (void);
  virtual TAO_Stub *_stubobj (void) const;
  virtual TAO_Stub *_stubobj (void);
virtual void hello (
  ::CORBA::Long howmany);virtual void shutdown (
  void);protected:
  ::Test_ptr get_proxy (void);
  ::Test_var proxy_;
};
