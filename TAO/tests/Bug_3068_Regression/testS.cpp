...
#ifndef _TAO_IDL_TESTS_OICZB3_CPP_
#define _TAO_IDL_TESTS_OICZB3_CPP_
...
public:
  ...
  virtual void execute (void)
  {
    TAO::SArg_Traits< ::CORBA::OctetSeq>::in_arg_type arg_1 =
      TAO::Portable_Server::get_in_arg< ::CORBA::OctetSeq> (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::CORBA::OctetSeq>::in_arg_val _tao_payload;
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_is_a", &TAO_ServantBase::_is_a_thru_poa_skel, 0},
      {"",0,0},
      {"ow_test", &POA_Simple_Server::ow_test_skel, 0},
...
class ow_test_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline ow_test_Simple_Server (
...
void POA_Simple_Server::ow_test_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
