...
#ifndef _TAO_IDL_TESTS_3HEVQ5_H_
#define _TAO_IDL_TESTS_3HEVQ5_H_
...
public:
  ...
  virtual void callback_method (
    const ::CORBA::OctetSeq & payload) = 0;

  static void callback_method_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
};
...
public:
  ...
  virtual void ow_test (
    void) = 0;

  static void ow_test_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
