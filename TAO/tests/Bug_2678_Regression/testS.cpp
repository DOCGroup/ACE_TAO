...
#ifndef _TAO_IDL_TESTS_O6GY8I_CPP_
#define _TAO_IDL_TESTS_O6GY8I_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"RunTest", &POA_Test::RunTest_skel, 0},
...
public:
  ...
  {
    TAO::SArg_Traits< ::AnySeq>::ret_arg_type retval =
      TAO::Portable_Server::get_ret_arg< ::AnySeq> (
        this->operation_details_,
        this->args_);

    TAO::SArg_Traits< ::AnySeq>::in_arg_type arg_1 =
      TAO::Portable_Server::get_in_arg< ::AnySeq> (
        this->operation_details_,
        this->args_,
        1);
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::AnySeq>::ret_val retval;
  TAO::SArg_Traits< ::AnySeq>::in_arg_val _tao_params;
