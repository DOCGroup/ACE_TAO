...
#ifndef _TAO_IDL_TESTS_QM1B50_CPP_
#define _TAO_IDL_TESTS_QM1B50_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_get_test_val", &POA_Simple_Server::_get_test_val_skel, 0},
      {"_set_test_val", &POA_Simple_Server::_set_test_val_skel, 0},
      {"raise_user_exception", &POA_Simple_Server::raise_user_exception_skel, 0},
      {"raise_system_exception", &POA_Simple_Server::raise_system_exception_skel, 0},
    };

  static const signed char lookup[] =
    {
       -1,  -1,  -1,  -1,  -1,   5,  -1,  -1,   6,  -1,   7,   8,  -1,   9,
       10,  11, -12,  -2, -24,  -1,  14,  -1,  15,
    };
...
class _get_test_val_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline _get_test_val_Simple_Server (
...
void POA_Simple_Server::_get_test_val_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  _get_test_val_Simple_Server command (
    impl,
...
class _set_test_val_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline _set_test_val_Simple_Server (
    POA_Simple_Server * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_Simple_Server::_set_test_val_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_test_val;
  ...
  _set_test_val_Simple_Server command (
    impl,
    server_request.operation_details (),
    args);
...
public:
  ...
  virtual void execute (void)
  {
    ...
    TAO::SArg_Traits< ::Structure>::in_arg_type arg_2 =
      TAO::Portable_Server::get_in_arg< ::Structure> (
        this->operation_details_,
        this->args_,
        2);

    TAO::SArg_Traits< ::Structure>::out_arg_type arg_3 =
      TAO::Portable_Server::get_out_arg< ::Structure> (
        this->operation_details_,
        this->args_,
        3);
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Structure>::in_arg_val _tao_the_in_structure;
  TAO::SArg_Traits< ::Structure>::out_arg_val _tao_the_out_structure;
  TAO::SArg_Traits< char *>::inout_arg_val _tao_name;
...
class raise_user_exception_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline raise_user_exception_Simple_Server (
    POA_Simple_Server * servant)
    : servant_ (servant)
  {
  }
  ...
  virtual void execute (void)
  {
    this->servant_->raise_user_exception ();
  }
...
void POA_Simple_Server::raise_user_exception_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  raise_user_exception_Simple_Server command (
    impl);
...
class raise_system_exception_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline raise_system_exception_Simple_Server (
    POA_Simple_Server * servant)
    : servant_ (servant)
  {
  }
  ...
  virtual void execute (void)
  {
    this->servant_->raise_system_exception ();
  }
...
void POA_Simple_Server::raise_system_exception_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  raise_system_exception_Simple_Server command (
    impl);
