...
#ifndef _TAO_IDL_TESTS_T8HAQM_H_
#define _TAO_IDL_TESTS_T8HAQM_H_
...
public:
  ...
  static void _get_test_val_skel (
  ...
  virtual void test_val (
    ::CORBA::Long test_val) = 0;

  static void _set_test_val_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
