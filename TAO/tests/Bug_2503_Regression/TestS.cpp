...
#ifndef _TAO_IDL_TESTS_ZX5YZE_CPP_
#define _TAO_IDL_TESTS_ZX5YZE_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},
      {"the_operation", &POA_Test::the_operation_skel, 0},
      {"",0,0},
...
class the_operation_Test
  : public TAO::Upcall_Command
{
public:
  inline the_operation_Test (
    POA_Test * servant,
...
void POA_Test::the_operation_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::out_arg_val _tao_x;
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},{"",0,0},
      {"the_operation", &POA_AMI_TestHandler::the_operation_skel, 0},
      {"the_operation_excep", &POA_AMI_TestHandler::the_operation_excep_skel, 0},
    };
...
class the_operation_AMI_TestHandler
  : public TAO::Upcall_Command
{
public:
  inline the_operation_AMI_TestHandler (
...
void POA_AMI_TestHandler::the_operation_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  the_operation_AMI_TestHandler command (
    impl,
    server_request.operation_details (),
    args);
...
class the_operation_excep_AMI_TestHandler
  : public TAO::Upcall_Command
{
public:
  inline the_operation_excep_AMI_TestHandler (
    POA_AMI_TestHandler * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_AMI_TestHandler::the_operation_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  the_operation_excep_AMI_TestHandler command (
    impl,
    server_request.operation_details (),
    args);
