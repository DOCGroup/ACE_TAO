...
#ifndef _TAO_IDL_TESTC_FZH0DK_H_
#define _TAO_IDL_TESTC_FZH0DK_H_
...
public:
  ...
  virtual void the_operation (
    ::CORBA::Long_out x);

  virtual void shutdown (
    void);

  virtual void sendc_the_operation (
...
public:
  ...
  static void
  the_operation_reply_stub (
    TAO_InputCDR &_tao_reply_cdr,
    ::Messaging::ReplyHandler_ptr _tao_reply_handler,
    ::CORBA::ULong reply_status);

  virtual void the_operation_excep (
