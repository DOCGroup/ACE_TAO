...
#ifndef _TAO_IDL_TESTS_AY9BLC_H_
#define _TAO_IDL_TESTS_AY9BLC_H_
...
namespace POA_Test
{
  ...
  public:
    ...
    static void get_stringList_skel (
    ...
    virtual void get_stringList2 (
      ...
      ::Test::StringList_out osl) = 0;

    static void get_stringList2_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    virtual void mod_stringList (
      ::Test::StringList & iosl) = 0;

    static void mod_stringList_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
