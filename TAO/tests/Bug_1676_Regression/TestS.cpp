...
#ifndef _TAO_IDL_TESTS_BIHE7I_CPP_
#define _TAO_IDL_TESTS_BIHE7I_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_stringList", &POA_Test::Hello::get_stringList_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"get_stringList2", &POA_Test::Hello::get_stringList2_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"mod_stringList", &POA_Test::Hello::mod_stringList_skel, 0},
    };
...
namespace POA_Test
{
  ...
  class get_stringList_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline get_stringList_Hello (
    ...
    {
      TAO::SArg_Traits< ::Test::StringList>::ret_arg_type retval =
        TAO::Portable_Server::get_ret_arg< ::Test::StringList> (
          this->operation_details_,
          this->args_);

      retval =
        this->servant_->get_stringList ();
    }
...
namespace POA_Test
{
  ...
  class get_stringList2_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline get_stringList2_Hello (
      POA_Test::Hello * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
    ...
    virtual void execute (void)
    {
      ...
      TAO::SArg_Traits< ::Test::StringList>::out_arg_type arg_2 =
        TAO::Portable_Server::get_out_arg< ::Test::StringList> (
          this->operation_details_,
          this->args_,
          2);

      this->servant_->get_stringList2 (
        arg_1
        , arg_2);
    }
...
void POA_Test::Hello::get_stringList2_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::ACE_InputCDR::to_boolean>::in_arg_val _tao_initialize;
  TAO::SArg_Traits< ::Test::StringList>::out_arg_val _tao_osl;
...
namespace POA_Test
{
  ...
  class mod_stringList_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline mod_stringList_Hello (
      POA_Test::Hello * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
    ...
    virtual void execute (void)
    {
      TAO::SArg_Traits< ::Test::StringList>::inout_arg_type arg_1 =
        TAO::Portable_Server::get_inout_arg< ::Test::StringList> (
          this->operation_details_,
          this->args_,
          1);

      this->servant_->mod_stringList (
        arg_1);
    }
...
void POA_Test::Hello::mod_stringList_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::Test::StringList>::inout_arg_val _tao_iosl;
