...
#ifndef _TAO_IDL_TESTS_LDPUTL_CPP_
#define _TAO_IDL_TESTS_LDPUTL_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"initialize", &POA_test::initialize_skel, 0},
    };
...
class initialize_test
  : public TAO::Upcall_Command
{
public:
  inline initialize_test (
    POA_test * servant,
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::ULong>::in_arg_val _tao_total_iterations;
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::in_arg_val _tao_iteration;
