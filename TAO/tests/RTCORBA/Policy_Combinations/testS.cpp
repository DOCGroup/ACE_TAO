...
#ifndef _TAO_IDL_TESTS_YWQMD9_CPP_
#define _TAO_IDL_TESTS_YWQMD9_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},
      {"prioritized_method", &POA_test::prioritized_method_skel, 0},
    };
...
class prioritized_method_test
  : public TAO::Upcall_Command
{
public:
  inline prioritized_method_test (
    POA_test * servant)
    : servant_ (servant)
  {
  }
  ...
  virtual void execute (void)
  {
    this->servant_->prioritized_method ();
  }
...
void POA_test::prioritized_method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  prioritized_method_test command (
    impl);
