...
void
Test::test_method (
  ::CORBA::Boolean client_propagated,
  ::CORBA::Short client_priority)
{
  ...
  TAO::Arg_Traits< ::ACE_InputCDR::to_boolean>::in_arg_val _tao_client_propagated (client_propagated);
  TAO::Arg_Traits< ::CORBA::Short>::in_arg_val _tao_client_priority (client_priority);
