...
#ifndef _TAO_IDL_TESTS_6MQYPM_CPP_
#define _TAO_IDL_TESTS_6MQYPM_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"test_method", &POA_Test::test_method_skel, 0},
      {"",0,0},
...
class test_method_Test
  : public TAO::Upcall_Command
{
public:
  inline test_method_Test (
    POA_Test * servant,
...
void POA_Test::test_method_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::ACE_InputCDR::to_boolean>::in_arg_val _tao_client_propagated;
  TAO::SArg_Traits< ::CORBA::Short>::in_arg_val _tao_client_priority;
