...
#ifndef _TAO_IDL_TESTS_Q5DDOE_CPP_
#define _TAO_IDL_TESTS_Q5DDOE_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"client_done", &POA_Simple_Server::client_done_skel, 0},
    };
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Simple_Server>::in_arg_val _tao_objref;
...
class client_done_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline client_done_Simple_Server (
    POA_Simple_Server * servant)
    : servant_ (servant)
  {
  }
...
void POA_Simple_Server::client_done_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
/* C++ code produced by gperf version 2.8 (ACE version) */
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_AMI_Simple_ServerHandler_Perfect_Hash_OpTable -N lookup  */
unsigned int
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"test_method", &POA_AMI_Simple_ServerHandler::test_method_skel, 0},
      {"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},
      {"test_method_excep", &POA_AMI_Simple_ServerHandler::test_method_excep_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"client_done", &POA_AMI_Simple_ServerHandler::client_done_skel, 0},
      {"client_done_excep", &POA_AMI_Simple_ServerHandler::client_done_excep_skel, 0},
    };
...
POA_AMI_Simple_ServerHandler::POA_AMI_Simple_ServerHandler (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_AMI_Simple_ServerHandler_optable;
}
...
class test_method_AMI_Simple_ServerHandler
  : public TAO::Upcall_Command
{
public:
  inline test_method_AMI_Simple_ServerHandler (
    POA_AMI_Simple_ServerHandler * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
      , operation_details_ (operation_details)
...
private:
  POA_AMI_Simple_ServerHandler * const servant_;
  TAO_Operation_Details const * const operation_details_;
  TAO::Argument * const * const args_;
};
...
void POA_AMI_Simple_ServerHandler::test_method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  POA_AMI_Simple_ServerHandler * const impl =
    dynamic_cast<POA_AMI_Simple_ServerHandler *> (servant);
  ...
  test_method_AMI_Simple_ServerHandler command (
    impl,
    server_request.operation_details (),
    args);
...
class test_method_excep_AMI_Simple_ServerHandler
  : public TAO::Upcall_Command
{
public:
  inline test_method_excep_AMI_Simple_ServerHandler (
    POA_AMI_Simple_ServerHandler * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_AMI_Simple_ServerHandler::test_method_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  test_method_excep_AMI_Simple_ServerHandler command (
    impl,
    server_request.operation_details (),
    args);
...
class client_done_AMI_Simple_ServerHandler
  : public TAO::Upcall_Command
{
public:
  inline client_done_AMI_Simple_ServerHandler (
    POA_AMI_Simple_ServerHandler * servant)
    : servant_ (servant)
  {
  }
...
void POA_AMI_Simple_ServerHandler::client_done_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
class client_done_excep_AMI_Simple_ServerHandler
  : public TAO::Upcall_Command
{
public:
  inline client_done_excep_AMI_Simple_ServerHandler (
    POA_AMI_Simple_ServerHandler * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_AMI_Simple_ServerHandler::client_done_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  client_done_excep_AMI_Simple_ServerHandler command (
    impl,
    server_request.operation_details (),
    args);
...
const char* POA_AMI_Simple_ServerHandler::_interface_repository_id (void) const
{
...
POA_AMI_Simple_ServerHandler::_this (void)
{
  TAO_Stub *stub = this->_create_stub ();
  ...
  typedef ::AMI_Simple_ServerHandler STUB_SCOPED_NAME;
  return
    TAO::Narrow_Utils<STUB_SCOPED_NAME>::unchecked_narrow (
        obj.in ());
}
