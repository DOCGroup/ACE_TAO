...
#ifndef _TAO_IDL_TESTS_PMM2KJ_H_
#define _TAO_IDL_TESTS_PMM2KJ_H_
...
{
protected:
  POA_AMI_Simple_ServerHandler (void);
...
public:
  ...
  virtual ~POA_AMI_Simple_ServerHandler (void);
  ...
  ::AMI_Simple_ServerHandler *_this (void);
  ...
  static void client_done_excep_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
};
