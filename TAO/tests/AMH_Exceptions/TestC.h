...
#ifndef _TAO_IDL_TESTC_TKJUEN_H_
#define _TAO_IDL_TESTC_TKJUEN_H_
...
#define _TEST_RED_HERRING__VAR_OUT_CH_
  ...
  public:
    ...
    typedef Red_Herring * _ptr_type;
    typedef Red_Herring_var _var_type;
    typedef Red_Herring_out _out_type;
...
namespace Test
{
   ...
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::Test::InvalidTimestamp *&); // deprecated
...
namespace Test
{
   ...
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::Test::ServerOverload *&); // deprecated
...
namespace Test
{
   void operator<<= ( ::CORBA::Any &, Red_Herring *); // copying
   void operator<<= ( ::CORBA::Any &, Red_Herring **); // non-copying
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Red_Herring *&);
}
