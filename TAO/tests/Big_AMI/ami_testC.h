...
#ifndef _TAO_IDL_AMI_TESTC_F8QTLL_H_
#define _TAO_IDL_AMI_TESTC_F8QTLL_H_
...
#if !defined (_A_PAYLOAD_CH_)
#define _A_PAYLOAD_CH_
...
namespace A
{
   void operator<<= ( ::CORBA::Any &, const ::A::Payload &); // copying version
   void operator<<= ( ::CORBA::Any &, ::A::Payload*); // noncopying version
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::A::Payload *&); // deprecated
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const ::A::Payload *&);
}
...
#if !defined _TAO_CDR_OP_A_Payload_H_
#define _TAO_CDR_OP_A_Payload_H_
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
...
#endif /* _TAO_CDR_OP_A_Payload_H_ */
