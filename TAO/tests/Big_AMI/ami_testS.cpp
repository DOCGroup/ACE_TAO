...
#ifndef _TAO_IDL_AMI_TESTS_FGNT3K_CPP_
#define _TAO_IDL_AMI_TESTS_FGNT3K_CPP_
...
namespace POA_A
{
  ...
  public:
    ...
    virtual void execute (void)
    {
      ...
      TAO::SArg_Traits< ::A::Payload>::in_arg_type arg_4 =
        TAO::Portable_Server::get_in_arg< ::A::Payload> (
          this->operation_details_,
          this->args_,
          4);
