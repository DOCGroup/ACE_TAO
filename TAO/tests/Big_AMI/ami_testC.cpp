...
#if !defined (_A_PAYLOAD_CS_)
#define _A_PAYLOAD_CS_

A::Payload::Payload (void)
{}
...
void A::Payload::_tao_any_destructor (
...
#ifndef _TAO_TYPECODE_A_Payload_GUARD
#define _TAO_TYPECODE_A_Payload_GUARD
...
#endif /* _TAO_TYPECODE_A_Payload_GUARD */
  ...
  const ::A::Payload & the_payload)
{
  ...
  TAO::Arg_Traits< ::A::Payload>::in_arg_val _tao_the_payload (the_payload);
...
namespace A
{
  ...
  void operator<<= (
      ::CORBA::Any &_tao_any,
      const ::A::Payload &_tao_elem
    )
  {
    TAO::Any_Dual_Impl_T< ::A::Payload>::insert_copy (
        _tao_any,
        ::A::Payload::_tao_any_destructor,
        ::A::_tc_Payload,
        _tao_elem
      );
}
...
void operator<<= (
    ...
    ::A::Payload *_tao_elem)
{
  TAO::Any_Dual_Impl_T< ::A::Payload>::insert (
      _tao_any,
      ::A::Payload::_tao_any_destructor,
      ::A::_tc_Payload,
      _tao_elem
...
{
  return
    TAO::Any_Dual_Impl_T< ::A::Payload>::extract (
        _tao_any,
        ::A::Payload::_tao_any_destructor,
        ::A::_tc_Payload,
        _tao_elem
...
#if !defined _TAO_CDR_OP_A_Payload_CPP_
#define _TAO_CDR_OP_A_Payload_CPP_

TAO_BEGIN_VERSIONED_NAMESPACE_DECL

::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const A::Payload &_tao_sequence)
{
...
#endif /* _TAO_CDR_OP_A_Payload_CPP_ */
