...
#ifndef _TAO_IDL_TESTS_F76VGB_H_
#define _TAO_IDL_TESTS_F76VGB_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::FirstUnionArray_tag>
    : public
