...
// Traits specializations for Test::HelloWorld.

Test::HelloWorld_ptr
TAO::Objref_Traits<Test::HelloWorld>::duplicate (
    Test::HelloWorld_ptr p)
{
  return Test::HelloWorld::_duplicate (p);
}

void
TAO::Objref_Traits<Test::HelloWorld>::release (
    Test::HelloWorld_ptr p)
{
  ::CORBA::release (p);
}
...
Test::HelloWorld_ptr
TAO::Objref_Traits<Test::HelloWorld>::nil (void)
{
  return Test::HelloWorld::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<Test::HelloWorld>::marshal (
...
Test::HelloWorld::HelloWorld (void)
{
}
...
void
Test::HelloWorld::_tao_any_destructor (void *_tao_void_pointer)
{
...
Test::HelloWorld_ptr
Test::HelloWorld::_unchecked_narrow (
    ::CORBA::Object_ptr _tao_objref)
{
  return
...
Test::HelloWorld_ptr
Test::HelloWorld::_nil (void)
{
  return 0;
}

Test::HelloWorld_ptr
Test::HelloWorld::_duplicate (HelloWorld_ptr obj)
{
  if (! ::CORBA::is_nil (obj))
    {
      obj->_add_ref ();
...
void
Test::HelloWorld::_tao_release (HelloWorld_ptr obj)
{
  ::CORBA::release (obj);
}

::CORBA::Boolean
Test::HelloWorld::_is_a (const char *value)
{
  if (
      ACE_OS::strcmp (
          value,
...
const char* Test::HelloWorld::_interface_repository_id (void) const
{
  return "IDL:Test/HelloWorld:1.0";
}

::CORBA::Boolean
Test::HelloWorld::marshal (TAO_OutputCDR &cdr)
{
  return (cdr << this);
}
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Impl_T<Test::HelloWorld>::to_object (
...
operator<<= (
    ::CORBA::Any &_tao_any,
    Test::HelloWorld_ptr _tao_elem)
{
  Test::HelloWorld_ptr _tao_objptr =
    Test::HelloWorld::_duplicate (_tao_elem);
  _tao_any <<= &_tao_objptr;
}
...
operator<<= (
    ...
    Test::HelloWorld_ptr *_tao_elem)
{
  TAO::Any_Impl_T<Test::HelloWorld>::insert (
      _tao_any,
      Test::HelloWorld::_tao_any_destructor,
      Test::_tc_HelloWorld,
      *_tao_elem);
}
...
{
  return
    TAO::Any_Impl_T<Test::HelloWorld>::extract (
        _tao_any,
        Test::HelloWorld::_tao_any_destructor,
        Test::_tc_HelloWorld,
        _tao_elem);
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const Test::HelloWorld_ptr _tao_objref)
{
...
::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    Test::HelloWorld_ptr &_tao_objref)
{
