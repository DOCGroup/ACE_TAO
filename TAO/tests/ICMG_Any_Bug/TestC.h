...
#ifndef _TAO_IDL_TESTC_L1F02V_H_
#define _TAO_IDL_TESTC_L1F02V_H_
...
#if !defined (_TEST_HELLOWORLD__VAR_OUT_CH_)
#define _TEST_HELLOWORLD__VAR_OUT_CH_
...
#if !defined (_TEST_HELLOWORLD__ARG_TRAITS_)
#define _TEST_HELLOWORLD__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::Test::HelloWorld>
    : public
        Object_Arg_Traits_T<
            ::Test::HelloWorld_ptr,
            ::Test::HelloWorld_var,
            ::Test::HelloWorld_out,
            TAO::Objref_Traits<Test::HelloWorld>,
...
#if !defined (_TEST_HELLOWORLD__TRAITS_)
#define _TEST_HELLOWORLD__TRAITS_

  template<>
  struct  Objref_Traits< ::Test::HelloWorld>
  {
    static ::Test::HelloWorld_ptr duplicate (
        ::Test::HelloWorld_ptr p);
    static void release (
        ::Test::HelloWorld_ptr p);
    static ::Test::HelloWorld_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::Test::HelloWorld_ptr p,
        TAO_OutputCDR & cdr);
  };
...
namespace Test
{
   void operator<<= ( ::CORBA::Any &, HelloWorld_ptr); // copying
   void operator<<= ( ::CORBA::Any &, HelloWorld_ptr *); // non-copying
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, HelloWorld_ptr &);
}
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, Test::HelloWorld_ptr); // copying
 void operator<<= (::CORBA::Any &, Test::HelloWorld_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Test::HelloWorld_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::HelloWorld_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::HelloWorld_ptr &);
