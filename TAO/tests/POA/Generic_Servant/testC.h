...
#ifndef _TAO_IDL_TESTC_EQZDZ9_H_
#define _TAO_IDL_TESTC_EQZDZ9_H_
...
#endif
#define TAO_EXPORT_MACRO GENERIC_SERVANT_Export
...
class GENERIC_SERVANT_Export test
...
public:
  ...
  virtual void timed_method (
    ::CORBA::ULong timeout);

  virtual void timed_oneway_method (
    ::CORBA::ULong timeout);
...
#define _TEST__TRAITS_
  ...
  template<>
  struct GENERIC_SERVANT_Export Objref_Traits< ::test>
  {
...
GENERIC_SERVANT_Export ::CORBA::Boolean operator<< (TAO_OutputCDR &, const test_ptr );
GENERIC_SERVANT_Export ::CORBA::Boolean operator>> (TAO_InputCDR &, test_ptr &);
