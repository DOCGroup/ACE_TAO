...
#ifndef _TAO_IDL_TESTS_FYWAJI_H_
#define _TAO_IDL_TESTS_FYWAJI_H_
...
class GENERIC_SERVANT_Export POA_test
...
public:
  ...
  static void timed_oneway_method_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
