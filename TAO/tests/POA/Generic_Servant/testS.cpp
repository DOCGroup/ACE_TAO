...
#ifndef _TAO_IDL_TESTS_GNEQUY_CPP_
#define _TAO_IDL_TESTS_GNEQUY_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"timed_method", &POA_test::timed_method_skel, 0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},{"",0,0},
      {"oneway_method", &POA_test::oneway_method_skel, 0},
      {"timed_oneway_method", &POA_test::timed_oneway_method_skel, 0},
    };
...
class timed_method_test
  : public TAO::Upcall_Command
{
public:
  inline timed_method_test (
    POA_test * servant,
...
void POA_test::timed_method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::CORBA::ULong>::in_arg_val _tao_timeout;
...
class timed_oneway_method_test
  : public TAO::Upcall_Command
{
public:
  inline timed_oneway_method_test (
    POA_test * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
  ...
  virtual void execute (void)
  {
    ...
    this->servant_->timed_oneway_method (
      arg_1);
  }
...
void POA_test::timed_oneway_method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  timed_oneway_method_test command (
    impl,
    server_request.operation_details (),
    args);
