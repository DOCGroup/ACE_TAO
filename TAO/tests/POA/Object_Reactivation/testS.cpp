...
#ifndef _TAO_IDL_TESTS_15DLEC_CPP_
#define _TAO_IDL_TESTS_15DLEC_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"deactivate_self", &POA_test::deactivate_self_skel, 0},
    };
...
class deactivate_self_test
  : public TAO::Upcall_Command
{
public:
  inline deactivate_self_test (
    POA_test * servant)
    : servant_ (servant)
  {
  }
...
void POA_test::deactivate_self_skel (
