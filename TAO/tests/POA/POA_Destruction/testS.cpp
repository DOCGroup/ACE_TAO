...
#ifndef _TAO_IDL_TESTS_KS800K_CPP_
#define _TAO_IDL_TESTS_KS800K_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"destroy_poa", &POA_test::destroy_poa_skel, 0},
      {"",0,0},
...
class destroy_poa_test
  : public TAO::Upcall_Command
{
public:
  inline destroy_poa_test (
    POA_test * servant)
    : servant_ (servant)
  {
  }
...
void POA_test::destroy_poa_skel (
