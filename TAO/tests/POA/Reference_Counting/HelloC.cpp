...
Hello_ptr
TAO::Objref_Traits<Hello>::duplicate (
    Hello_ptr p)
{
...
void
TAO::Objref_Traits<Hello>::release (
    Hello_ptr p)
{
  ::CORBA::release (p);
}
...
Hello_ptr
TAO::Objref_Traits<Hello>::nil (void)
{
  return Hello::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<Hello>::marshal (
    const Hello_ptr p,
    TAO_OutputCDR & cdr)
{
...
const char* Hello::_interface_repository_id (void) const
{
