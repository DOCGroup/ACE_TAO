...
#ifndef _TAO_IDL_HELLOS_OSOYFR_CPP_
#define _TAO_IDL_HELLOS_OSOYFR_CPP_
...
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_Hello_Perfect_Hash_OpTable -N lookup  */
unsigned int
...
POA_Hello::POA_Hello (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_Hello_optable;
}
...
const char* POA_Hello::_interface_repository_id (void) const
{
...
POA_Hello::_this (void)
{
  ...
  typedef ::Hello STUB_SCOPED_NAME;
  return
