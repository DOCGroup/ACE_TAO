...
#ifndef _TAO_IDL_TESTS_5ALM5N_H_
#define _TAO_IDL_TESTS_5ALM5N_H_
...
public:
  ...
  virtual void exceptional (
    void) = 0;

  static void exceptional_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
  ...
  virtual void notexisting (
    void) = 0;

  static void notexisting_skel (
      TAO_ServerRequest &server_request,
      TAO::Portable_Server::Servant_Upcall *servant_upcall,
      TAO_ServantBase *servant);
};
