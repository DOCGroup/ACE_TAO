...
#ifndef _TAO_IDL_TESTS_YTP6KK_CPP_
#define _TAO_IDL_TESTS_YTP6KK_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"normal", &POA_test::normal_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"notexisting", &POA_test::notexisting_skel, 0},
      {"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"exceptional", &POA_test::exceptional_skel, 0},
    };
...
class exceptional_test
  : public TAO::Upcall_Command
{
public:
  inline exceptional_test (
    POA_test * servant)
    : servant_ (servant)
  {
  }
...
void POA_test::exceptional_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
class notexisting_test
  : public TAO::Upcall_Command
{
public:
  inline notexisting_test (
    POA_test * servant)
    : servant_ (servant)
  {
  }
...
void POA_test::notexisting_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
