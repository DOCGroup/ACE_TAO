...
#ifndef _TAO_IDL_TESTS_0YZZDK_CPP_
#define _TAO_IDL_TESTS_0YZZDK_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"short_sleep", &POA_Test::Hello::short_sleep_skel, 0},
      {"",0,0},
...
namespace POA_Test
{
  ...
  class short_sleep_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline short_sleep_Hello (
...
void POA_Test::Hello::short_sleep_skel (
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"short_sleep", &POA_Test::AMI_HelloHandler::short_sleep_skel, 0},
      {"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},
      {"short_sleep_excep", &POA_Test::AMI_HelloHandler::short_sleep_excep_skel, 0},
    };
...
namespace POA_Test
{
  ...
  class short_sleep_AMI_HelloHandler
    : public TAO::Upcall_Command
  {
  public:
    inline short_sleep_AMI_HelloHandler (
...
void POA_Test::AMI_HelloHandler::short_sleep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
namespace POA_Test
{
  ...
  class short_sleep_excep_AMI_HelloHandler
    : public TAO::Upcall_Command
  {
  public:
    inline short_sleep_excep_AMI_HelloHandler (
      POA_Test::AMI_HelloHandler * servant,
...
void POA_Test::AMI_HelloHandler::short_sleep_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  short_sleep_excep_AMI_HelloHandler command (
    impl,
