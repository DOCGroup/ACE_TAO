...
#ifndef _TAO_IDL_TESTS_XGBNZI_H_
#define _TAO_IDL_TESTS_XGBNZI_H_
...
namespace POA_Test
{
  ...
  public:
    ...
    virtual void short_sleep_excep (
      ::Messaging::ExceptionHolder * excep_holder) = 0;

    static void short_sleep_excep_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
  };
