  ...
  ::CORBA::Any_out outany)
{
  ...
  TAO::Arg_Traits< ::CORBA::Any>::in_arg_val _tao_inany (inany);
  TAO::Arg_Traits< ::CORBA::Any>::out_arg_val _tao_outany (outany);
  ...
  const ::CORBA::WChar * s1)
{
  ...
  TAO::Arg_Traits< ::CORBA::WChar *>::in_arg_val _tao_s1 (s1);
