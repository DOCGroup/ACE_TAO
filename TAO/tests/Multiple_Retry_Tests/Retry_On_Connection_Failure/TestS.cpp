...
#ifndef _TAO_IDL_TESTS_RHS17F_CPP_
#define _TAO_IDL_TESTS_RHS17F_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"set_string", &POA_Test::Hello::set_string_skel, 0},
      {"",0,0},
...
namespace POA_Test
{
  ...
  class set_string_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline set_string_Hello (
      POA_Test::Hello * servant,
      TAO::Argument * const args[])
      : servant_ (servant)
        , args_ (args)
...
void POA_Test::Hello::set_string_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
