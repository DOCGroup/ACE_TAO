...
#ifndef _TAO_IDL_TESTS_TMKQT9_CPP_
#define _TAO_IDL_TESTS_TMKQT9_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"do_something_FixedLength", &POA_Test::do_something_FixedLength_skel, 0},
      {"",0,0},{"",0,0},
      {"do_something_VariableLength", &POA_Test::do_something_VariableLength_skel, 0},
    };
...
class do_something_FixedLength_Test
  : public TAO::Upcall_Command
{
public:
  inline do_something_FixedLength_Test (
    POA_Test * servant,
  ...
  {
    TAO::SArg_Traits< ::FixedLengthInfo>::out_arg_type arg_1 =
      TAO::Portable_Server::get_out_arg< ::FixedLengthInfo> (
...
void POA_Test::do_something_FixedLength_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::FixedLengthInfo>::out_arg_val _tao_my_info;
  ...
  do_something_FixedLength_Test command (
    impl,
...
class do_something_VariableLength_Test
  : public TAO::Upcall_Command
{
public:
  inline do_something_VariableLength_Test (
    POA_Test * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
  ...
  virtual void execute (void)
  {
    TAO::SArg_Traits< ::VariableLengthInfo>::out_arg_type arg_1 =
      TAO::Portable_Server::get_out_arg< ::VariableLengthInfo> (
        this->operation_details_,
        this->args_,
        1);
...
void POA_Test::do_something_VariableLength_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::VariableLengthInfo>::out_arg_val _tao_my_info;
  ...
  do_something_VariableLength_Test command (
    impl,
    server_request.operation_details (),
    args);
