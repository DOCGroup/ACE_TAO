  ...
  ::FixedLengthInfo_out my_info)
{
  ...
  TAO::Arg_Traits< ::FixedLengthInfo>::out_arg_val _tao_my_info (my_info);
...
void
Test::do_something_VariableLength (
  ::VariableLengthInfo_out my_info)
{
  ...
  TAO::Arg_Traits< void>::ret_val _tao_retval;
  TAO::Arg_Traits< ::VariableLengthInfo>::out_arg_val _tao_my_info (my_info);
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const FixedLengthInfo &_tao_aggregate)
{
  return
...
::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    FixedLengthInfo &_tao_aggregate)
{
  return
    (strm >> _tao_aggregate.a) &&
    (strm >> _tao_aggregate.b) &&
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const VariableLengthInfo &_tao_aggregate)
{
  return
    (strm << _tao_aggregate.a) &&
    (strm << _tao_aggregate.b) &&
...
::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    VariableLengthInfo &_tao_aggregate)
{
  return
    (strm >> _tao_aggregate.a) &&
    (strm >> _tao_aggregate.b) &&
