...
{
public:
  mock_transport () : id_(0), is_connected_(false), entry_(), purging_order_ (0), purged_count_ (0) {}
  ...
  void cache_map_entry (const TCM::HASH_MAP_ENTRY_REF& entry) {this->entry_ = entry;}
