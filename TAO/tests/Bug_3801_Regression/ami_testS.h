...
#ifndef _TAO_IDL_AMI_TESTS_VUTUIB_H_
#define _TAO_IDL_AMI_TESTS_VUTUIB_H_
...
namespace POA_A
{
  ...
  public:
    ...
    virtual ::CORBA::Long dadda (
      void) = 0;

    static void _get_dadda_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
  ...
  public:
    ...
    virtual void get_dadda (
      ::CORBA::Long ami_return_val) = 0;

    static void get_dadda_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    virtual void get_dadda_excep (
      ::Messaging::ExceptionHolder * excep_holder) = 0;

    static void get_dadda_excep_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
