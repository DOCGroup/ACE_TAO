...
A::DidTheRightThingB::DidTheRightThingB (
    ::CORBA::Long _tao_id,
    const char * _tao_whatDidTheRightThing)
  : ::CORBA::UserException (
...
A::DidTheRightThingB::DidTheRightThingB (void)
  : ::CORBA::UserException (
        "IDL:A/DidTheRightThingB:1.0",
        "DidTheRightThingB"
      )
...
A::DidTheRightThingB::DidTheRightThingB (const ::A::DidTheRightThingB &_tao_excp)
  : ::CORBA::UserException (
        _tao_excp._rep_id (),
        _tao_excp._name ()
      )
...
A::DidTheRightThingB&
A::DidTheRightThingB::operator= (const ::A::DidTheRightThingB &_tao_excp)
{
  this->::CORBA::UserException::operator= (_tao_excp);
  this->id = _tao_excp.id;
  this->whatDidTheRightThing = ::CORBA::string_dup (_tao_excp.whatDidTheRightThing.in ());
...
void A::DidTheRightThingB::_tao_any_destructor (void *_tao_void_pointer)
{
  DidTheRightThingB *_tao_tmp_pointer =
    static_cast<DidTheRightThingB *> (_tao_void_pointer);
  delete _tao_tmp_pointer;
}

A::DidTheRightThingB *
A::DidTheRightThingB::_downcast ( ::CORBA::Exception *_tao_excp)
{
  return dynamic_cast<DidTheRightThingB *> (_tao_excp);
}

const A::DidTheRightThingB *
A::DidTheRightThingB::_downcast ( ::CORBA::Exception const *_tao_excp)
{
  return dynamic_cast<const DidTheRightThingB *> (_tao_excp);
}

::CORBA::Exception *A::DidTheRightThingB::_alloc (void)
{
  ::CORBA::Exception *retval = 0;
  ACE_NEW_RETURN (retval, ::A::DidTheRightThingB, 0);
  return retval;
}

::CORBA::Exception *
A::DidTheRightThingB::_tao_duplicate (void) const
{
  ::CORBA::Exception *result = 0;
  ACE_NEW_RETURN (
      result,
      ::A::DidTheRightThingB (*this),
      0
    );
  return result;
}

void A::DidTheRightThingB::_raise (void) const
{
  throw *this;
}

void A::DidTheRightThingB::_tao_encode (TAO_OutputCDR &cdr) const
{
  if (!(cdr << *this))
    {
      throw ::CORBA::MARSHAL ();
...
void A::DidTheRightThingB::_tao_decode (TAO_InputCDR &cdr)
{
  if (!(cdr >> *this))
    {
      throw ::CORBA::MARSHAL ();
...
// TAO extension - the virtual _type method.
::CORBA::TypeCode_ptr A::DidTheRightThingB::_tao_type (void) const
{
  return ::A::_tc_DidTheRightThingB;
}
...
namespace A
{
  ::CORBA::TypeCode_ptr const _tc_DidTheRightThingB =
    &_tao_tc_A_DidTheRightThingB;
}
  ...
  ::A::AMI_AMI_TestHandler_ptr ami_handler)
{
  ...
  _tao_call.invoke (
      ami_handler,
      &A::AMI_AMI_TestHandler::get_dadda_reply_stub
    );
}
...
void
A::AMI_AMI_TestHandler::get_dadda (
  ::CORBA::Long ami_return_val)
{
  if (!this->is_evaluated ())
    {
...
void
A::AMI_AMI_TestHandler::get_dadda_excep (
  ::Messaging::ExceptionHolder * excep_holder)
{
  if (!this->is_evaluated ())
    {
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<A::DidTheRightThingB>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace A
{
  ...
  void operator<<= (
      ::CORBA::Any &_tao_any,
      const ::A::DidTheRightThingB &_tao_elem)
  {
    TAO::Any_Dual_Impl_T< ::A::DidTheRightThingB>::insert_copy (
        _tao_any,
        ::A::DidTheRightThingB::_tao_any_destructor,
        ::A::_tc_DidTheRightThingB,
        _tao_elem);
  }
  ...
  void operator<<= (
      ::CORBA::Any &_tao_any,
      ::A::DidTheRightThingB *_tao_elem)
  {
    TAO::Any_Dual_Impl_T< ::A::DidTheRightThingB>::insert (
        _tao_any,
        ::A::DidTheRightThingB::_tao_any_destructor,
        ::A::_tc_DidTheRightThingB,
        _tao_elem);
  ...
  {
    return
      TAO::Any_Dual_Impl_T< ::A::DidTheRightThingB>::extract (
          _tao_any,
          ::A::DidTheRightThingB::_tao_any_destructor,
          ::A::_tc_DidTheRightThingB,
          _tao_elem);
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const A::DidTheRightThingB &_tao_aggregate
  )
{
  // First marshal the repository ID.
  if (strm << _tao_aggregate._rep_id ())
...
::CORBA::Boolean operator>> (
    TAO_InputCDR &strm,
    A::DidTheRightThingB &_tao_aggregate
  )
{
  // Demarshal the members.
  return (
