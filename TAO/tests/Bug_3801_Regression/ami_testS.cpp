...
#ifndef _TAO_IDL_AMI_TESTS_HWVDIB_CPP_
#define _TAO_IDL_AMI_TESTS_HWVDIB_CPP_
  ...
  static const unsigned char asso_values[] =
    {
     ...
     20, 20, 20, 20, 20,  0, 20,  0, 20, 20,
      0,  2, 20, 20, 20,  0, 20, 20, 20, 20,
      0, 20, 20, 20, 20,  0,  5, 20, 20, 20,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_get_dadda", &POA_A::AMI_Test::_get_dadda_skel, 0},
...
namespace POA_A
{
  ...
  class _get_dadda_AMI_Test
    : public TAO::Upcall_Command
  {
  public:
    inline _get_dadda_AMI_Test (
      POA_A::AMI_Test * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_A::AMI_Test::_get_dadda_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  static const unsigned char asso_values[] =
    {
     ...
     15, 14, 30,  0, 30,  5, 30, 30, 30, 30,
     30, 30,  0, 30, 30,  5,  0, 30, 30, 30,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_dadda", &POA_A::AMI_AMI_TestHandler::get_dadda_skel, 0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"set_yadda", &POA_A::AMI_AMI_TestHandler::set_yadda_skel, 0},
      {"get_yadda_excep", &POA_A::AMI_AMI_TestHandler::get_yadda_excep_skel, 0},
      {"get_dadda_excep", &POA_A::AMI_AMI_TestHandler::get_dadda_excep_skel, 0},
...
namespace POA_A
{
  ...
  class get_dadda_AMI_AMI_TestHandler
    : public TAO::Upcall_Command
  {
  public:
    inline get_dadda_AMI_AMI_TestHandler (
      POA_A::AMI_AMI_TestHandler * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_A::AMI_AMI_TestHandler::get_dadda_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  get_dadda_AMI_AMI_TestHandler command (
    impl,
    server_request.operation_details (),
    args);
...
namespace POA_A
{
  ...
  class get_dadda_excep_AMI_AMI_TestHandler
    : public TAO::Upcall_Command
  {
  public:
    inline get_dadda_excep_AMI_AMI_TestHandler (
      POA_A::AMI_AMI_TestHandler * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_A::AMI_AMI_TestHandler::get_dadda_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  get_dadda_excep_AMI_AMI_TestHandler command (
    impl,
    server_request.operation_details (),
    args);
