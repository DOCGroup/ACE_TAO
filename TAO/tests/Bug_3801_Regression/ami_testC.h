...
#ifndef _TAO_IDL_AMI_TESTC_WNNCQO_H_
#define _TAO_IDL_AMI_TESTC_WNNCQO_H_
...
namespace A
{
  ...
  class  DidTheRightThingB : public ::CORBA::UserException
  {
  public:
    ::CORBA::Long id;
    ::TAO::String_Manager whatDidTheRightThing;

    DidTheRightThingB (void);
    DidTheRightThingB (const DidTheRightThingB &);
    ~DidTheRightThingB (void);

    DidTheRightThingB &operator= (const DidTheRightThingB &);

    static void _tao_any_destructor (void *);

    static DidTheRightThingB *_downcast ( ::CORBA::Exception *);
    static const DidTheRightThingB *_downcast ( ::CORBA::Exception const *);
  ...
  extern  ::CORBA::TypeCode_ptr const _tc_DidTheRightThingB;
...
namespace A
{
   ...
   void operator<<= (::CORBA::Any &, const ::A::DidTheRightThingB &); // copying version
   void operator<<= (::CORBA::Any &, ::A::DidTheRightThingB*); // noncopying version
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::A::DidTheRightThingB *&); // deprecated
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const ::A::DidTheRightThingB *&);
}
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const A::DidTheRightThingB &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, A::DidTheRightThingB &);
