...
#ifndef _TAO_IDL_FOOS_0ZXLKM_CPP_
#define _TAO_IDL_FOOS_0ZXLKM_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"match_references", &POA_foo::match_references_skel, 0},
    };
...
class match_references_foo
  : public TAO::Upcall_Command
{
public:
  inline match_references_foo (
    POA_foo * servant,
  ...
  virtual void execute (void)
  {
    ...
    retval =
      this->servant_->match_references ();
  }
...
void POA_foo::match_references_skel (
