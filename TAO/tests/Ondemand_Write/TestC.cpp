  ...
  const char * inputb)
{
  ...
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_valuea (valuea);
  TAO::Arg_Traits< char *>::in_arg_val _tao_inputa (inputa);
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_valueb (valueb);
  TAO::Arg_Traits< char *>::in_arg_val _tao_inputb (inputb);
