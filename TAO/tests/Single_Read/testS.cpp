...
#ifndef _TAO_IDL_TESTS_6IE7C5_CPP_
#define _TAO_IDL_TESTS_6IE7C5_CPP_
...
public:
  ...
  virtual void execute (void)
  {
    ...
    TAO::SArg_Traits< ::test::data>::in_arg_type arg_2 =
      TAO::Portable_Server::get_in_arg< ::test::data> (
        this->operation_details_,
        this->args_,
        2);
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::ULong>::in_arg_val _tao_req_no;
  TAO::SArg_Traits< ::test::data>::in_arg_val _tao_d;
