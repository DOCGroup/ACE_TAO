...
#ifndef _TAO_IDL_TESTS_GNHBIR_CPP_
#define _TAO_IDL_TESTS_GNHBIR_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"print_hello_world", &POA_Test::print_hello_world_skel, 0},
    };
...
class print_hello_world_Test
  : public TAO::Upcall_Command
{
public:
  inline print_hello_world_Test (
    POA_Test * servant)
    : servant_ (servant)
  {
  }
  ...
  {
    this->servant_->print_hello_world ();
  }
...
void POA_Test::print_hello_world_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  print_hello_world_Test command (
    impl);
