...
#ifndef _TAO_IDL_QUOTERC_H9FZPN_H_
#define _TAO_IDL_QUOTERC_H9FZPN_H_
...
#define _QUOTER_MODIFY_STOCK__VAR_OUT_CH_
  ...
  extern  ::CORBA::TypeCode_ptr const _tc_Modify_Stock;
...
#define _QUOTER_MODIFY_STOCK__TRAITS_
  ...
  template<>
  struct  Objref_Traits< ::Quoter::Modify_Stock>
  {
...
namespace Quoter
{
   void operator<<= (::CORBA::Any &, const ::Quoter::Event &); // copying version
   void operator<<= (::CORBA::Any &, ::Quoter::Event*); // noncopying version
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::Quoter::Event *&); // deprecated
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const ::Quoter::Event *&);
}
...
namespace Quoter
{
   void operator<<= ( ::CORBA::Any &, Modify_Stock_ptr); // copying
   void operator<<= ( ::CORBA::Any &, Modify_Stock_ptr *); // non-copying
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Modify_Stock_ptr &);
}
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, Quoter::Modify_Stock_ptr); // copying
 void operator<<= (::CORBA::Any &, Quoter::Modify_Stock_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, Quoter::Modify_Stock_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Quoter::Event &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Quoter::Event &);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Quoter::Modify_Stock_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Quoter::Modify_Stock_ptr &);
