...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "include" /I "be_include" /I "../../" /D TAO_IDL_FE_HAS_DLL=1 /D "TAO_IDL_FE_BUILD_DLL" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "TAO_IDL_FE_DLL_EXPORTS" /YX /FD /c
