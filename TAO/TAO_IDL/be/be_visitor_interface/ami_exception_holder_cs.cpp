...
ACE_RCSID(be_visitor_interface, ami_exception_holder_cs, "$Id$")
...
be_visitor_interface_ami_exception_holder_cs::be_visitor_interface_ami_exception_holder_cs (be_visitor_context *ctx)
  : be_visitor_interface (ctx)
{
}

be_visitor_interface_ami_exception_holder_cs::~be_visitor_interface_ami_exception_holder_cs (void)
{
}

int
be_visitor_interface_ami_exception_holder_cs::visit_interface (be_interface *node)
{
  ...
  if (node->nmembers () > 0)
    ...
    if (!visitor)
      {
        ACE_ERROR_RETURN ((LM_ERROR,
                           "be_visitor_interface_ami_exception_holder_cs::"
                           "visit_operation - "
    ...
    if (bt->accept (visitor) == -1)
      {
        delete visitor;
        ACE_ERROR_RETURN ((LM_ERROR,
                           "(%N:%l) be_visitor_interface_ami_exception_holder_cs::"
                           "visit_interface - "
