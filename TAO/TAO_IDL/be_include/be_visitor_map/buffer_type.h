 ...
 *  This one provides code generation for the buffer type of the Map
 *  node.
 *
 *  @author Tyler Mayoff
 */
 ...
 *
 * @brief be_visitor_map_buffer_type
 *
 * This is a concrete visitor to generate the buffer type
 * for a map instantiation.
 */
class be_visitor_map_buffer_type : public be_visitor_decl
{
public:
  /// Constructor
  be_visitor_map_buffer_type (be_visitor_context *ctx);
