...
#ifndef _TAO_IDL_MESSENGERS_X088QW_CPP_
#define _TAO_IDL_MESSENGERS_X088QW_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},
      {"shutdown", &POA_Messenger::shutdown_skel, 0},
      {"",0,0},
...
class shutdown_Messenger
  : public TAO::Upcall_Command
{
public:
  inline shutdown_Messenger (
    POA_Messenger * servant)
    : servant_ (servant)
  {
  }
...
void POA_Messenger::shutdown_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
