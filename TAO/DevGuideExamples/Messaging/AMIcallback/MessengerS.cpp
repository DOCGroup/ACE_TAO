...
#ifndef _TAO_IDL_MESSENGERS_WRYTW3_CPP_
#define _TAO_IDL_MESSENGERS_WRYTW3_CPP_
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::out_arg_val _tao_time_sent;
...
/* C++ code produced by gperf version 2.8 (ACE version) */
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_AMI_MessengerHandler_Perfect_Hash_OpTable -N lookup  */
unsigned int
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_time_sent;
  ...
  POA_AMI_MessengerHandler * const impl =
    dynamic_cast<POA_AMI_MessengerHandler *> (servant);
...
void POA_AMI_MessengerHandler::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
