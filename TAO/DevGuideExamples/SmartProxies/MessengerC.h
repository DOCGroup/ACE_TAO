...
#ifndef _TAO_IDL_MESSENGERC_AW7KKP_H_
#define _TAO_IDL_MESSENGERC_AW7KKP_H_
...
protected:
  TAO_Messenger_Proxy_Factory_Adapter (void);
  ~TAO_Messenger_Proxy_Factory_Adapter (void);
  TAO_Messenger_Proxy_Factory_Adapter &operator= (
      const TAO_Messenger_Proxy_Factory_Adapter &
    );
  TAO_Messenger_Default_Proxy_Factory *proxy_factory_;
  bool one_shot_factory_;
  bool disable_factory_;
  TAO_SYNCH_RECURSIVE_MUTEX lock_;
};

typedef TAO_Singleton<TAO_Messenger_Proxy_Factory_Adapter, TAO_SYNCH_RECURSIVE_MUTEX> TAO_Messenger_PROXY_FACTORY_ADAPTER;

class  TAO_Messenger_Smart_Proxy_Base
  : public virtual Messenger,
    public virtual TAO_Smart_Proxy_Base
{
public:
  TAO_Messenger_Smart_Proxy_Base (void);
  ~TAO_Messenger_Smart_Proxy_Base (void);
...
virtual ::CORBA::Boolean send_message (
  ...
  ::Messenger_ptr get_proxy (void);
  ::Messenger_var proxy_;
};
