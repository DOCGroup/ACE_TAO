...
#ifndef _TAO_IDL_LOGGERS_YAHNGN_CPP_
#define _TAO_IDL_LOGGERS_YAHNGN_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"log_message", &POA_Logger::log_message_skel, 0},
    };
...
class log_message_Logger
  : public TAO::Upcall_Command
{
public:
  inline log_message_Logger (
    POA_Logger * servant,
...
void POA_Logger::log_message_skel (
