...
#ifndef _TAO_IDL_MESSENGERS_EMQIKB_H_
#define _TAO_IDL_MESSENGERS_EMQIKB_H_
...
#if !defined (_MESSAGE__SARG_TRAITS_)
#define _MESSAGE__SARG_TRAITS_
  ...
  template<>
  class SArg_Traits< ::Message::AddrList>
    : public
