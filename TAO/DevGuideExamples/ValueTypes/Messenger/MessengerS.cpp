...
#include "_pch.h"
#ifndef _TAO_IDL_MESSENGERS_EMQIKB_CPP_
#define _TAO_IDL_MESSENGERS_EMQIKB_CPP_
...
public:
  ...
  virtual void execute (void)
  {
    ...
    TAO::SArg_Traits< ::Message>::inout_arg_type arg_1 =
      TAO::Portable_Server::get_inout_arg< ::Message> (
        this->operation_details_,
        this->args_,
        1);
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Message>::inout_arg_val _tao_msg;
