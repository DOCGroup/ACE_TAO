  ...
  ::CORBA::Long req)
{
  ...
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_thread (thread);
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_iter (iter);
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_obj (obj);
  TAO::Arg_Traits< ::CORBA::Long>::in_arg_val _tao_req (req);
