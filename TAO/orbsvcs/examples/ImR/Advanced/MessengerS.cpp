...
#ifndef _TAO_IDL_MESSENGERS_NTTMFW_CPP_
#define _TAO_IDL_MESSENGERS_NTTMFW_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"shutdownOrb", &POA_Messenger::shutdownOrb_skel, 0},
      {"",0,0},
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_thread;
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_iter;
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_obj;
  TAO::SArg_Traits< ::CORBA::Long>::in_arg_val _tao_req;
...
class shutdownOrb_Messenger
  : public TAO::Upcall_Command
{
public:
  inline shutdownOrb_Messenger (
    POA_Messenger * servant)
    : servant_ (servant)
  {
  }
...
void POA_Messenger::shutdownOrb_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
