...
#ifndef _TAO_IDL_TESTS_KJRBGF_CPP_
#define _TAO_IDL_TESTS_KJRBGF_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"send_line", &POA_Simple_Server::send_line_skel, 0},
...
class send_line_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline send_line_Simple_Server (
...
void POA_Simple_Server::send_line_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::in_arg_val _tao_line;
  ...
  send_line_Simple_Server command (
    impl,
