...
#ifndef _TAO_IDL_OBJECTREFERENCEFACTORYC_YSTUVK_H_
#define _TAO_IDL_OBJECTREFERENCEFACTORYC_YSTUVK_H_
...
#define _ORT_OBJECTREFERENCEFACTORY__VAR_OUT_CH_
  ...
  protected:
    ...
    virtual ::CORBA::Boolean
    _tao_unmarshal__ORT_ObjectReferenceFactory (TAO_InputCDR &, TAO_ChunkInfo &) = 0;
  };
...
#if !defined (_ORT_OBJECTREFERENCEFACTORY__ARG_TRAITS_)
#define _ORT_OBJECTREFERENCEFACTORY__ARG_TRAITS_

  template<>
  class Arg_Traits< ::ORT::ObjectReferenceFactory>
    : public
        Object_Arg_Traits_T<
            ::ORT::ObjectReferenceFactory *,
            ::ORT::ObjectReferenceFactory_var,
            ::ORT::ObjectReferenceFactory_out,
            TAO::Value_Traits<ORT::ObjectReferenceFactory>,
...
namespace OBV_ORT
{
  ...
  // OBV_ class
  class  ObjectReferenceFactory
    : public virtual ORT::ObjectReferenceFactory
  {
...
protected:
  ...
  virtual ::CORBA::Boolean
  _tao_unmarshal__ORT_ObjectReferenceFactory (TAO_InputCDR &, TAO_ChunkInfo &);
...
#if !defined (_ORT_OBJECTREFERENCEFACTORY__TRAITS_)
#define _ORT_OBJECTREFERENCEFACTORY__TRAITS_

  template<>
  struct  Value_Traits<ORT::ObjectReferenceFactory>
  {
    static void add_ref (ORT::ObjectReferenceFactory *);
    static void remove_ref (ORT::ObjectReferenceFactory *);
    static void release (ORT::ObjectReferenceFactory *);
  };
...
namespace CORBA
{
  extern  void add_ref (ORT::ObjectReferenceFactory *);
  extern  void remove_ref (ORT::ObjectReferenceFactory *);
}
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const ORT::ObjectReferenceFactory *);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, ORT::ObjectReferenceFactory *&);
