...
//   Based on previous work by Carlos O'Ryan (coryan@cs.wustl.edu)
//
// ============================================================================
...
public:
  ...
  //Allows the address to be set after the object is constructed
  virtual void set_addr (const RtecUDPAdmin::UDP_Addr& addr
