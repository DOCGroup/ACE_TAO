...
#ifndef _TAO_IDL_TESTS_Z9EAWR_CPP_
#define _TAO_IDL_TESTS_Z9EAWR_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"method", &POA_server::method_skel, 0},
      {"",0,0},
