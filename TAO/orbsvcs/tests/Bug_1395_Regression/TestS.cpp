...
#ifndef _TAO_IDL_TESTS_8L3K6P_CPP_
#define _TAO_IDL_TESTS_8L3K6P_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},
      {"try_and_create_POA", &POA_Test::try_and_create_POA_skel, 0},
    };
...
class try_and_create_POA_Test
  : public TAO::Upcall_Command
{
public:
  inline try_and_create_POA_Test (
    POA_Test * servant,
  ...
  virtual void execute (void)
  {
    ...
    retval =
      this->servant_->try_and_create_POA ();
  }
...
void POA_Test::try_and_create_POA_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  try_and_create_POA_Test command (
    impl,
