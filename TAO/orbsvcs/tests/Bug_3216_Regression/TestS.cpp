...
#ifndef _TAO_IDL_TESTS_V1RB5V_CPP_
#define _TAO_IDL_TESTS_V1RB5V_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"check_normal_context", &POA_Test::Hello::check_normal_context_skel, 0},
      {"",0,0},
      {"check_extended_context", &POA_Test::Hello::check_extended_context_skel, 0},
    };
...
namespace POA_Test
{
  ...
  class check_normal_context_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline check_normal_context_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
    ...
    virtual void execute (void)
    {
      this->servant_->check_normal_context ();
    }
...
void POA_Test::Hello::check_normal_context_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  check_normal_context_Hello command (
    impl);
...
namespace POA_Test
{
  ...
  class check_extended_context_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline check_extended_context_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
    ...
    virtual void execute (void)
    {
      this->servant_->check_extended_context ();
    }
...
void POA_Test::Hello::check_extended_context_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  check_extended_context_Hello command (
    impl);
