...
#ifndef _TAO_IDL_TESTS_ZNFPHO_CPP_
#define _TAO_IDL_TESTS_ZNFPHO_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"myMethod", &POA_Test::myMethod_skel, 0},
