...
#ifndef _TAO_IDL_TESTS_DHHFZQ_CPP_
#define _TAO_IDL_TESTS_DHHFZQ_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"abort", &POA_Simple_Server::abort_skel, 0},
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::ret_val retval;
  TAO::SArg_Traits< char *>::in_arg_val _tao_ior_file;
...
class abort_Simple_Server
  : public TAO::Upcall_Command
{
public:
  inline abort_Simple_Server (
    POA_Simple_Server * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
...
void POA_Simple_Server::abort_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
