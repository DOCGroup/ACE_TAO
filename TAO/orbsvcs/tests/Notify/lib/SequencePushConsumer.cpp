...
void TAO_NS_SequencePushConsumer::init
...
TAO_NS_SequencePushConsumer::_default_POA (
...
TAO_NS_SequencePushConsumer::get_proxy_supplier (void)
{
  return proxy_supplier_.in ();
}

void
TAO_NS_SequencePushConsumer::connect (
...
void
TAO_NS_SequencePushConsumer::deactivate (ACE_ENV_SINGLE_ARG_DECL)
{
...
void
TAO_NS_SequencePushConsumer::disconnect (ACE_ENV_SINGLE_ARG_DECL)
{
...
void
TAO_NS_SequencePushConsumer::offer_change
...
void
TAO_NS_SequencePushConsumer::disconnect_sequence_push_consumer (
