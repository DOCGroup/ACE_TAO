...
#ifndef _TAO_IDL___GOC_KCEA00_H_
#define _TAO_IDL___GOC_KCEA00_H_
...
extern  ::CORBA::TypeCode_ptr const _tc_sig;
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 void operator<<= (::CORBA::Any &, sig_ptr); // copying
 void operator<<= (::CORBA::Any &, sig_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, sig_ptr &);
TAO_END_VERSIONED_NAMESPACE_DECL
