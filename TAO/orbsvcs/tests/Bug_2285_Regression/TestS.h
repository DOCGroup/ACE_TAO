...
#ifndef _TAO_IDL_TESTS_CUPTLU_H_
#define _TAO_IDL_TESTS_CUPTLU_H_
...
namespace POA_Test
{
  ...
  public:
    ...
    static void throw_exception_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void check_request_id_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void drop_down_dead_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
  };
