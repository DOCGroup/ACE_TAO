...
#ifndef _TAO_IDL_TESTS_FVDVIV_CPP_
#define _TAO_IDL_TESTS_FVDVIV_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"call_back", &POA_Test::Hello::call_back_skel, 0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"",0,0},
      {"call_me_back", &POA_Test::Hello::call_me_back_skel, 0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"",0,0},
      {"throw_exception", &POA_Test::Hello::throw_exception_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"check_request_id", &POA_Test::Hello::check_request_id_skel, 0},
      {"",0,0},{"",0,0},
      {"drop_down_dead", &POA_Test::Hello::drop_down_dead_skel, 0},
    };
...
namespace POA_Test
{
  ...
  class throw_exception_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline throw_exception_Hello (
      POA_Test::Hello * servant)
      : servant_ (servant)
    {
    }
...
void POA_Test::Hello::throw_exception_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
namespace POA_Test
{
  ...
  class call_me_back_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline call_me_back_Hello (
      POA_Test::Hello * servant,
...
void POA_Test::Hello::call_me_back_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::Test::Hello>::in_arg_val _tao_me;
...
namespace POA_Test
{
  ...
  class call_back_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline call_back_Hello (
      POA_Test::Hello * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_Test::Hello::call_back_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
...
namespace POA_Test
{
  ...
  class check_request_id_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline check_request_id_Hello (
      POA_Test::Hello * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_Test::Hello::check_request_id_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  check_request_id_Hello command (
    impl,
    server_request.operation_details (),
    args);
...
namespace POA_Test
{
  ...
  class drop_down_dead_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline drop_down_dead_Hello (
      POA_Test::Hello * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_Test::Hello::drop_down_dead_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
