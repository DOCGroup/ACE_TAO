...
#ifndef _TAO_IDL_TESTC_RATPBN_H_
#define _TAO_IDL_TESTC_RATPBN_H_
...
#define _TEST_HELLO__VAR_OUT_CH_
  ...
  public:
    ...
    virtual ::CORBA::Boolean call_me_back (
      ::Test::Hello_ptr me);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::MyException &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::MyException &);
