...
#ifndef _TAO_IDL_TESTS_M2BTDS_CPP_
#define _TAO_IDL_TESTS_M2BTDS_CPP_
...
class TAO_Test_NsShutdown_Perfect_Hash_OpTable
  : public TAO_Perfect_Hash_OpTable
{
private:
  unsigned int hash (const char *str, unsigned int len);
...
/* C++ code produced by gperf version 2.8 (ACE version) */
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_Test_NsShutdown_Perfect_Hash_OpTable -N lookup  */
unsigned int
TAO_Test_NsShutdown_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
  static const unsigned char asso_values[] =
    {
...
const TAO_operation_db_entry *
TAO_Test_NsShutdown_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 6,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"_is_a", &TAO_ServantBase::_is_a_thru_poa_skel, 0},
      {"",0,0},{"",0,0},
      {"shutdown", &POA_Test::NsShutdown::shutdown_skel, 0},
      {"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"",0,0},{"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
...
static TAO_Test_NsShutdown_Perfect_Hash_OpTable tao_Test_NsShutdown_optable;

// TAO_IDL - Generated from
// be/be_visitor_interface/interface_ss.cpp:90

POA_Test::NsShutdown::NsShutdown (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_Test_NsShutdown_optable;
}

POA_Test::NsShutdown::NsShutdown (const NsShutdown& rhs)
  : TAO_Abstract_ServantBase (rhs),
    TAO_ServantBase (rhs)
{
}
...
namespace POA_Test
{
  ...
  class shutdown_NsShutdown
    : public TAO::Upcall_Command
  {
  public:
    inline shutdown_NsShutdown (
      POA_Test::NsShutdown * servant)
      : servant_ (servant)
    {
    }
  ...
  private:
    POA_Test::NsShutdown * const servant_;
  };
}
...
void POA_Test::NsShutdown::shutdown_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  POA_Test::NsShutdown * const impl =
    dynamic_cast<POA_Test::NsShutdown *> (servant);
...
::CORBA::Boolean POA_Test::NsShutdown::_is_a (const char* value)
{
  return
    (
      ACE_OS::strcmp (
          value,
          "IDL:Test/NsShutdown:1.0"
        ) == 0 ||
      !ACE_OS::strcmp (
          value,
          "IDL:omg.org/CORBA/Object:1.0"
...
const char* POA_Test::NsShutdown::_interface_repository_id (void) const
{
  return "IDL:Test/NsShutdown:1.0";
}

// TAO_IDL - Generated from
// be/be_visitor_interface/interface_ss.cpp:423

void POA_Test::NsShutdown::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
...
Test::NsShutdown *
POA_Test::NsShutdown::_this (void)
{
  TAO_Stub *stub = this->_create_stub ();
  ...
  typedef ::Test::NsShutdown STUB_SCOPED_NAME;
  return
    TAO::Narrow_Utils<STUB_SCOPED_NAME>::unchecked_narrow (
        obj.in ());
}
