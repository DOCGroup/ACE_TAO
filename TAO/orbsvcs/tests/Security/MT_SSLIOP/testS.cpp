...
#ifndef _TAO_IDL_TESTS_8IAW3C_CPP_
#define _TAO_IDL_TESTS_8IAW3C_CPP_
...
class TAO_Another_One_Perfect_Hash_OpTable
  : public TAO_Perfect_Hash_OpTable
{
private:
  unsigned int hash (const char *str, unsigned int len);
...
/* C++ code produced by gperf version 2.8 (ACE version) */
/* Command-line: /mnt/win_d/projects/ATCD/ACE/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_Another_One_Perfect_Hash_OpTable -N lookup  */
unsigned int
TAO_Another_One_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
  static const unsigned char asso_values[] =
    {
     16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
...
const TAO_operation_db_entry *
TAO_Another_One_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 6,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"_component", &TAO_ServantBase::_component_thru_poa_skel, 0},
      {"test_method", &POA_Another_One::test_method_skel, 0},
      {"",0,0},
      {"_non_existent", &TAO_ServantBase::_non_existent_thru_poa_skel, 0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
...
static TAO_Another_One_Perfect_Hash_OpTable tao_Another_One_optable;

// TAO_IDL - Generated from
// be/be_visitor_interface/interface_ss.cpp:90

POA_Another_One::POA_Another_One (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_Another_One_optable;
}

POA_Another_One::POA_Another_One (const POA_Another_One& rhs)
  : TAO_Abstract_ServantBase (rhs),
    TAO_ServantBase (rhs)
{
}
...
class test_method_Another_One
  : public TAO::Upcall_Command
{
public:
  inline test_method_Another_One (
    POA_Another_One * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
      , operation_details_ (operation_details)
...
private:
  POA_Another_One * const servant_;
  TAO_Operation_Details const * const operation_details_;
  TAO::Argument * const * const args_;
};
...
void POA_Another_One::test_method_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  POA_Another_One * const impl =
    dynamic_cast<POA_Another_One *> (servant);
  ...
  test_method_Another_One command (
    impl,
    server_request.operation_details (),
    args);
...
::CORBA::Boolean POA_Another_One::_is_a (const char* value)
{
  return
    (
      ACE_OS::strcmp (
...
const char* POA_Another_One::_interface_repository_id (void) const
{
...
void POA_Another_One::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
...
POA_Another_One::_this (void)
{
  ...
  typedef ::Another_One STUB_SCOPED_NAME;
  return
    TAO::Narrow_Utils<STUB_SCOPED_NAME>::unchecked_narrow (
        obj.in ());
}
