...
// Traits specializations for Another_One.

Another_One_ptr
TAO::Objref_Traits<Another_One>::duplicate (
    Another_One_ptr p)
{
  return Another_One::_duplicate (p);
}

void
TAO::Objref_Traits<Another_One>::release (
    Another_One_ptr p)
{
  ::CORBA::release (p);
}
...
Another_One_ptr
TAO::Objref_Traits<Another_One>::nil (void)
{
  return Another_One::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<Another_One>::marshal (
...
{
  return
    TAO::Narrow_Utils<Another_One>::narrow (
        _tao_objref,
        "IDL:Another_One:1.0");
}

Another_One_ptr
Another_One::_unchecked_narrow (
    ::CORBA::Object_ptr _tao_objref)
{
  return
    TAO::Narrow_Utils<Another_One>::unchecked_narrow (
        _tao_objref);
}

Another_One_ptr
Another_One::_nil (void)
{
  return 0;
}

Another_One_ptr
Another_One::_duplicate (Another_One_ptr obj)
{
  if (! ::CORBA::is_nil (obj))
    {
      obj->_add_ref ();
...
void
Another_One::_tao_release (Another_One_ptr obj)
{
  ::CORBA::release (obj);
}

::CORBA::Boolean
Another_One::_is_a (const char *value)
{
  if (
      ACE_OS::strcmp (
          value,
...
const char* Another_One::_interface_repository_id (void) const
{
  return "IDL:Another_One:1.0";
}

::CORBA::Boolean
Another_One::marshal (TAO_OutputCDR &cdr)
{
  return (cdr << this);
}
...
::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
    const Another_One_ptr _tao_objref)
{
  ::CORBA::Object_ptr _tao_corba_obj = _tao_objref;
  return (strm << _tao_corba_obj);
}
    ...
    Another_One_ptr &_tao_objref)
{
  ...
  typedef ::Another_One RHS_SCOPED_NAME;
