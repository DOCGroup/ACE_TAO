...
#ifndef _TAO_IDL_TESTC_EVPVFI_H_
#define _TAO_IDL_TESTC_EVPVFI_H_
...
#if !defined (_ANOTHER_ONE__VAR_OUT_CH_)
#define _ANOTHER_ONE__VAR_OUT_CH_

class Another_One;
typedef Another_One *Another_One_ptr;
...
{
public:
  friend class TAO::Narrow_Utils<Another_One>;

  // TAO_IDL - Generated from
  // be/be_type.cpp:304

  typedef Another_One_ptr _ptr_type;
  typedef Another_One_var _var_type;
  typedef Another_One_out _out_type;

  // The static operations.
  static Another_One_ptr _duplicate (Another_One_ptr obj);

  static void _tao_release (Another_One_ptr obj);

  static Another_One_ptr _narrow (::CORBA::Object_ptr obj);
  static Another_One_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
  static Another_One_ptr _nil (void);
...
protected:
  ...
  virtual ~Another_One (void);

private:
  // Private and unimplemented for concrete interfaces.
  Another_One (const Another_One &);

  void operator= (const Another_One &);
};
...
#if !defined (_ANOTHER_ONE__ARG_TRAITS_)
#define _ANOTHER_ONE__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::Another_One>
    : public
        Object_Arg_Traits_T<
            ::Another_One_ptr,
            ::Another_One_var,
            ::Another_One_out,
            TAO::Objref_Traits<Another_One>,
            TAO::Any_Insert_Policy_Noop
          >
  {
  };
...
#if !defined (_ANOTHER_ONE__TRAITS_)
#define _ANOTHER_ONE__TRAITS_

  template<>
  struct  Objref_Traits< ::Another_One>
  {
    static ::Another_One_ptr duplicate (
        ::Another_One_ptr p);
    static void release (
        ::Another_One_ptr p);
    static ::Another_One_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::Another_One_ptr p,
        TAO_OutputCDR & cdr);
  };
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Another_One_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Another_One_ptr &);
