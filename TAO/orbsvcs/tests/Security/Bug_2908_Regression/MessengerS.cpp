...
#ifndef _TAO_IDL_MESSENGERS_E9PCQ2_CPP_
#define _TAO_IDL_MESSENGERS_E9PCQ2_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"call_message", &POA_Messenger::call_message_skel, 0},
...
class call_message_Messenger
  : public TAO::Upcall_Command
{
public:
  inline call_message_Messenger (
    POA_Messenger * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
