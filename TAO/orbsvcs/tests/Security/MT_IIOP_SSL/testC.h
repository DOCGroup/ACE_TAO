...
#ifndef _TAO_IDL_TESTC_JCGH7N_H_
#define _TAO_IDL_TESTC_JCGH7N_H_
...
public:
  ...
  class  WrongProtocolType : public ::CORBA::UserException
  {
  public:

    WrongProtocolType (void);
    WrongProtocolType (const WrongProtocolType &);
    ~WrongProtocolType (void);

    WrongProtocolType &operator= (const WrongProtocolType &);

    static WrongProtocolType *_downcast ( ::CORBA::Exception *);
    static const WrongProtocolType *_downcast ( ::CORBA::Exception const *);
  ...
  virtual void validate_protocol (
    void);
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Simple_Server::WrongProtocolType &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Simple_Server::WrongProtocolType &);
