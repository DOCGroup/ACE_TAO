...
# ADD LINK32 TAO.lib ace.lib TAO_CosNaming.lib TAO_RTSched.lib /nologo /subsystem:console /machine:I386 /out:"Sched_Conf.exe" /libpath:"..\..\..\tao" /libpath:"..\..\..\..\ace" /libpath:"..\..\orbsvcs"
...
# ADD LINK32 TAOd.lib aced.lib TAO_CosNamingd.lib TAO_RTSchedd.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"..\..\orbsvcs" /libpath:"..\..\..\tao" /libpath:"..\..\..\..\ace"
