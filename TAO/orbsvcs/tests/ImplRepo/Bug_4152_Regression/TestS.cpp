...
#ifndef _TAO_IDL_TESTS_PL7CP0_CPP_
#define _TAO_IDL_TESTS_PL7CP0_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"terminate", &POA_Test::terminate_skel, 0},
...
class terminate_Test
  : public TAO::Upcall_Command
{
public:
  inline terminate_Test (
    POA_Test * servant)
    : servant_ (servant)
  {
  }
