...
#ifndef _TAO_IDL_MESSENGERS_O4GOHI_CPP_
#define _TAO_IDL_MESSENGERS_O4GOHI_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"abort", &POA_Messenger::abort_skel, 0},
...
class abort_Messenger
  : public TAO::Upcall_Command
{
public:
  inline abort_Messenger (
    POA_Messenger * servant,
    TAO_Operation_Details const * operation_details,
    TAO::Argument * const args[])
    : servant_ (servant)
