...
#ifndef _TAO_IDL_TESTS_HGNPZZ_CPP_
#define _TAO_IDL_TESTS_HGNPZZ_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_call_count", &POA_Test::get_call_count_skel, 0},
...
class get_call_count_Test
  : public TAO::Upcall_Command
{
public:
  inline get_call_count_Test (
    POA_Test * servant,
...
void POA_Test::get_call_count_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
