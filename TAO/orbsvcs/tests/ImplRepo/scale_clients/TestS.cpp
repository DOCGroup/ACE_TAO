...
#ifndef _TAO_IDL_TESTS_YSXACU_CPP_
#define _TAO_IDL_TESTS_YSXACU_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_num_requests", &POA_Test::get_num_requests_skel, 0},
    };
...
class get_num_requests_Test
  : public TAO::Upcall_Command
{
public:
  inline get_num_requests_Test (
    POA_Test * servant,
  ...
  virtual void execute (void)
  {
    ...
    retval =
      this->servant_->get_num_requests (
        arg_1);
  }
...
void POA_Test::get_num_requests_skel (
