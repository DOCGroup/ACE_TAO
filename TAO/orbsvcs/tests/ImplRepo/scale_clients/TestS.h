...
#ifndef _TAO_IDL_TESTS_2LF6HG_H_
#define _TAO_IDL_TESTS_2LF6HG_H_
...
public:
  ...
  virtual ::CORBA::Short get_num_requests (
    ::CORBA::Short delay_secs) = 0;

  static void get_num_requests_skel (
