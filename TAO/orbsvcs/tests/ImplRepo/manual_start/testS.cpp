...
#ifndef _TAO_IDL_TESTS_MZNW2P_CPP_
#define _TAO_IDL_TESTS_MZNW2P_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"contact", &POA_Test::contact_skel, 0},
      {"",0,0},{"",0,0},
