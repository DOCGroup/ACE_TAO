...
#ifndef _TAO_IDL_TESTS_JLNP3F_CPP_
#define _TAO_IDL_TESTS_JLNP3F_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},
      {"server_pid", &POA_Test::server_pid_skel, 0},
...
class server_pid_Test
  : public TAO::Upcall_Command
{
public:
  inline server_pid_Test (
    POA_Test * servant,
