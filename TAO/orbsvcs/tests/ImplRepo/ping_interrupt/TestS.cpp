...
#ifndef _TAO_IDL_TESTS_C2EKV8_CPP_
#define _TAO_IDL_TESTS_C2EKV8_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"get_server_num", &POA_Test::get_server_num_skel, 0},
...
class get_server_num_Test
  : public TAO::Upcall_Command
{
public:
  inline get_server_num_Test (
    POA_Test * servant,
...
void POA_Test::get_server_num_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< ::CORBA::Short>::in_arg_val _tao_delay_secs;
