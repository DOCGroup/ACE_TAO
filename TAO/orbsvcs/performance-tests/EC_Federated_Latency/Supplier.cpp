...
ACE_RCSID(EC_Federated_Latency, Supplier, "$Id$")

ECFL_Supplier::ECFL_Supplier (CORBA::Long experiment_id)
                        ...
                        ACE_ENV_ARG_DECL)
{
  ...
  sh0.type   = ECFL_START_EVENT_TYPE;
...
void
ECFL_Supplier::disconnect (ACE_ENV_SINGLE_ARG_DECL)
{
...
void
ECFL_Supplier::disconnect_push_supplier (ACE_ENV_SINGLE_ARG_DECL_NOT_USED)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  ACE_GUARD (TAO_SYNCH_MUTEX, ace_mon, this->mutex_);
  this->proxy_consumer_ =
