  ...
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  ...
  TAO_IDLType_i *impl = this->path_to_idltype (result_path);
  ...
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  ...
  CORBA::Object_var obj = this->path_to_ir_object (result_path
  ...
  for (i = 0; i < size; ++i)
    {
      ...
      TAO_IDLType_i *impl = path_to_idltype (type_path);
