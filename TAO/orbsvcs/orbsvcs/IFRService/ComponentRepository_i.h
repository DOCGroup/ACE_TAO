...
public:
  ...
  TAO_Container_i *select_container (CORBA::DefinitionKind def_kind) const override;
  TAO_Contained_i *select_contained (CORBA::DefinitionKind def_kind) const override;
