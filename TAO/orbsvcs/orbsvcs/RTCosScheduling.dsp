...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../../.." /I "../.." /I ".." /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "TAO_RTCOSSCHEDULING_BUILD_DLL" /YX /FD /c
...
# ADD LINK32 TAO.lib ace.lib TAO_RTPortableServer.lib TAO_RTCORBA.lib TAO_PortableServer.lib TAO_IORInterceptor.lib TAO_Valuetype.lib TAO_ObjRefTemplate.lib /nologo /dll /machine:I386 /out:"..\..\..\bin\TAO_RTCosScheduling.dll" /libpath:"..\..\tao\RTPortableServer" /libpath:"..\..\tao" /libpath:"..\..\..\ace" /libpath:"..\..\tao\RTCORBA" /libpath:"..\..\tao\PortableServer" /libpath:"..\..\tao\IORInterceptor" /libpath:"..\..\tao\Valuetype" /libpath:"..\..\tao\ObjRefTemplate" /libpath:"..\..\..\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /Zi /Od /I "../../.." /I "../.." /I ".." /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "TAO_RTCOSSCHEDULING_BUILD_DLL" /YX /FD  /c
...
# ADD LINK32 TAOd.lib aced.lib TAO_RTPortableServerd.lib TAO_RTCORBAd.lib TAO_PortableServerd.lib TAO_IORInterceptord.lib TAO_Valuetyped.lib TAO_ObjRefTemplated.lib /nologo /dll /debug /machine:I386 /out:"..\..\..\bin\TAO_RTCosSchedulingd.dll" /pdbtype:sept /libpath:"..\..\tao\RTPortableServer" /libpath:"..\..\tao" /libpath:"..\..\..\ace" /libpath:"..\..\tao\RTCORBA" /libpath:"..\..\tao\PortableServer" /libpath:"..\..\tao\IORInterceptor" /libpath:"..\..\tao\Valuetype" /libpath:"..\..\tao\ObjRefTemplate" /libpath:"..\..\..\lib"
...
SOURCE=.\RTCosSchedulingC.cpp
# End Source File
# Begin Source File

SOURCE=.\RTCosSchedulingS.cpp
# End Source File
# End Group
...
SOURCE=.\RTCosScheduling\RTCosScheduling_export.h
# End Source File
# Begin Source File
...
SOURCE=.\RTCosSchedulingC.h
# End Source File
# Begin Source File

SOURCE=.\RTCosSchedulingS.h
# End Source File
# End Group
...
BuildCmds= \
	..\..\..\bin\tao_idl -Ge 1 -I../../ -I../../tao  -Wb,pre_include=ace/pre.h -Wb,post_include=ace/post.h -Wb,export_macro=TAO_RTCosScheduling_Export -Wb,export_include=RTCosScheduling\RTCosScheduling_export.h $(InputName).idl
