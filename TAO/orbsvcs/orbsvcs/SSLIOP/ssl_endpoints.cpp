...
void operator<<= (
    CORBA::Any &_tao_any,
    const TAO_SSLEndpointSequence &_tao_elem
  ) // copying
{
...
void operator<<= (CORBA::Any &_tao_any, TAO_SSLEndpointSequence *_tao_elem) // non copying
{
  TAO_OutputCDR stream;
  stream << *_tao_elem;
  _tao_any._tao_replace (
      ...
      1,
      _tao_elem,
      TAO_SSLEndpointSequence::_tao_any_destructor
    );
}

CORBA::Boolean operator>>= (const CORBA::Any &_tao_any, TAO_SSLEndpointSequence *&_tao_elem)
{
...
CORBA::Boolean operator>>= (const CORBA::Any &_tao_any, const TAO_SSLEndpointSequence *&_tao_elem)
{
  _tao_elem = 0;
  ACE_TRY_NEW_ENV
  {
    CORBA::TypeCode_var type = _tao_any.type ();
    if (!type->equivalent (_tc_TAO_SSLEndpointSequence, ACE_TRY_ENV)) // not equal
      {
        return 0;
      }
    ACE_TRY_CHECK;
    ...
    {
      TAO_SSLEndpointSequence *tmp;
      ACE_NEW_RETURN (tmp, TAO_SSLEndpointSequence, 0);
      TAO_InputCDR stream (
