...
void
TAO_NS_RTCORBA_POA_Helper::init (PortableServer::POA_ptr parent_poa, NotifyExt::ThreadPoolLanesParams* tpl_params ACE_ENV_ARG_DECL)
{
  char child_poa_name[32];
  ACE_OS_String::itoa (ACE_OS::rand (), child_poa_name, 10);
...
void
TAO_NS_RTCORBA_POA_Helper::init (PortableServer::POA_ptr parent_poa, const char* poa_name, NotifyExt::ThreadPoolLanesParams* tpl_params ACE_ENV_ARG_DECL)
{
  CORBA::PolicyList policy_list (4);
