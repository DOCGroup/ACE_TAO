...
CORBA::TypeCode_ptr RtecScheduler::_tc_Time = CORBA::_tc_double;
CORBA::TypeCode_ptr RtecScheduler::_tc_Period = CORBA::_tc_long;
CORBA::TypeCode_ptr RtecScheduler::_tc_Quantum = RtecScheduler::_tc_Period;
...
CORBA::TypeCode_ptr RtecScheduler::_tc_handle_t = CORBA::_tc_long;
...
// *************************************************************
// class RtecScheduler::Dependency_Set
// *************************************************************

// copy constructor
RtecScheduler::Dependency_Set::Dependency_Set (const RtecScheduler::Dependency_Set &seq)
	: maximum_ (seq.maximum_),
	  length_ (seq.length_),
	  buffer_ (RtecScheduler::Dependency_Set::allocbuf (seq.maximum_)),
...
RtecScheduler::Dependency_Set::~Dependency_Set (void)
{
  ...
  {
    RtecScheduler::Dependency_Set::freebuf (this->buffer_);
  }
}

// assignment operator
RtecScheduler::Dependency_Set& 
RtecScheduler::Dependency_Set::operator= (const RtecScheduler::Dependency_Set &seq)
{
  ...
  this->buffer_ = RtecScheduler::Dependency_Set::allocbuf (seq.maximum_),
...
static CORBA::TypeCode _tc__tc_RtecScheduler_Dependency_Set (CORBA::tk_sequence, sizeof (_oc_RtecScheduler_Dependency_Set), (unsigned char *) &_oc_RtecScheduler_Dependency_Set, CORBA::B_FALSE);
CORBA::TypeCode_ptr RtecScheduler::_tc_Dependency_Set = &_tc__tc_RtecScheduler_Dependency_Set;

CORBA::TypeCode_ptr RtecScheduler::_tc_OS_Priority = CORBA::_tc_long;

CORBA::TypeCode_ptr RtecScheduler::_tc_Sub_Priority = CORBA::_tc_long;

CORBA::TypeCode_ptr RtecScheduler::_tc_Preemption_Priority = CORBA::_tc_long;
...
// *************************************************************
// class RtecScheduler::RT_Info_Set
// *************************************************************

// copy constructor
RtecScheduler::RT_Info_Set::RT_Info_Set (const RtecScheduler::RT_Info_Set &seq)
	: maximum_ (seq.maximum_),
	  length_ (seq.length_),
	  buffer_ (RtecScheduler::RT_Info_Set::allocbuf (seq.maximum_)),
	  release_ (1) // we always own it
{
  for (CORBA::ULong i=0; i < seq.length_; i++)
  	this->buffer_[i] = seq.buffer_[i];
...
RtecScheduler::RT_Info_Set::~RT_Info_Set (void)
{
  if (this->release_) // we own the buffer
  {
    RtecScheduler::RT_Info_Set::freebuf (this->buffer_);
  }
}

// assignment operator
RtecScheduler::RT_Info_Set& 
RtecScheduler::RT_Info_Set::operator= (const RtecScheduler::RT_Info_Set &seq)
{
  if (this == &seq) return *this;
  if (this->release_)
  {
  ...
  this->length_ = seq.length_;
  this->maximum_ = seq.maximum_;
  this->buffer_ = RtecScheduler::RT_Info_Set::allocbuf (seq.maximum_),
  this->release_ =1; // we always own it
  for (CORBA::ULong i=0; i < seq.length_; i++)
  	this->buffer_[i] = seq.buffer_[i];
  return *this;
...
static CORBA::TypeCode _tc__tc_RtecScheduler_RT_Info_Set (CORBA::tk_sequence, sizeof (_oc_RtecScheduler_RT_Info_Set), (unsigned char *) &_oc_RtecScheduler_RT_Info_Set, CORBA::B_FALSE);
...
RtecScheduler::Scheduler_ptr RtecScheduler::Scheduler::_bind (const char *host, CORBA::ULong port, const char *key, CORBA::Environment &env)
{
