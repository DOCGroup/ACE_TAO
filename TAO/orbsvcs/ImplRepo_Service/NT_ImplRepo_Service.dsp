# Microsoft Developer Studio Project File - Name="NT_ImplRepo_Service" - Package Owner=<4>
...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "..\\" /I "..\..\\" /I "..\..\..\\" /I "..\..\tao\DynamicInterface" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 TAO_Svc_Utils.lib TAO_DynamicInterface.lib TAO_IORTable.lib TAO_PortableServer.lib TAO.lib ace.lib user32.lib advapi32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"..\orbsvcs" /libpath:"..\..\tao\DynamicInterface" /libpath:"..\..\tao\PortableServer" /libpath:"..\..\tao\IORTable" /libpath:"..\..\tao" /libpath:"..\..\..\ace"
...
# ADD LINK32 TAO_Svc_Utilsd.lib TAO_DynamicInterfaced.lib TAO_IORTabled.lib TAO_PortableServerd.lib TAOd.lib aced.lib user32.lib advapi32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"..\orbsvcs" /libpath:"..\..\tao\DynamicInterface" /libpath:"..\..\tao\PortableServer" /libpath:"..\..\tao\IORTable" /libpath:"..\..\tao" /libpath:"..\..\..\ace"
