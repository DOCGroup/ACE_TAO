...
#define _PORTABLEINTERCEPTOR_INTERCEPTOR___VAR_CH_
  ...
  class  Interceptor_var : public TAO_Base_var
  {
  public:
...
class  Interceptor : public virtual CORBA_Object
  {
  public:
  #if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  InvalidSlot : public CORBA::UserException
{
public:
...
class  Current: public virtual CORBA::Current
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  RequestInfo_var : public TAO_Base_var
{
public:
...
class  RequestInfo : public virtual CORBA_Object
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  ClientRequestInfo_var : public TAO_Base_var
{
public:
  ClientRequestInfo_var (void); // default constructor
  ClientRequestInfo_var (ClientRequestInfo_ptr);
...
class  ClientRequestInfo: public virtual RequestInfo
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  ServerRequestInfo_var : public TAO_Base_var
{
public:
  ServerRequestInfo_var (void); // default constructor
  ServerRequestInfo_var (ServerRequestInfo_ptr);
...
class  ServerRequestInfo: public virtual RequestInfo
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  ClientRequestInterceptor_var : public TAO_Base_var
{
public:
...
class  ClientRequestInterceptor: public virtual Interceptor
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  ServerRequestInterceptor_var : public TAO_Base_var
{
public:
...
class  ServerRequestInterceptor_out
{
public:
...
class  ServerRequestInterceptor: public virtual Interceptor
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  IORInfo_var : public TAO_Base_var
{
public:
  IORInfo_var (void); // default constructor
  IORInfo_var (IORInfo_ptr);
...
class  IORInfo : public virtual CORBA_Object
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  IORInterceptor_var : public TAO_Base_var
{
public:
  IORInterceptor_var (void); // default constructor
  IORInterceptor_var (IORInterceptor_ptr);
...
class  IORInterceptor: public virtual Interceptor
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  PolicyFactory_var : public TAO_Base_var
{
public:
  PolicyFactory_var (void); // default constructor
  PolicyFactory_var (PolicyFactory_ptr);
...
class  PolicyFactory : public virtual CORBA_Object
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  ORBInitInfo_var : public TAO_Base_var
{
public:
  ORBInitInfo_var (void); // default constructor
  ORBInitInfo_var (ORBInitInfo_ptr);
...
class  ORBInitInfo : public virtual CORBA_Object
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
class  ORBInitializer_var : public TAO_Base_var
{
public:
  ORBInitializer_var (void); // default constructor
  ORBInitializer_var (ORBInitializer_ptr);
...
class  ORBInitializer : public virtual CORBA_Object
{
public:
#if !defined(__GNUC__) || !defined (ACE_HAS_GNUG_PRE_2_8)
...
TAO_NAMESPACE_CLOSE // module PortableInterceptor
 ...
 void operator<<= (CORBA::Any &, const PortableInterceptor::OctetSeq &); // copying version
 void operator<<= (CORBA::Any &, PortableInterceptor::OctetSeq*); // noncopying version
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::OctetSeq *&); // deprecated
 CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::OctetSeq *&);
 void operator<<= (CORBA::Any &, const PortableInterceptor::StringSeq &); // copying version
 void operator<<= (CORBA::Any &, PortableInterceptor::StringSeq*); // noncopying version
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::StringSeq *&); // deprecated
 CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::StringSeq *&);
extern  PortableInterceptor::Interceptor_ptr (*_TAO_collocation_PortableInterceptor_Interceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::Interceptor
 void operator<<= (CORBA::Any &, PortableInterceptor::Interceptor_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::Interceptor *&);
 void operator<<= (CORBA::Any &, const PortableInterceptor::ForwardRequest &); // copying version
 void operator<<= (CORBA::Any &, PortableInterceptor::ForwardRequest*); // noncopying version
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ForwardRequest *&); // deprecated
 CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::ForwardRequest *&);
 void operator<<= (CORBA::Any &, const PortableInterceptor::InvalidSlot &); // copying version
 void operator<<= (CORBA::Any &, PortableInterceptor::InvalidSlot*); // noncopying version
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::InvalidSlot *&); // deprecated
 CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::InvalidSlot *&);
extern  PortableInterceptor::Current_ptr (*_TAO_collocation_PortableInterceptor_Current_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::Current
 void operator<<= (CORBA::Any &, PortableInterceptor::Current_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::Current *&);
extern  PortableInterceptor::RequestInfo_ptr (*_TAO_collocation_PortableInterceptor_RequestInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::RequestInfo
 void operator<<= (CORBA::Any &, PortableInterceptor::RequestInfo_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::RequestInfo *&);
extern  PortableInterceptor::ClientRequestInfo_ptr (*_TAO_collocation_PortableInterceptor_ClientRequestInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ClientRequestInfo
 ...
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ClientRequestInfo *&);
extern  PortableInterceptor::ServerRequestInfo_ptr (*_TAO_collocation_PortableInterceptor_ServerRequestInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ServerRequestInfo
 void operator<<= (CORBA::Any &, PortableInterceptor::ServerRequestInfo_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ServerRequestInfo *&);
extern  PortableInterceptor::ClientRequestInterceptor_ptr (*_TAO_collocation_PortableInterceptor_ClientRequestInterceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ClientRequestInterceptor
 void operator<<= (CORBA::Any &, PortableInterceptor::ClientRequestInterceptor_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ClientRequestInterceptor *&);
extern  PortableInterceptor::ServerRequestInterceptor_ptr (*_TAO_collocation_PortableInterceptor_ServerRequestInterceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ServerRequestInterceptor
 ...
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ServerRequestInterceptor *&);
extern  PortableInterceptor::IORInfo_ptr (*_TAO_collocation_PortableInterceptor_IORInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::IORInfo
 void operator<<= (CORBA::Any &, PortableInterceptor::IORInfo_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::IORInfo *&);
extern  PortableInterceptor::IORInterceptor_ptr (*_TAO_collocation_PortableInterceptor_IORInterceptor_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::IORInterceptor
 void operator<<= (CORBA::Any &, PortableInterceptor::IORInterceptor_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::IORInterceptor *&);
extern  PortableInterceptor::PolicyFactory_ptr (*_TAO_collocation_PortableInterceptor_PolicyFactory_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::PolicyFactory
 ...
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::PolicyFactory *&);
extern  PortableInterceptor::ORBInitInfo_ptr (*_TAO_collocation_PortableInterceptor_ORBInitInfo_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ORBInitInfo
 void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo *&);
 void operator<<= (CORBA::Any &, const PortableInterceptor::ORBInitInfo::DuplicateName &); // copying version
 void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo::DuplicateName*); // noncopying version
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo::DuplicateName *&); // deprecated
 CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::ORBInitInfo::DuplicateName *&);
 void operator<<= (CORBA::Any &, const PortableInterceptor::ORBInitInfo::InvalidName &); // copying version
 void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo::InvalidName*); // noncopying version
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo::InvalidName *&); // deprecated
 CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::ORBInitInfo::InvalidName *&);
extern  PortableInterceptor::ORBInitializer_ptr (*_TAO_collocation_PortableInterceptor_ORBInitializer_Stub_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
// Any operators for interface PortableInterceptor::ORBInitializer
 void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitializer_ptr);
 CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitializer *&);
...
#define _TAO_CDR_OP_PortableInterceptor_StringSeq_H_
 ...
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ForwardRequest &);
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ForwardRequest &);

# if !defined (ACE_LACKS_IOSTREAM_TOTALLY)

 ostream& operator<< (ostream &, const PortableInterceptor::ForwardRequest &);

# endif /* ACE_LACKS_IOSTREAM_TOTALLY */
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::InvalidSlot &);
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::InvalidSlot &);

# if !defined (ACE_LACKS_IOSTREAM_TOTALLY)

 ostream& operator<< (ostream &, const PortableInterceptor::InvalidSlot &);

# endif /* ACE_LACKS_IOSTREAM_TOTALLY */
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::Current_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::Current_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::RequestInfo_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::RequestInfo_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ClientRequestInfo_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ClientRequestInfo_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ServerRequestInfo_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ServerRequestInfo_ptr &);
 ...
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::IORInfo_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::IORInfo_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::IORInterceptor_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::IORInterceptor_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::PolicyFactory_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::PolicyFactory_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitInfo_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitInfo_ptr &);
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitInfo::DuplicateName &);
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitInfo::DuplicateName &);

# if !defined (ACE_LACKS_IOSTREAM_TOTALLY)

 ostream& operator<< (ostream &, const PortableInterceptor::ORBInitInfo::DuplicateName &);

# endif /* ACE_LACKS_IOSTREAM_TOTALLY */
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitInfo::InvalidName &);
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitInfo::InvalidName &);

# if !defined (ACE_LACKS_IOSTREAM_TOTALLY)

 ostream& operator<< (ostream &, const PortableInterceptor::ORBInitInfo::InvalidName &);

# endif /* ACE_LACKS_IOSTREAM_TOTALLY */
 CORBA::Boolean operator<< (TAO_OutputCDR &, const PortableInterceptor::ORBInitializer_ptr );
 CORBA::Boolean operator>> (TAO_InputCDR &, PortableInterceptor::ORBInitializer_ptr &);
