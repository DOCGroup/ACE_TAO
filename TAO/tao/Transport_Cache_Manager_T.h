...
namespace TAO
{
  ...
  private:
    ...
    friend class TAO_VERSIONED_NAMESPACE_NAME::TAO_Transport;
#else
    ...
    class TCM_Idle_Timer_Handler : public ACE_Event_Handler
    {
    public:
    ...
    void purge_idle_transports (void);
