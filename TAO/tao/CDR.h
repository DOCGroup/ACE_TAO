...
public:
  ...
  typedef TAO_Intrusive_Ref_Count_Object<DynValue_Map, ACE_Null_Mutex> RC_DynValue_Map;
  ...
  typedef TAO_Intrusive_Ref_Count_Handle<RC_DynValue_Map> DynValue_Map_Handle;
  ...
  DynValue_Map_Handle& get_dynvalue_map ();
  ...
  void set_dynvalue_map (DynValue_Map_Handle& map);
...
private:
  ...
  DynValue_Map_Handle dynvalue_map_;
};
