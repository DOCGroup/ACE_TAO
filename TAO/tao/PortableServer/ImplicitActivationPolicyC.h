...
namespace PortableServer
{
  ...
  TAO_NAMESPACE_STORAGE_CLASS ::CORBA::TypeCode_ptr const _tc_ImplicitActivationPolicyValue;
...
#define _PORTABLESERVER_IMPLICITACTIVATIONPOLICY_CH_
  ...
  TAO_NAMESPACE_STORAGE_CLASS ::CORBA::TypeCode_ptr const _tc_ImplicitActivationPolicy;
