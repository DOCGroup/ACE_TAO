...
#ifndef TAO_DYNAMIC_TP_ORB_ORB_INITIALIZER_H
#define TAO_DYNAMIC_TP_ORB_ORB_INITIALIZER_H
...
class TAO_Dynamic_TP_ORB_ORBInitializer
...
public:
   ...
   * TAO_Dynamic_TP_DT_INFINITIVE When the Dynamic Thread is created it will run
   * forever
   * TAO_Dynamic_TP_DT_IDLE When the Dynamic Thread is created it will run until
   * it has been idle for the specified amount of time
   * TAO_Dynamic_TP_DT_FIXED When the Dynamic Thread is created it will run for
   * the specified fix amount of time
   */
  enum TAO_Dynamic_TP_DT_LifeSpan
  {
    TAO_Dynamic_TP_DT_INFINITIVE,
    TAO_Dynamic_TP_DT_IDLE,
    TAO_Dynamic_TP_DT_FIXED
  };

  TAO_Dynamic_TP_ORB_ORBInitializer (size_t n_static,
                                     size_t n_dynamic,
                                     size_t stack,
...
private:
  ...
  TAO_Dynamic_TP_ORB_ORBInitializer::TAO_Dynamic_TP_DT_LifeSpan lifespan_;
...
#endif /* TAO_DYNAMIC_TP_ORB_ORB_INITIALIZER_H */
