  ...
  : serialize_servants_(serialize_servants)
{
  ...
  {
    	ACE_DEBUG ((LM_DEBUG, 
		    ACE_TEXT ("TAO (%P|%t) - Dynamic_TP_POA_StrategyImpl: Initialized with:\n \
			           initial_pool_threads_=[%d]\n \
					   min_pool_threads_=[%d]\n \
					   max_pool_threads_=[%d]\n \
					   max_request_queue_depth_=[%d]\n \
					   thread_stack_size_=[%d]\n \
					   thread_idle_time_=[%d]\n"), 
  ...
  { 
	...
	ACE_DEBUG ((LM_DEBUG, 
		    ACE_TEXT ("TAO (%P|%t) - Dynamic_TP_POA_StrategyImpl: Null configuration provided, setting to defaults:\n \
			           initial_pool_threads_=[%d]\n \
					   min_pool_threads_=[%d]\n \
					   max_pool_threads_=[%d]\n \
					   max_request_queue_depth_=[%d]\n \
