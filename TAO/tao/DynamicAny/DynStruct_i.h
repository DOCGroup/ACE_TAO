...
private:
  ...
  TAO_DynStruct_i (const TAO_DynStruct_i &) = delete;
  TAO_DynStruct_i &operator= (const TAO_DynStruct_i &) = delete;
  TAO_DynStruct_i& operator= (TAO_DynStruct_i&&) = delete;
  TAO_DynStruct_i (TAO_DynStruct_i&&) = delete;
