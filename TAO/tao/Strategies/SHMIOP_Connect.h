...
class TAO_Strategies_Export TAO_SHMIOP_Server_Connection_Handler : public TAO_SHMIOP_SVC_HANDLER,
...
class TAO_Strategies_Export TAO_SHMIOP_Client_Connection_Handler : public TAO_SHMIOP_SVC_HANDLER,
                                                        public TAO_Connection_Handler
{
  // = TITLE
