...
public:
   ...
   * single endpoint.  Data format is specified in sciop_endpoins.pidl.
   *
   * Multiple TAG_ALTERNATE_SCIOP_ADDRESS components can be used
   * instead of a single proprietory component to transmit multiple
   * endpoints.  This is somewhat slower and less convenient.  Also,
   * TAG_ALTERNATE_SCIOP_ADDRESS does not provide for transmission of
   * endpoint priorities.
   *
   */
