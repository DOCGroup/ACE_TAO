...
CORBA::THREAD_CANCELLED::THREAD_CANCELLED (void)
  : CORBA_UserException (
        "IDL:CORBA/THREAD_CANCELLED:1.0",
        "THREAD_CANCELLED"
      )
{
}
...
CORBA::THREAD_CANCELLED::THREAD_CANCELLED (const ::CORBA::THREAD_CANCELLED &_tao_excp)
  : CORBA_UserException (
        _tao_excp._rep_id (),
        _tao_excp._name ()
      )
...
CORBA::THREAD_CANCELLED::operator= (const ::CORBA::THREAD_CANCELLED &_tao_excp)
{
  this->CORBA_UserException::operator= (_tao_excp);
  return *this;
}

void CORBA::THREAD_CANCELLED::_tao_any_destructor (void *_tao_void_pointer)
{
  THREAD_CANCELLED *tmp = ACE_static_cast (THREAD_CANCELLED*, _tao_void_pointer);
  delete tmp;
}

CORBA::THREAD_CANCELLED *
CORBA::THREAD_CANCELLED::_downcast (CORBA::Exception *exc)
{
  if (!ACE_OS::strcmp ("IDL:CORBA/THREAD_CANCELLED:1.0", exc->_rep_id ()))
    {
      return ACE_dynamic_cast (THREAD_CANCELLED *, exc);
    }
  else
    {
      return 0;
...
CORBA::Exception *CORBA::THREAD_CANCELLED::_alloc (void)
{
  CORBA::Exception *retval = 0;
  ACE_NEW_RETURN (retval, ::CORBA::THREAD_CANCELLED, 0);
  return retval;
}

CORBA::Exception *
CORBA::THREAD_CANCELLED::_tao_duplicate (void) const
{
  CORBA::Exception *result;
  ACE_NEW_RETURN (
      result,
      ::CORBA::THREAD_CANCELLED (*this),
      0
    );
  return result;
}

void CORBA::THREAD_CANCELLED::_raise (void)
{
  TAO_RAISE (*this);
}

void CORBA::THREAD_CANCELLED::_tao_encode (
    TAO_OutputCDR &cdr
    ACE_ENV_ARG_DECL
  ) const
{
...
void CORBA::THREAD_CANCELLED::_tao_decode (
    TAO_InputCDR &cdr
    ACE_ENV_ARG_DECL
  )
{
...
CORBA::TypeCode_ptr CORBA::THREAD_CANCELLED::_type (void) const
{
  return ::CORBA::_tc_THREAD_CANCELLED;
}

// TAO_IDL - Generated from
// C:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_typecode/typecode_defn.cpp:284

static const CORBA::Long _oc_CORBA_THREAD_CANCELLED[] =
{
    TAO_ENCAP_BYTE_ORDER, // byte order
  31,
  ACE_NTOHL (0x49444c3a), 
  ACE_NTOHL (0x434f5242), 
  ACE_NTOHL (0x412f5448), 
  ACE_NTOHL (0x52454144), 
  ACE_NTOHL (0x5f43414e), 
  ACE_NTOHL (0x43454c4c), 
  ACE_NTOHL (0x45443a31), 
  ACE_NTOHL (0x2e300000),  // repository ID = IDL:CORBA/THREAD_CANCELLED:1.0
  17,
  ACE_NTOHL (0x54485245), 
  ACE_NTOHL (0x41445f43), 
  ACE_NTOHL (0x414e4345), 
  ACE_NTOHL (0x4c4c4544), 
  ACE_NTOHL (0x0),  // name = THREAD_CANCELLED
  0, // member count
};

static CORBA::TypeCode _tc_TAO_tc_CORBA_THREAD_CANCELLED (
    CORBA::tk_except,
    sizeof (_oc_CORBA_THREAD_CANCELLED),
    (char *) &_oc_CORBA_THREAD_CANCELLED,
    0,
    sizeof (CORBA::THREAD_CANCELLED)
  );
...
TAO_NAMESPACE_DEFINE (
    ::CORBA::TypeCode_ptr,
    _tc_THREAD_CANCELLED,
    &_tc_TAO_tc_CORBA_THREAD_CANCELLED
  )
TAO_NAMESPACE_END
...
// TAO_IDL - Generated from 
// C:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_exception/any_op_cs.cpp:54

// Copying insertion.
void operator<<= (
    CORBA::Any &_tao_any,
    const CORBA::THREAD_CANCELLED &_tao_elem
  )
{
...
void operator<<= (
    CORBA::Any &_tao_any,
    CORBA::THREAD_CANCELLED *_tao_elem
  )
{
  TAO_OutputCDR stream;
  ...
  if (stream << *_tao_elem)
    {
      _tao_any._tao_replace (
          ...
          1,
          _tao_elem,
          CORBA::THREAD_CANCELLED::_tao_any_destructor
        );
    }
}
...
CORBA::Boolean operator>>= (
    const CORBA::Any &_tao_any,CORBA::THREAD_CANCELLED *&_tao_elem
  )
{
  return _tao_any >>= ACE_const_cast(
      const CORBA::THREAD_CANCELLED*&,
      _tao_elem
    );
}
  ...
  )
{
  ...
  ACE_TRY_NEW_ENV
  {
    ...
    if (_tao_any.any_owns_data ())
      {
        _tao_elem = (CORBA::THREAD_CANCELLED *)_tao_any.value ();
        return 1;
      }
    else
      {
        CORBA::THREAD_CANCELLED *tmp = 0;
        ACE_NEW_RETURN (
            tmp,
            CORBA::THREAD_CANCELLED,
            0
