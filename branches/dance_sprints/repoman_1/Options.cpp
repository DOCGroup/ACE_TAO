...
Options::parse_args (int argc, ACE_TCHAR *argv[])
{
  ...
  get_opts.long_option (ACE_TEXT("ior"), 'k', ACE_Get_Opt::ARG_REQUIRED);
  get_opts.long_option (ACE_TEXT("shutdown"), 's', ACE_Get_Opt::NO_ARG);
  get_opts.long_option (ACE_TEXT("shutdown"), 's', ACE_Get_Opt::NO_ARG);
...
void Options::usage (void)
{
  ...
  return "Node Manager Options:\n"
    "\t-k,--ior [ior]\t IOR of the RepositoryManager instance.\n"
