...
#define dt_oneway_NUM_FAMILIES 3


/* DSUI Family: MAIN_GROUP
 * (null)
 */
#define MAIN_GROUP_FAM 1
...
#define START 0
#define STOP 1
#define SCHEDULE_SETUP 2
#define WORKER_ACTIVATED 3
#define WORKER_WAIT_DONE 4
#define CALL_SERVER_SHUTDOWN 5
#define AFTER_SERVER_SHUTDOWN 6
#define SCHEDULER_SHUTDOWN 7
#define SCHEDULER_STARTED 8
...
#define NUM_EVENTS_WORKER_GROUP 7 
#define NUM_HISTOGRAMS_WORKER_GROUP 0


#define WORKER_STARTED 0
#define BEGIN_SCHED_SEGMENT 1
#define END_SCHED_SEGMENT 2
#define ONE_WAY_CALL_START 3
#define ONE_WAY_CALL_DONE 4
 ...
 * (null)
 */
#define TEST_ONE_FAM 3
#define NUM_COUNTERS_TEST_ONE 0
#define NUM_EVENTS_TEST_ONE 2
