...
#if !defined (_HELLOHOMEEXPLICIT___PTR_CH_)
#define _HELLOHOMEEXPLICIT___PTR_CH_

class HelloHomeExplicit;
typedef HelloHomeExplicit *HelloHomeExplicit_ptr;

#endif /* end #if !defined */

#if !defined (_HELLOHOMEEXPLICIT___VAR_CH_)
#define _HELLOHOMEEXPLICIT___VAR_CH_

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:571

class HELLO_EXECUTOR_Export HelloHomeExplicit_var : public TAO_Base_var
{
public:
  HelloHomeExplicit_var (void); // default constructor
  HelloHomeExplicit_var (HelloHomeExplicit_ptr p) : ptr_ (p) {} 
  HelloHomeExplicit_var (const HelloHomeExplicit_var &); // copy constructor
  ~HelloHomeExplicit_var (void); // destructor
  
  HelloHomeExplicit_var &operator= (HelloHomeExplicit_ptr);
  HelloHomeExplicit_var &operator= (const HelloHomeExplicit_var &);
  HelloHomeExplicit_ptr operator-> (void) const;
  
  operator const HelloHomeExplicit_ptr &() const;
  operator HelloHomeExplicit_ptr &();
  // in, inout, out, _retn 
  HelloHomeExplicit_ptr in (void) const;
  HelloHomeExplicit_ptr &inout (void);
  HelloHomeExplicit_ptr &out (void);
  HelloHomeExplicit_ptr _retn (void);
  HelloHomeExplicit_ptr ptr (void) const;
  
  // Hooks used by template sequence and object manager classes
  // for non-defined forward declared interfaces.
  static HelloHomeExplicit_ptr tao_duplicate (HelloHomeExplicit_ptr);
  static void tao_release (HelloHomeExplicit_ptr);
  static HelloHomeExplicit_ptr tao_nil (void);
  static HelloHomeExplicit_ptr tao_narrow (
      CORBA::Object *
      ACE_ENV_ARG_DECL_NOT_USED
    );
  static CORBA::Object * tao_upcast (void *);
...
private:
  HelloHomeExplicit_ptr ptr_;
  // Unimplemented - prevents widening assignment.
  HelloHomeExplicit_var (const TAO_Base_var &rhs);
  HelloHomeExplicit_var &operator= (const TAO_Base_var &rhs);
};

#endif /* end #if !defined */

#if !defined (_HELLOHOMEEXPLICIT___OUT_CH_)
#define _HELLOHOMEEXPLICIT___OUT_CH_

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:946

class HELLO_EXECUTOR_Export HelloHomeExplicit_out
{
public:
  HelloHomeExplicit_out (HelloHomeExplicit_ptr &);
  HelloHomeExplicit_out (HelloHomeExplicit_var &);
  HelloHomeExplicit_out (const HelloHomeExplicit_out &);
  HelloHomeExplicit_out &operator= (const HelloHomeExplicit_out &);
  HelloHomeExplicit_out &operator= (const HelloHomeExplicit_var &);
  HelloHomeExplicit_out &operator= (HelloHomeExplicit_ptr);
  operator HelloHomeExplicit_ptr &();
  HelloHomeExplicit_ptr &ptr (void);
  HelloHomeExplicit_ptr operator-> (void);
...
#if !defined (_HELLOHOMEEXPLICIT_CH_)
#define _HELLOHOMEEXPLICIT_CH_

class _TAO_HelloHomeExplicit_Proxy_Impl;
class _TAO_HelloHomeExplicit_Remote_Proxy_Impl;
class _TAO_HelloHomeExplicit_Proxy_Broker;
class _TAO_HelloHomeExplicit_Remote_Proxy_Broker;

class HELLO_EXECUTOR_Export HelloHomeExplicit
  : public virtual Components::CCMHome
{
public:
  typedef HelloHomeExplicit_ptr _ptr_type;
  typedef HelloHomeExplicit_var _var_type;
  static int _tao_class_id;
  
  // The static operations.
  static HelloHomeExplicit_ptr _duplicate (HelloHomeExplicit_ptr obj);
  
  static HelloHomeExplicit_ptr _narrow (
      CORBA::Object_ptr obj
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    );
  
  static HelloHomeExplicit_ptr _unchecked_narrow (
      CORBA::Object_ptr obj
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    );
  
  static HelloHomeExplicit_ptr _nil (void)
    {
      return (HelloHomeExplicit_ptr)0;
    }
  ...
  virtual const char* _interface_repository_id (void) const;
private:
  _TAO_HelloHomeExplicit_Proxy_Broker *the_TAO_HelloHomeExplicit_Proxy_Broker_;

protected:
  HelloHomeExplicit (int collocated = 0);
  
  // These methods travese the inheritance tree and set the
  // parents piece of the given class in the right mode.
  virtual void HelloHomeExplicit_setup_collocation (int collocated);
  ...
  virtual ~HelloHomeExplicit (void);
  
  friend class _TAO_HelloHomeExplicit_Remote_Proxy_Impl;
  friend class _TAO_HelloHomeExplicit_ThruPOA_Proxy_Impl;
  friend class _TAO_HelloHomeExplicit_Direct_Proxy_Impl;

private:
  HelloHomeExplicit (const HelloHomeExplicit &);
  void operator= (const HelloHomeExplicit &);
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeExplicit_Proxy_Impl
  : public virtual Components::_TAO_CCMHome_Proxy_Impl
{
public:
  virtual ~_TAO_HelloHomeExplicit_Proxy_Impl (void) {}

protected:
  _TAO_HelloHomeExplicit_Proxy_Impl (void);
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeExplicit_Remote_Proxy_Impl
  : public virtual _TAO_HelloHomeExplicit_Proxy_Impl,
    public virtual TAO_Remote_Object_Proxy_Impl,
    public virtual Components::_TAO_CCMHome_Remote_Proxy_Impl
{
public:
  _TAO_HelloHomeExplicit_Remote_Proxy_Impl (void);
  
  virtual ~_TAO_HelloHomeExplicit_Remote_Proxy_Impl (void) {}
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeExplicit_Proxy_Broker
{
public:
  virtual ~_TAO_HelloHomeExplicit_Proxy_Broker (void);
  virtual _TAO_HelloHomeExplicit_Proxy_Impl &select_proxy (
      HelloHomeExplicit *object
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    ) = 0;
  
protected:
  _TAO_HelloHomeExplicit_Proxy_Broker (void);
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeExplicit_Remote_Proxy_Broker
  : public virtual _TAO_HelloHomeExplicit_Proxy_Broker
{
public: 
  _TAO_HelloHomeExplicit_Remote_Proxy_Broker (void);
  
  virtual ~_TAO_HelloHomeExplicit_Remote_Proxy_Broker (void);
...
private:
  _TAO_HelloHomeExplicit_Remote_Proxy_Impl remote_proxy_impl_;

public:
  // This member function is used to get an handle to the unique instance
  // of the Remote Proxy Broker that is available for a given
  // interface.
  static _TAO_HelloHomeExplicit_Remote_Proxy_Broker *the_TAO_HelloHomeExplicit_Remote_Proxy_Broker (void);
};
...
extern HELLO_EXECUTOR_Export ::CORBA::TypeCode_ptr  _tc_HelloHomeExplicit;

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface/interface_ch.cpp:52

#if !defined (_HELLOHOMEIMPLICIT___PTR_CH_)
#define _HELLOHOMEIMPLICIT___PTR_CH_

class HelloHomeImplicit;
typedef HelloHomeImplicit *HelloHomeImplicit_ptr;

#endif /* end #if !defined */

#if !defined (_HELLOHOMEIMPLICIT___VAR_CH_)
#define _HELLOHOMEIMPLICIT___VAR_CH_

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:571

class HELLO_EXECUTOR_Export HelloHomeImplicit_var : public TAO_Base_var
{
public:
  HelloHomeImplicit_var (void); // default constructor
  HelloHomeImplicit_var (HelloHomeImplicit_ptr p) : ptr_ (p) {} 
  HelloHomeImplicit_var (const HelloHomeImplicit_var &); // copy constructor
  ~HelloHomeImplicit_var (void); // destructor
  
  HelloHomeImplicit_var &operator= (HelloHomeImplicit_ptr);
  HelloHomeImplicit_var &operator= (const HelloHomeImplicit_var &);
  HelloHomeImplicit_ptr operator-> (void) const;
  
  operator const HelloHomeImplicit_ptr &() const;
  operator HelloHomeImplicit_ptr &();
  // in, inout, out, _retn 
  HelloHomeImplicit_ptr in (void) const;
  HelloHomeImplicit_ptr &inout (void);
  HelloHomeImplicit_ptr &out (void);
  HelloHomeImplicit_ptr _retn (void);
  HelloHomeImplicit_ptr ptr (void) const;
  
  // Hooks used by template sequence and object manager classes
  // for non-defined forward declared interfaces.
  static HelloHomeImplicit_ptr tao_duplicate (HelloHomeImplicit_ptr);
  static void tao_release (HelloHomeImplicit_ptr);
  static HelloHomeImplicit_ptr tao_nil (void);
  static HelloHomeImplicit_ptr tao_narrow (
      CORBA::Object *
      ACE_ENV_ARG_DECL_NOT_USED
    );
  static CORBA::Object * tao_upcast (void *);
...
private:
  HelloHomeImplicit_ptr ptr_;
  // Unimplemented - prevents widening assignment.
  HelloHomeImplicit_var (const TAO_Base_var &rhs);
  HelloHomeImplicit_var &operator= (const TAO_Base_var &rhs);
};

#endif /* end #if !defined */

#if !defined (_HELLOHOMEIMPLICIT___OUT_CH_)
#define _HELLOHOMEIMPLICIT___OUT_CH_

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:946

class HELLO_EXECUTOR_Export HelloHomeImplicit_out
{
public:
  HelloHomeImplicit_out (HelloHomeImplicit_ptr &);
  HelloHomeImplicit_out (HelloHomeImplicit_var &);
  HelloHomeImplicit_out (const HelloHomeImplicit_out &);
  HelloHomeImplicit_out &operator= (const HelloHomeImplicit_out &);
  HelloHomeImplicit_out &operator= (const HelloHomeImplicit_var &);
  HelloHomeImplicit_out &operator= (HelloHomeImplicit_ptr);
  operator HelloHomeImplicit_ptr &();
  HelloHomeImplicit_ptr &ptr (void);
  HelloHomeImplicit_ptr operator-> (void);
...
#if !defined (_HELLOHOMEIMPLICIT_CH_)
#define _HELLOHOMEIMPLICIT_CH_

class _TAO_HelloHomeImplicit_Proxy_Impl;
class _TAO_HelloHomeImplicit_Remote_Proxy_Impl;
class _TAO_HelloHomeImplicit_Proxy_Broker;
class _TAO_HelloHomeImplicit_Remote_Proxy_Broker;

class HELLO_EXECUTOR_Export HelloHomeImplicit
  : public virtual Components::KeylessCCMHome
{
public:
  typedef HelloHomeImplicit_ptr _ptr_type;
  typedef HelloHomeImplicit_var _var_type;
  static int _tao_class_id;
  
  // The static operations.
  static HelloHomeImplicit_ptr _duplicate (HelloHomeImplicit_ptr obj);
  
  static HelloHomeImplicit_ptr _narrow (
      CORBA::Object_ptr obj
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    );
  
  static HelloHomeImplicit_ptr _unchecked_narrow (
      CORBA::Object_ptr obj
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    );
  
  static HelloHomeImplicit_ptr _nil (void)
    {
      return (HelloHomeImplicit_ptr)0;
    }
  ...
  virtual const char* _interface_repository_id (void) const;
private:
  _TAO_HelloHomeImplicit_Proxy_Broker *the_TAO_HelloHomeImplicit_Proxy_Broker_;

protected:
  HelloHomeImplicit (int collocated = 0);
  
  // These methods travese the inheritance tree and set the
  // parents piece of the given class in the right mode.
  virtual void HelloHomeImplicit_setup_collocation (int collocated);
  ...
  virtual ~HelloHomeImplicit (void);
  
  friend class _TAO_HelloHomeImplicit_Remote_Proxy_Impl;
  friend class _TAO_HelloHomeImplicit_ThruPOA_Proxy_Impl;
  friend class _TAO_HelloHomeImplicit_Direct_Proxy_Impl;

private:
  HelloHomeImplicit (const HelloHomeImplicit &);
  void operator= (const HelloHomeImplicit &);
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeImplicit_Proxy_Impl
  : public virtual Components::_TAO_KeylessCCMHome_Proxy_Impl
{
public:
  virtual ~_TAO_HelloHomeImplicit_Proxy_Impl (void) {}
...
protected:
  _TAO_HelloHomeImplicit_Proxy_Impl (void);
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeImplicit_Remote_Proxy_Impl
  : public virtual _TAO_HelloHomeImplicit_Proxy_Impl,
    public virtual TAO_Remote_Object_Proxy_Impl,
    public virtual Components::_TAO_KeylessCCMHome_Remote_Proxy_Impl
{
public:
  _TAO_HelloHomeImplicit_Remote_Proxy_Impl (void);
  
  virtual ~_TAO_HelloHomeImplicit_Remote_Proxy_Impl (void) {}
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeImplicit_Proxy_Broker
{
public:
  virtual ~_TAO_HelloHomeImplicit_Proxy_Broker (void);
  virtual _TAO_HelloHomeImplicit_Proxy_Impl &select_proxy (
      HelloHomeImplicit *object
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    ) = 0;
  
protected:
  _TAO_HelloHomeImplicit_Proxy_Broker (void);
...
class HELLO_EXECUTOR_Export _TAO_HelloHomeImplicit_Remote_Proxy_Broker
  : public virtual _TAO_HelloHomeImplicit_Proxy_Broker
{
public: 
  _TAO_HelloHomeImplicit_Remote_Proxy_Broker (void);
  
  virtual ~_TAO_HelloHomeImplicit_Remote_Proxy_Broker (void);
...
private:
  _TAO_HelloHomeImplicit_Remote_Proxy_Impl remote_proxy_impl_;

public:
  // This member function is used to get an handle to the unique instance
  // of the Remote Proxy Broker that is available for a given
  // interface.
  static _TAO_HelloHomeImplicit_Remote_Proxy_Broker *the_TAO_HelloHomeImplicit_Remote_Proxy_Broker (void);
};
...
extern HELLO_EXECUTOR_Export ::CORBA::TypeCode_ptr  _tc_HelloHomeImplicit;

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface/interface_ch.cpp:52

#if !defined (_HELLOHOME___PTR_CH_)
#define _HELLOHOME___PTR_CH_

class HelloHome;
typedef HelloHome *HelloHome_ptr;

#endif /* end #if !defined */

#if !defined (_HELLOHOME___VAR_CH_)
#define _HELLOHOME___VAR_CH_

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:571

class HELLO_EXECUTOR_Export HelloHome_var : public TAO_Base_var
{
public:
  HelloHome_var (void); // default constructor
  HelloHome_var (HelloHome_ptr p) : ptr_ (p) {} 
  HelloHome_var (const HelloHome_var &); // copy constructor
  ~HelloHome_var (void); // destructor
  
  HelloHome_var &operator= (HelloHome_ptr);
  HelloHome_var &operator= (const HelloHome_var &);
  HelloHome_ptr operator-> (void) const;
  
  operator const HelloHome_ptr &() const;
  operator HelloHome_ptr &();
  // in, inout, out, _retn 
  HelloHome_ptr in (void) const;
  HelloHome_ptr &inout (void);
  HelloHome_ptr &out (void);
  HelloHome_ptr _retn (void);
  HelloHome_ptr ptr (void) const;
  
  // Hooks used by template sequence and object manager classes
  // for non-defined forward declared interfaces.
  static HelloHome_ptr tao_duplicate (HelloHome_ptr);
  static void tao_release (HelloHome_ptr);
  static HelloHome_ptr tao_nil (void);
  static HelloHome_ptr tao_narrow (
      CORBA::Object *
      ACE_ENV_ARG_DECL_NOT_USED
    );
  static CORBA::Object * tao_upcast (void *);
...
private:
  HelloHome_ptr ptr_;
  // Unimplemented - prevents widening assignment.
  HelloHome_var (const TAO_Base_var &rhs);
  HelloHome_var &operator= (const TAO_Base_var &rhs);
};

#endif /* end #if !defined */

#if !defined (_HELLOHOME___OUT_CH_)
#define _HELLOHOME___OUT_CH_

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_interface.cpp:946

class HELLO_EXECUTOR_Export HelloHome_out
{
public:
  HelloHome_out (HelloHome_ptr &);
  HelloHome_out (HelloHome_var &);
  HelloHome_out (const HelloHome_out &);
  HelloHome_out &operator= (const HelloHome_out &);
  HelloHome_out &operator= (const HelloHome_var &);
  HelloHome_out &operator= (HelloHome_ptr);
  operator HelloHome_ptr &();
  HelloHome_ptr &ptr (void);
  HelloHome_ptr operator-> (void);
...
#if !defined (_HELLOHOME_CH_)
#define _HELLOHOME_CH_

class _TAO_HelloHome_Proxy_Impl;
class _TAO_HelloHome_Remote_Proxy_Impl;
class _TAO_HelloHome_Proxy_Broker;
class _TAO_HelloHome_Remote_Proxy_Broker;

class HELLO_EXECUTOR_Export HelloHome
  : public virtual HelloHomeExplicit,
    public virtual HelloHomeImplicit
{
public:
  typedef HelloHome_ptr _ptr_type;
  typedef HelloHome_var _var_type;
  static int _tao_class_id;
  
  // The static operations.
  static HelloHome_ptr _duplicate (HelloHome_ptr obj);
  
  static HelloHome_ptr _narrow (
      CORBA::Object_ptr obj
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    );
  
  static HelloHome_ptr _unchecked_narrow (
      CORBA::Object_ptr obj
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    );
  
  static HelloHome_ptr _nil (void)
    {
      return (HelloHome_ptr)0;
    }
  ...
  virtual const char* _interface_repository_id (void) const;
private:
  _TAO_HelloHome_Proxy_Broker *the_TAO_HelloHome_Proxy_Broker_;

protected:
  HelloHome (int collocated = 0);
  
  // These methods travese the inheritance tree and set the
  // parents piece of the given class in the right mode.
  virtual void HelloHome_setup_collocation (int collocated);
  ...
  virtual ~HelloHome (void);
  
  friend class _TAO_HelloHome_Remote_Proxy_Impl;
  friend class _TAO_HelloHome_ThruPOA_Proxy_Impl;
  friend class _TAO_HelloHome_Direct_Proxy_Impl;

private:
  HelloHome (const HelloHome &);
  void operator= (const HelloHome &);
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHome_Proxy_Impl
  : public virtual _TAO_HelloHomeExplicit_Proxy_Impl, 
    public virtual _TAO_HelloHomeImplicit_Proxy_Impl
{
public:
  virtual ~_TAO_HelloHome_Proxy_Impl (void) {}

protected:
  _TAO_HelloHome_Proxy_Impl (void);
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHome_Remote_Proxy_Impl
  : public virtual _TAO_HelloHome_Proxy_Impl,
    public virtual TAO_Remote_Object_Proxy_Impl,
    public virtual _TAO_HelloHomeExplicit_Remote_Proxy_Impl,
    public virtual _TAO_HelloHomeImplicit_Remote_Proxy_Impl
{
public:
  _TAO_HelloHome_Remote_Proxy_Impl (void);
  
  virtual ~_TAO_HelloHome_Remote_Proxy_Impl (void) {}
};
...
class HELLO_EXECUTOR_Export _TAO_HelloHome_Proxy_Broker
{
public:
  virtual ~_TAO_HelloHome_Proxy_Broker (void);
  virtual _TAO_HelloHome_Proxy_Impl &select_proxy (
      HelloHome *object
      ACE_ENV_ARG_DECL_WITH_DEFAULTS
    ) = 0;
  
protected:
  _TAO_HelloHome_Proxy_Broker (void);
...
class HELLO_EXECUTOR_Export _TAO_HelloHome_Remote_Proxy_Broker
  : public virtual _TAO_HelloHome_Proxy_Broker
{
public: 
  _TAO_HelloHome_Remote_Proxy_Broker (void);
  
  virtual ~_TAO_HelloHome_Remote_Proxy_Broker (void);
...
private:
  _TAO_HelloHome_Remote_Proxy_Impl remote_proxy_impl_;

public:
  // This member function is used to get an handle to the unique instance
  // of the Remote Proxy Broker that is available for a given
  // interface.
  static _TAO_HelloHome_Remote_Proxy_Broker *the_TAO_HelloHome_Remote_Proxy_Broker (void);
};
...
extern HELLO_EXECUTOR_Export ::CORBA::TypeCode_ptr  _tc_HelloHome;
...
extern HELLO_EXECUTOR_Export
_TAO_HelloHomeExplicit_Proxy_Broker *
(*_TAO_HelloHomeExplicit_Proxy_Broker_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );

extern HELLO_EXECUTOR_Export
_TAO_HelloHomeImplicit_Proxy_Broker *
(*_TAO_HelloHomeImplicit_Proxy_Broker_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );

extern HELLO_EXECUTOR_Export
_TAO_HelloHome_Proxy_Broker *
(*_TAO_HelloHome_Proxy_Broker_Factory_function_pointer) (
    CORBA::Object_ptr obj
  );
...
HELLO_EXECUTOR_Export void operator<<= (CORBA::Any &, HelloHomeExplicit_ptr); // copying
HELLO_EXECUTOR_Export void operator<<= (CORBA::Any &, HelloHomeExplicit_ptr *); // non-copying
HELLO_EXECUTOR_Export CORBA::Boolean operator>>= (const CORBA::Any &, HelloHomeExplicit_ptr &);

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface/any_op_ch.cpp:52

HELLO_EXECUTOR_Export void operator<<= (CORBA::Any &, HelloHomeImplicit_ptr); // copying
HELLO_EXECUTOR_Export void operator<<= (CORBA::Any &, HelloHomeImplicit_ptr *); // non-copying
HELLO_EXECUTOR_Export CORBA::Boolean operator>>= (const CORBA::Any &, HelloHomeImplicit_ptr &);

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface/any_op_ch.cpp:52

HELLO_EXECUTOR_Export void operator<<= (CORBA::Any &, HelloHome_ptr); // copying
HELLO_EXECUTOR_Export void operator<<= (CORBA::Any &, HelloHome_ptr *); // non-copying
HELLO_EXECUTOR_Export CORBA::Boolean operator>>= (const CORBA::Any &, HelloHome_ptr &);
...
HELLO_EXECUTOR_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const HelloHomeExplicit_ptr );
HELLO_EXECUTOR_Export CORBA::Boolean operator>> (TAO_InputCDR &, HelloHomeExplicit_ptr &);

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface/cdr_op_ch.cpp:55

HELLO_EXECUTOR_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const HelloHomeImplicit_ptr );
HELLO_EXECUTOR_Export CORBA::Boolean operator>> (TAO_InputCDR &, HelloHomeImplicit_ptr &);

// TAO_IDL - Generated from
// W:\ACE_wrappers\TAO\TAO_IDL\be\be_visitor_interface/cdr_op_ch.cpp:55

HELLO_EXECUTOR_Export CORBA::Boolean operator<< (TAO_OutputCDR &, const HelloHome_ptr );
HELLO_EXECUTOR_Export CORBA::Boolean operator>> (TAO_InputCDR &, HelloHome_ptr &);
