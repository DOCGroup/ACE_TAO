  ...
  switch (type) 
    {
      ...
      case TAO_CACHED_COMPRESSION_ID_LIST_POLICY:
        {
          return this->effective_compression_id_list_policy ();
        }
    }
...
TAO_ZIOP_Stub::effective_compression_id_list_policy (void)
{
  // Get effective override.
  CORBA::Policy_var override =
    this->TAO_Stub::get_cached_policy (TAO_CACHED_COMPRESSION_ID_LIST_POLICY);
  ...
  ZIOP::CompressorIdListPolicy_var override_policy_var =
    ZIOP::CompressorIdListPolicy::_narrow (override.in ());
