...
ACE_INLINE u_int
ACE_OS_String::wslen (const WChar *s)
{
  u_int len = 0;
...
ACE_INLINE ACE_OS_String::WChar *
ACE_OS_String::wscpy (WChar *dest, const WChar *src)
{
...
ACE_INLINE int
ACE_OS_String::wscmp (const WChar *s, const WChar *t)
{
  const WChar *scan1 = s;
  const WChar *scan2 = t;
...
ACE_INLINE int
ACE_OS_String::wsncmp (const WChar *s, const WChar *t, size_t len)
{
  const WChar *scan1 = s;
  const WChar *scan2 = t;
