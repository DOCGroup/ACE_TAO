...
#if TAO_HAS_NIOP == 1
  ACE_Service_Config::process_directive (ace_svc_desc_TAO_NIOP_Protocol_Factory);
#endif /* TAO_HAS_SCIOP == 1 */
}
  ...
  if (factory == end)
    {
      ...
      if (TAO::details::load_protocol_factory <TAO_NIOP_Protocol_Factory> (
          this->protocol_factories_, "NIOP_Factory") == -1)
        return -1;
