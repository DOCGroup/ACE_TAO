...
namespace TAO
{
  Request_Processing_Policy_Value::~Request_Processing_Policy_Value (void)
  {
  }
  ...
  template class ACE_Dynamic_Service<Request_Processing_Policy_Value>;
  ...
  #pragma instantiate ACE_Dynamic_Service<Request_Processing_Policy_Value>
