...
namespace TAO
{
  Lifespan_Policy_Value::~Lifespan_Policy_Value (void)
  {
  }
  ...
  template class ACE_Dynamic_Service<Lifespan_Policy_Value>;
  ...
  #pragma instantiate ACE_Dynamic_Service<Lifespan_Policy_Value>
