...
namespace TAO
{
  Implicit_Activation_Policy_Value::~Implicit_Activation_Policy_Value (void)
  {
  }
  ...
  template class ACE_Dynamic_Service<Implicit_Activation_Policy_Value>;
  ...
  #pragma instantiate ACE_Dynamic_Service<Implicit_Activation_Policy_Value>
