...
namespace TAO
{
  Servant_Retention_Policy_Value::~Servant_Retention_Policy_Value (void)
  {
  }
  ...
  template class ACE_Dynamic_Service<Servant_Retention_Policy_Value>;
  ...
  #pragma instantiate ACE_Dynamic_Service<Servant_Retention_Policy_Value>
