...
//=============================================================================
/**
 *  @file Loadable_Id_Assignment_Policy.h
 *
 *  $Id$
 *
...
namespace TAO
{
  class TAO_PortableServer_Export Loadable_Id_Assignment_Policy :
     public virtual POA_Policy
  {
  public:
    virtual ~Loadable_Id_Assignment_Policy (void);
  ...
  ACE_STATIC_SVC_DECLARE_EXPORT (TAO_PortableServer, Loadable_Id_Assignment_Policy)
  ACE_FACTORY_DECLARE (TAO_PortableServer, Loadable_Id_Assignment_Policy)
}
