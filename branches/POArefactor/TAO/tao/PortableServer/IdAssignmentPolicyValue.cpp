...
namespace TAO
{
  IdAssignment_Policy_Value::~IdAssignment_Policy_Value (void)
  {
  }
  ...
  template class ACE_Dynamic_Service<IdAssignment_Policy_Value>;
  ...
  #pragma instantiate ACE_Dynamic_Service<IdAssignment_Policy_Value>
