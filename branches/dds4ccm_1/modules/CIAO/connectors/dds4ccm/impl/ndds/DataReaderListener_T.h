    ...
    namespace RTI
    {
      ...
      public:
        ...
        DataReaderListener_T (
                      typename CONNECTOR_TYPE::context_type::_ptr_type context,
      ...
      private:
        DataReaderListener_T<NDDS_TYPE, CONNECTOR_TYPE> (const DataReaderListener_T<NDDS_TYPE, CONNECTOR_TYPE> &);
        DataReaderListener_T<NDDS_TYPE, CONNECTOR_TYPE> & operator = (const DataReaderListener_T<NDDS_TYPE, CONNECTOR_TYPE> &);
        ...
        typename CONNECTOR_TYPE::rawlistener_type::_var_type listener_;
