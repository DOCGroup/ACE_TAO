...
namespace CCM_CORBA_AMI_MyFoo_Impl
{
    ...
    ::CORBA::Short ami_return_val)
  {
    ...
    foo_callback_->get_rw_attrib_callback_handler (ami_return_val);
    this->_remove_ref ();
  }
    ...
    ::Messaging::ExceptionHolder * excep_holder)
  {
    ...
    foo_callback_->get_rw_attrib_callback_excep (excep_holder);
    this->_remove_ref ();
  }
  ...
  AMI_MyFoo_reply_handler::set_rw_attrib ()
  {
    ...
    foo_callback_->set_rw_attrib_callback_handler ();
    this->_remove_ref ();
  }
    ...
    ::Messaging::ExceptionHolder * excep_holder)
  {
    ...
    foo_callback_->set_rw_attrib_callback_excep (excep_holder);
    this->_remove_ref ();
  }
    ...
    ::CORBA::Short ami_return_val)
  {
    ...
    foo_callback_->get_ro_attrib_callback_handler (ami_return_val);
    this->_remove_ref ();
  }
    ...
    ::Messaging::ExceptionHolder * excep_holder)
  {
    ...
    foo_callback_->get_ro_attrib_callback_excep (excep_holder);
    this->_remove_ref ();
  }
