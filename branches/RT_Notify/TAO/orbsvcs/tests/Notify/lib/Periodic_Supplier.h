 ...
 *
 */
class TAO_NOTIFY_TEST_Export TAO_NS_Periodic_Supplier : public TAO_NS_StructuredPushSupplier, public ACE_Task <ACE_SYNCH>
{
public:
  /// Constuctor
...
protected:
  virtual void connect_i (ACE_ENV_SINGLE_ARG_DECL);
...
#include "NS_Periodic_Supplier.inl"
