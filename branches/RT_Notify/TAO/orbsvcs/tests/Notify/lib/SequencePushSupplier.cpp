...
void
TAO_NS_SequencePushSupplier::init
...
TAO_NS_SequencePushSupplier::get_proxy_consumer (void)
{
  return proxy_consumer_.in ();
}

void
TAO_NS_SequencePushSupplier::connect (
...
void
TAO_NS_SequencePushSupplier::disconnect (ACE_ENV_SINGLE_ARG_DECL)
{
...
void
TAO_NS_SequencePushSupplier::subscription_change
...
TAO_NS_SequencePushSupplier::_default_POA (
...
void
TAO_NS_SequencePushSupplier::deactivate (ACE_ENV_SINGLE_ARG_DECL)
{
...
void
TAO_NS_SequencePushSupplier::disconnect_sequence_push_supplier (
...
void
TAO_NS_SequencePushSupplier::send_events (
