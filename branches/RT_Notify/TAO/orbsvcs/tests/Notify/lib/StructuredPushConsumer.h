...
//
// = DESCRIPTION
//   This is a utility class is to be used by test clients of the Notification
...
class TAO_NOTIFY_TEST_Export TAO_NS_StructuredPushConsumer : public POA_CosNotifyComm::StructuredPushConsumer, public PortableServer::RefCountServantBase
{
  // = TITLE
...
protected:
  ...
  virtual ~TAO_NS_StructuredPushConsumer (void);
  // Destructor
