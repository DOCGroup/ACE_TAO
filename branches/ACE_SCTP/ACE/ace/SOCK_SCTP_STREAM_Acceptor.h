...
//=============================================================================
/**
 *  @file    SOCK_SCTP_STREAM_Acceptor.h
 *
 *  $Id$
...
#ifndef ACE_SOCK_SCTP_STREAM_ACCEPTOR_H
#define ACE_SOCK_SCTP_STREAM_ACCEPTOR_H
...
/**
 * @class ACE_SOCK_SCTP_STREAM_Acceptor
 *
 * @brief Defines a factory that creates new ACE_Associations passively.
 *
 * The <ACE_SOCK_SCTP_STREAM_Acceptor> has its own "passive-mode" socket.
 * This serves as a factory to create so-called "data-mode"
 * sockets, which are what the ACE_SOCK_SCTP_STREAM encapsulates.
 * Therefore, by inheriting from <ACE_SOCK>, <ACE_SOCK_SCTP_STREAM_Acceptor>
 * gets its very own socket.
 */
class ACE_Export ACE_SOCK_SCTP_STREAM_Acceptor : public ACE_SOCK
{
public:
  // = Initialization and termination methods.
  /// Default constructor.
  ACE_SOCK_SCTP_STREAM_Acceptor (void);
   ...
   */
  ACE_SOCK_SCTP_STREAM_Acceptor (const ACE_Addr &local_sap,
                     int reuse_addr = 0,
  ...
  ACE_SOCK_SCTP_STREAM_Acceptor (const ACE_Multihomed_INET_Addr &local_sap,
                     int reuse_addr = 0,
                     int protocol_family = PF_UNSPEC,
                     int backlog = ACE_DEFAULT_BACKLOG,
                     int protocol = 132);
  ...
  /**
   * Accept a new ACE_SOCK_SCTP_STREAM connection.  A @a timeout of 0
   ...
   * <ACE_SOCK_SCTP_STREAM_Acceptor>, i.e., if @c this acceptor factory is in
   * non-blocking mode, the <net_association> will be in non-blocking mode
   * and vice versa.
   */
  int accept (ACE_SOCK_SCTP_STREAM &new_association,
  ...
  typedef ACE_SOCK_SCTP_STREAM PEER_STREAM;
...
protected:
  ...
  /// called.
  int shared_accept_finish (ACE_SOCK_SCTP_STREAM new_association,
...
#include "ace/SOCK_SCTP_STREAM_Acceptor.inl"
#endif /* __ACE_INLINE__ */

#include /**/ "ace/post.h"

#endif /* ACE_SOCK_SCTP_STREAM_ACCEPTOR_H */
