...
ACE_RCSID(ace, SOCK_SCTP_STREAM_Connector, "SOCK_SCTP_STREAM_Connector.cpp,v 4.35 2002/03/08 23:18:09 spark Exp")

ACE_BEGIN_VERSIONED_NAMESPACE_DECL

ACE_ALLOC_HOOK_DEFINE(ACE_SOCK_SCTP_STREAM_Connector)

int
ACE_SOCK_SCTP_STREAM_Connector::shared_open (ACE_SOCK_SCTP_STREAM &new_association,
                                 int protocol_family,
                                 int protocol,
                                 int reuse_addr)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Connector::shared_open");
...
#else
         new_association.open (SOCK_SCTP_STREAMET,
...
int
ACE_SOCK_SCTP_STREAM_Connector::shared_connect_start (ACE_SOCK_SCTP_STREAM &new_association,
                                          const ACE_Time_Value *timeout,
                                          const ACE_Addr &local_sap)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Connector::shared_connect_start");
...
int
ACE_SOCK_SCTP_STREAM_Connector::shared_connect_finish (ACE_SOCK_SCTP_STREAM &new_association,
                                           const ACE_Time_Value *timeout,
                                           int result)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Connector::shared_connect_finish");
  // Save/restore errno.
  ACE_Errno_Guard error (errno);
...
int
ACE_SOCK_SCTP_STREAM_Connector::complete (ACE_SOCK_SCTP_STREAM &new_association,
                              ACE_Addr *remote_sap,
                              const ACE_Time_Value *tv)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Connector::complete");
...
ACE_SOCK_SCTP_STREAM_Connector::ACE_SOCK_SCTP_STREAM_Connector (ACE_SOCK_SCTP_STREAM &new_association,
                                        const ACE_Addr &remote_sap,
                                        const ACE_Time_Value *timeout,
                                        const ACE_Addr &local_sap,
                                        int reuse_addr,
                                        ...
                                        int protocol)
{
  ...
  if (this->connect (new_association,
    ...
    ACE_ERROR ((LM_ERROR,
                ACE_LIB_TEXT ("%p\n"),
                ACE_LIB_TEXT ("ACE_SOCK_SCTP_STREAM_Connector::ACE_SOCK_SCTP_STREAM_Connector")));
}
