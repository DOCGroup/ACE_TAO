...
ACE_INLINE
ACE_SOCK_SCTP_STREAM_Connector::~ACE_SOCK_SCTP_STREAM_Connector (void)
{
  ACE_TRACE ("ACE_SOCK_SCTP_STREAM_Connector::~ACE_SOCK_SCTP_STREAM_Connector");
}
...
ACE_INLINE int
ACE_SOCK_SCTP_STREAM_Connector::reset_new_handle (ACE_HANDLE handle)
{
