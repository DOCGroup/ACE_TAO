...
//=============================================================================
/**
 *  @file    SOCK_SCTP_STREAM_Connector.h
 *
 *  $Id$
 *
...
public:
   ...
   *                    connect(). @see connect().
   */
  int complete (ACE_SOCK_SCTP_STREAM &new_association,
...
protected:
  ...
  int shared_open (ACE_SOCK_SCTP_STREAM &new_association,
                   int protocol_family,
                   int protocol,
                   int reuse_addr);
  ...
  int shared_connect_start (ACE_SOCK_SCTP_STREAM &new_association,
                            const ACE_Time_Value *timeout,
  ...
  int shared_connect_finish (ACE_SOCK_SCTP_STREAM &new_association,
                             const ACE_Time_Value *timeout,
                             int result);
};
...
#include "ace/SOCK_SCTP_STREAM_Connector.inl"
#endif /* __ACE_INLINE__ */

#include /**/ "ace/post.h"

#endif /* ACE_SOCK_SCTP_STREAM_CONNECTOR_H */
