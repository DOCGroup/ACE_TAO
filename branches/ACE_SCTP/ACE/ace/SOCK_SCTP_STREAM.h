...
#ifndef ACE_SOCK_SCTP_STREAM_H
#define ACE_SOCK_SCTP_STREAM_H
...
/**
 * @class ACE_SOCK_SCTP_STREAM
 *
 * @brief Defines the methods in the ACE_SOCK_SCTP_STREAM abstraction.
 *
 ...
 */
class ACE_Export ACE_SOCK_SCTP_STREAM : public ACE_SOCK_IO, 
                                        public ACE_SOCK_SCTP
{
public:
  // Initialization and termination methods.
  /// Constructor.
  ACE_SOCK_SCTP_STREAM (void);

  /// Constructor (sets the underlying ACE_HANDLE with <h>).
  ACE_SOCK_SCTP_STREAM (ACE_HANDLE h);
