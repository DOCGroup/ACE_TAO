  ...
  while ( (c = get_opts ()) != -1)
    {
      switch (c)
        {
        case 'p':
          DANCE_DEBUG ((LM_DEBUG, DLINFO "FaultCorrelationManager_Module::parse_args - "
              ...
              if (get_opts.opt_arg () == 0)
                {
                  if (this->options_.domain_nc_ == 0)
                    {
                      DANCE_ERROR ((LM_ERROR, DLINFO "FaultCorrelationManager_Module::parse_args - "
        ...
        default:
          DANCE_DEBUG ((LM_TRACE, DLINFO "FaultCorrelationManager_Module::parse_args - ignoring unknown option %i\n",
                        c));
        }
    }
  return true;
      ...
      if (this->options_.domain_nc_)
        {
          try
            ...
            {
              DANCE_DEBUG  ((LM_WARNING, DLINFO "FaultCorrelationManager_Module::create_object - "
...
FaultCorrelationManager_Module::create_poas (void)
{
  ...
  DANCE_DEBUG ((LM_TRACE, DLINFO "FaultCorrelationManager_Module::create_poas - "
                "Resolving root POA\n"));
  ...
  try
    {
      DANCE_DEBUG ((LM_TRACE, DLINFO "FaultCorrelationManager_Module::create_poas - "
                    "FaultCorrelationManager_Module::create_poas - "
    ...
    {
      DANCE_DEBUG ((LM_INFO, DLINFO "FaultCorrelationManager_Module::create_poas - "
