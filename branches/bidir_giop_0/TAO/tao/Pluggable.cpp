...
ssize_t
TAO_Transport::send (TAO_Stub *stub,
                     int two_way,
...
ssize_t
TAO_Transport::send (const ACE_Message_Block *message_block,
                     const ACE_Time_Value *max_wait_time,
...
ssize_t
TAO_Transport::send (const u_char *buf,
                          size_t len,
                          const ACE_Time_Value *max_wait_time)
{
