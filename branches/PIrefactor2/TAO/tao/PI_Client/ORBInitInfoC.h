...
#define _PORTABLEINTERCEPTOR_ORBINITINFO_CH_
  ...
  class TAO_PI_CLIENT_Export ORBInitInfo
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO_DUPLICATENAME_CH_
    ...
    class TAO_PI_CLIENT_Export DuplicateName : public CORBA::UserException
    {
    public:
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO_INVALIDNAME_CH_
    ...
    class TAO_PI_CLIENT_Export InvalidName : public CORBA::UserException
    {
    public:
  ...
  extern TAO_PI_CLIENT_Export ::CORBA::TypeCode_ptr const _tc_ORBInitInfo;
...
#define _PORTABLEINTERCEPTOR_CLIENTREQUESTINTERCEPTOR__TRAITS_CH_
  ...
  template<>
  struct TAO_PI_CLIENT_Export Objref_Traits< ::PortableInterceptor::ClientRequestInterceptor>
  {
...
#define _PORTABLEINTERCEPTOR_SERVERREQUESTINTERCEPTOR__TRAITS_CH_
  ...
  template<>
  struct TAO_PI_CLIENT_Export Objref_Traits< ::PortableInterceptor::ServerRequestInterceptor>
  {
...
#define _PORTABLEINTERCEPTOR_IORINTERCEPTOR__TRAITS_CH_
  ...
  template<>
  struct TAO_PI_CLIENT_Export Objref_Traits< ::PortableInterceptor::IORInterceptor>
  {
...
#define _PORTABLEINTERCEPTOR_POLICYFACTORY__TRAITS_CH_
  ...
  template<>
  struct TAO_PI_CLIENT_Export Objref_Traits< ::PortableInterceptor::PolicyFactory>
  {
...
TAO_PI_CLIENT_Export void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo_ptr); // copying
TAO_PI_CLIENT_Export void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo_ptr *); // non-copying
TAO_PI_CLIENT_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo_ptr &);

// TAO_IDL - Generated from
// be\be_visitor_exception/any_op_ch.cpp:52

TAO_PI_CLIENT_Export void operator<<= (CORBA::Any &, const PortableInterceptor::ORBInitInfo::DuplicateName &); // copying version
TAO_PI_CLIENT_Export void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo::DuplicateName*); // noncopying version
TAO_PI_CLIENT_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo::DuplicateName *&); // deprecated
TAO_PI_CLIENT_Export CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::ORBInitInfo::DuplicateName *&);

// TAO_IDL - Generated from
// be\be_visitor_exception/any_op_ch.cpp:52

TAO_PI_CLIENT_Export void operator<<= (CORBA::Any &, const PortableInterceptor::ORBInitInfo::InvalidName &); // copying version
TAO_PI_CLIENT_Export void operator<<= (CORBA::Any &, PortableInterceptor::ORBInitInfo::InvalidName*); // noncopying version
TAO_PI_CLIENT_Export CORBA::Boolean operator>>= (const CORBA::Any &, PortableInterceptor::ORBInitInfo::InvalidName *&); // deprecated
TAO_PI_CLIENT_Export CORBA::Boolean operator>>= (const CORBA::Any &, const PortableInterceptor::ORBInitInfo::InvalidName *&);
