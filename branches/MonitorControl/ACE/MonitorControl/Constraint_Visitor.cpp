...
namespace ACE
{
  namespace MonitorControl
  {
    ...
    int
    Constraint_Visitor::visit_literal (ETCL_Literal_Constraint *)
    {
      return 0;
    }
    
    int
    Constraint_Visitor::visit_identifier (ETCL_Identifier *)
    {
      return 0;
    }
    ...
    int
    Constraint_Visitor::visit_unary_expr (ETCL_Unary_Expr *)
    {
      return 0;
    }
    
    int
    Constraint_Visitor::visit_binary_expr (ETCL_Binary_Expr *)
    {
      return 0;
    }
