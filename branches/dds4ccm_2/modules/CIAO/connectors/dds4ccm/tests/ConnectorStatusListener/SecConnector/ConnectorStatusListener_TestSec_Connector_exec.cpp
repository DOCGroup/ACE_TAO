...
{
  ConnectorStatusListener_TestSec_Connector_exec_i::ConnectorStatusListener_TestSec_Connector_exec_i (const char * topic_name)
    : Connector_T<TestSecondTopic_DDS_Traits, TestSecondTopic_Connector_Traits> (topic_name)
  {
  }
  ...
  create_ConnectorStatusListener_TestSec_ConnectorStatusListener_TestSec_Connector_Impl (void)
  {
    ...
    ACE_NEW_NORETURN (
      retval,
      ConnectorStatusListener_TestSec_Connector_exec_i ("Circle")); //should be set by dep. plan.
