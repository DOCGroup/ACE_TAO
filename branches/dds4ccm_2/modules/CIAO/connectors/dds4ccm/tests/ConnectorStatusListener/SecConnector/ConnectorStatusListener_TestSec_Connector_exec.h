...
namespace CIAO_ConnectorStatusListener_TestSec_ConnectorStatusListener_TestSec_Connector_Impl
{
  ...
  typedef Connector_Traits <
    ...
    ::CCM_DDS::TestSecondTopic::RawListener,
  ...
  class CONNECTORSTATUSLISTENER_TESTSEC_CONNECTOR_EXEC_Export ConnectorStatusListener_TestSec_Connector_exec_i :
    public Connector_T <TestSecondTopic_DDS_Traits, TestSecondTopic_Connector_Traits>
  {
  public:
    ConnectorStatusListener_TestSec_Connector_exec_i (const char * topic_name);
