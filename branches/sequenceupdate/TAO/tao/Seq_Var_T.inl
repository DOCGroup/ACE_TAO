...
template<typename T>
ACE_INLINE
TAO_MngSeq_Var_T<T>::TAO_MngSeq_Var_T (void)
{}

template<typename T>
ACE_INLINE
TAO_MngSeq_Var_T<T>::TAO_MngSeq_Var_T (T * p)
  : TAO_Seq_Var_Base_T<T> (p)
{
}

template<typename T>
TAO_MngSeq_Var_T<T>::TAO_MngSeq_Var_T (
...
ACE_INLINE
TAO_MngSeq_Var_T<T> &
TAO_MngSeq_Var_T<T>::operator= (T * p)
{
  delete this->ptr_;
  this->ptr_ = p;
  return *this;
...
template<typename T>
ACE_INLINE
typename TAO_MngSeq_Var_T<T>::T_elem
