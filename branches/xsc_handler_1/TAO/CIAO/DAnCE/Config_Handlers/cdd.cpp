...
namespace Deployment
{
  ...
  Domain::
  Domain (::Deployment::Domain const& s)
  :
  label_ (new ::XMLSchema::string< char > (*s.label_)),
  UUID_ (new ::XMLSchema::string< char > (*s.UUID_)),
  sharedResource_ (s.sharedResource_.get () ? new ::Deployment::SharedResource (*s.sharedResource_) : 0),
  ...
  operator= (::Deployment::Domain const& s)
  {
    label (s.label ());
    ...
    else sharedResource_ = ::std::auto_ptr< ::Deployment::SharedResource > (0);
  ...
  ::Deployment::SharedResource const& Domain::
  sharedResource () const
  {
    return *sharedResource_;
  }

  ::Deployment::SharedResource& Domain::
  sharedResource ()
  {
    return *sharedResource_;
  }
  ...
  void Domain::
  sharedResource (::Deployment::SharedResource const& e)
  {
    ...
    {
      sharedResource_ = ::std::auto_ptr< ::Deployment::SharedResource > (new ::Deployment::SharedResource (e));
  ...
  void Domain::
  add_node (::Deployment::Node const& e)
  {
    if (node_.capacity () < node_.size () + 1)
    {
      ::std::vector< ::Deployment::Node > v;
      v.reserve (node_.size () + 1);

      while (node_.size ())
      {
        //@@ VC6
        ::Deployment::Node& t = node_.back ();
        t.container (0);
        v.push_back (t);
  ...
  ::Deployment::Property const& Domain::
  infoProperty () const
  {
