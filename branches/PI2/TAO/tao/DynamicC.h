...
#define __TAO_UNBOUNDED_OBJECT_SEQUENCE_DYNAMIC_EXCEPTIONLIST_CH_
    ...
    public:
      ...
      TAO_Pseudo_Object_Manager<CORBA::TypeCode,CORBA::TypeCode_var> operator[] (CORBA::ULong index) const;
...
#define _DYNAMIC_EXCEPTIONLIST___VAR_CH_
  ...
  public:
    ...
    TAO_Pseudo_Object_Manager<CORBA::TypeCode,CORBA::TypeCode_var> operator[] (CORBA::ULong index);
    // in, inout, out, _retn 
