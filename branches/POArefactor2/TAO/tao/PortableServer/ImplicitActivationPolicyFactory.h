...
namespace TAO
{
  namespace Portable_Server
  {
    ...
    {
    public:
      virtual ~ImplicitActivationPolicyFactory (void);
    ...
    ACE_STATIC_SVC_DECLARE_EXPORT (TAO_PortableServer, ImplicitActivationPolicyFactory)
    ACE_FACTORY_DECLARE (TAO_PortableServer, ImplicitActivationPolicyFactory)
  }
}
