                           ...
                           ACE_ENV_ARG_DECL)
{
  ...
  if (result != 0 ||
      ...
      !this->active_policy_strategies_.lifespan_strategy()->validate (is_persistent, poa_creation_time))
    {
...
bool
TAO_POA::has_system_id (void) const
{
...
CORBA::Short
TAO_POA::server_priority (void) const
{
