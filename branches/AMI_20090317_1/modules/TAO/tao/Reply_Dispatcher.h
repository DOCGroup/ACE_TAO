...
public:
  ...
  /// Copy constructor
  TAO_Reply_Dispatcher (TAO_ORB_Core *orb_core,
...
private:
  void operator= (const TAO_Reply_Dispatcher &);
  TAO_Reply_Dispatcher (const TAO_Reply_Dispatcher &);
...
namespace TAO
{
  ...
  {
  public:
    void operator() (TAO_Reply_Dispatcher *ardb) throw ();
  };
