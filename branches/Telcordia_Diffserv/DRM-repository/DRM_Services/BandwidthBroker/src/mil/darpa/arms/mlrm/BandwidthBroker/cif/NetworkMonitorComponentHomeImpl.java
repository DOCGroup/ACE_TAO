...
public class NetworkMonitorComponentHomeImpl
     extends mil.darpa.arms.mlrm.BandwidthBroker.NMSessionComposition.HomeImpl
{
    // ==================================================================
    //
    // Internal state.
    ...
    public
    NetworkMonitorComponentHomeImpl()
    {
...
*/
    ...
    create_executor_segment(int segid)
    {
	    ...
	    //     created 
          ...
          return new NetworkMonitorComponentImpl();
    }

    // ==================================================================
    //
    // Methods for OMG IDL DiningPhilosophers::CCM_PhilosopherHome
    //
    // ==================================================================
    ...
    create_home()
    {
        return new NetworkMonitorComponentHomeImpl();
    }
