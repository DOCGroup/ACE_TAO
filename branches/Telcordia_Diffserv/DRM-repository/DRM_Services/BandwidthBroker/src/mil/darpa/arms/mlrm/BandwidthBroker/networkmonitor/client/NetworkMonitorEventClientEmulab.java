...
public class NetworkMonitorEventClientEmulab extends NMEventConsumerPOA
{
    ...
    {
	NetworkMonitorEventClientEmulab nmClient = new NetworkMonitorEventClientEmulab ();
	NetworkMonitor netMon=null;
	org.omg.CORBA.Object obj =null;
	if( args.length < 3 ) 
	    {
		System.out.println( "Usage: java "+
				    " com.telcordia.research.BandwidthBroker.networkmonitor.client.NetworkMonitorEventClientEmulab "+
...
*/	
	...
	//latencyBetnHosts[1] = new LatencyBetnHosts ("rondomon09", 
	//				    "rondomon08", 
	//					    latencyPerQoSSeq);
	...
	/*System.out.println ("Subscribing for delay measurement event between hosts rondomon08 and rondomon09"+
	...
	latencyBetnHosts[0] = new LatencyBetnHosts ("rondomon09", 
						    "rondomon08", 
						    latencyPerQoSSeq);
	me.hostsLatencyInfo (latencyBetnHosts);
	MeasurementEndpointsHolder latencyInfo = new MeasurementEndpointsHolder (me);
	...
	/*	System.out.println (" Subscribing for latency event between hosts rondomon09 "+
			    "and rondomon08 with cookie:"+cookie+
