...
public class FaultMonitorComponentHomeImpl
     extends mil.darpa.arms.mlrm.BandwidthBroker.FMSessionComposition.HomeImpl
{
    // ==================================================================
    //
    // Internal state.
...
*/
    ...
    create_executor_segment(int segid)
    {
	    ...
	    //     created 
          ...
          return new FaultMonitorComponentImpl();
    }
    ...
    create_home()
    {
        return new FaultMonitorComponentHomeImpl();
    }
}
