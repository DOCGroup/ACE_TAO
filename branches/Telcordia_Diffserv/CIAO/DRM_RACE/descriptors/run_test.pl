...
#$daemons = 11;
$daemons = 1;
@ports = ( 50200, 50001, 50002, 50003, 50004,50005,50006,50007, 50008, 50009, 50010  );
...
$status = 0;
#$dat_file = "deployment.dat";
$dat_file = "NodeDetails.dat";
#$cdp_file = "RACE_Interactive.cdp";
$cdp_file = "RACE_NetQoS.cdp";
...
$NS = new PerlACE::Process ("$TAO_ROOT/orbsvcs/Naming_Service/Naming_Service",
"-m 0 -ORBEndpoint iiop://localhost:40203 -o ns.ior");
...
$ENV{"NameServiceIOR"} = "corbaloc:iiop:localhost:40203/NameService";
