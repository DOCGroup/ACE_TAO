...
namespace CIAO
{
  namespace RACE
  {
    ...
    {
      LocationUpdater_Context::LocationUpdater_Context (
      ...
      LocationUpdater_Context::~LocationUpdater_Context (void)
      {
      }
      ...
      LocationUpdater_Context::get_connection_ingress (
      ...
      void
      LocationUpdater_Context::connect_ingress (
      ...
      ::CIAO::RACE::PlanIngress_ptr
      LocationUpdater_Context::disconnect_ingress (
      ...
      {
        return dynamic_cast<LocationUpdater_Context *> (p);
      }

      LocationUpdater_Servant::LocationUpdater_Servant (
        ::CIAO::RACE::CCM_LocationUpdater_ptr exe,
        ::Components::CCMHome_ptr h,
        const char *ins_name,
          ...
          ins_name_ (ins_name)
      {
        ACE_NEW (this->context_,
                 LocationUpdater_Context (h, c, this));
      ...
      LocationUpdater_Servant::~LocationUpdater_Servant (void)
      {
      }

      void
      LocationUpdater_Servant::set_attributes (
      ...
      LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant::Deploy_InputConsumer_deployment_Servant (
        ::CIAO::RACE::CCM_LocationUpdater_ptr executor,
        ::CIAO::RACE::CCM_LocationUpdater_Context_ptr c)
        : executor_ ( ::CIAO::RACE::CCM_LocationUpdater::_duplicate (executor)),
          ctx_ ( ::CIAO::RACE::CCM_LocationUpdater_Context::_duplicate (c))
      {
      }

      LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant::~Deploy_InputConsumer_deployment_Servant (void)
      {
      }

      ::CORBA::Object_ptr
      LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant::_get_component (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant::push_Deploy_Input (
      ...
      void
      LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant::push_event (
      ...
      CORBA::Boolean
      LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant::ciao_is_substitutable (
      ...
      LocationUpdater_Servant::get_consumer_deployment (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      LocationUpdater_Servant::get_consumer_deployment_i (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
        ...
        LocationUpdater_Servant::Deploy_InputConsumer_deployment_Servant,
        ::CIAO::RACE::CCM_LocationUpdater,
        ::CIAO::RACE::CCM_LocationUpdater_Context,
        LocationUpdater_Servant > *tmp = 0;
      ...
      ::Components::Cookie *
      LocationUpdater_Servant::connect (
        const char *name,
      ...
      ::CORBA::Object_ptr
      LocationUpdater_Servant::disconnect (
        const char *name,
      ...
      LocationUpdater_Servant::get_all_receptacles (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      LocationUpdater_Servant::connect_ingress (
        ::CIAO::RACE::PlanIngress_ptr c
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
                       ::Components::AlreadyConnected,
      ...
      ::CIAO::RACE::PlanIngress_ptr
      LocationUpdater_Servant::disconnect_ingress (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
                       ::Components::NoConnection))
      {
      ...
      ::CIAO::RACE::PlanIngress_ptr
      LocationUpdater_Servant::get_connection_ingress (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      LocationUpdater_Servant::connect_consumer (
      ...
      ::Components::EventConsumerBase_ptr
      LocationUpdater_Servant::disconnect_consumer (
      ...
      LocationUpdater_Servant::get_all_publishers (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      LocationUpdater_Servant::get_all_emitters (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      ::Components::Cookie *
      LocationUpdater_Servant::subscribe (
      ...
      ::Components::EventConsumerBase_ptr
      LocationUpdater_Servant::unsubscribe (
        const char *publisher_name,
        ::Components::Cookie *ck
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException,
      ...
      ::CORBA::Object_ptr
      LocationUpdater_Servant::get_facet_executor (
        const char *name
        ACE_ENV_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      void
      LocationUpdater_Servant::populate_port_tables (
        ACE_ENV_SINGLE_ARG_DECL)
      ACE_THROW_SPEC (( ::CORBA::SystemException))
      {
      ...
      LocationUpdater_Home_Servant::LocationUpdater_Home_Servant (
      ...
      LocationUpdater_Home_Servant::~LocationUpdater_Home_Servant (void)
      {
      }
        ...
        ACE_ENV_ARG_DECL)
      {
        ...
        ::CIAO::RACE::CCM_LocationUpdater_Home_var x =
        ::CIAO::RACE::CCM_LocationUpdater_Home::_narrow (
          p
          ACE_ENV_ARG_PARAMETER);
        ACE_CHECK_RETURN (0);
