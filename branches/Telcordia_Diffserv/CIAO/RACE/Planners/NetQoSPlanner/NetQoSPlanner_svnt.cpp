...
namespace CIAO
{
  namespace RACE
  {
    namespace CIDL_NetQoSPlanner_Impl
    {
      ...
      NetQoSPlanner_Home_Servant::NetQoSPlanner_Home_Servant (
      ...
      NetQoSPlanner_Home_Servant::~NetQoSPlanner_Home_Servant (void)
      {
      }
        ...
        ACE_ENV_ARG_DECL)
      {
        ...
        ::CIAO::RACE::CCM_NetQoSPlanner_Home_var x =
        ::CIAO::RACE::CCM_NetQoSPlanner_Home::_narrow (
          p
          ACE_ENV_ARG_PARAMETER);
        ACE_CHECK_RETURN (0);
