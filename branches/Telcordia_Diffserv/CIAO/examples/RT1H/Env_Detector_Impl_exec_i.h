...
#ifndef _ENV_DETECTOR_IMPL_EXEC_I_H_
#define _ENV_DETECTOR_IMPL_EXEC_I_H_
...
#include "Env_Detector_Impl_exec_export.h"
...
{
  class ENV_DETECTOR_IMPL_EXEC_Export Env_Detector :
  ...
  class ENV_DETECTOR_IMPL_EXEC_Export Env_Detector_Factory :
  ...
  CUTS_FACTORY_EXPORT_DECLARE (ENV_DETECTOR_IMPL_EXEC_Export,
                                create_TSCE_Env_Detector_Factory_Impl);
}

#include /**/ "ace/post.h"

#endif  // !defined _ENV_DETECTOR_IMPL_EXEC_I_H_
