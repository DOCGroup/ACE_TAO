...
namespace CIDL_Receiver_Impl
{
  ...
  CORBA::Boolean
  Receiver_Servant::TimeOutConsumer_click_in_Servant::ciao_is_substitutable (
                   ...
                   ::Components::ExceededConnectionLimit))
  {
    ...
    if (ACE_OS::strcmp (name, "read_message") == 0)
    {
      ...
      policy_list = this->get_receptacle_policy (name);
      ...
      if (policy_list.length () != 0)
        {
          CORBA::Object_var over_ridden_object =
            _ciao_conn->_set_policy_overrides (policy_list,
                                               CORBA::SET_OVERRIDE
                                               ACE_ENV_ARG_PARAMETER);
          ACE_TRY_CHECK;

          _ciao_conn = ::Hello::ReadMessage::_narrow (over_ridden_object
                                                      ACE_ENV_ARG_PARAMETER);
          ACE_CHECK_RETURN (0);
        }
  ...
  Receiver_Servant::get_all_receptacles (
    ACE_ENV_SINGLE_ARG_DECL)
  ACE_THROW_SPEC (( ::CORBA::SystemException))
  {
    ...
    ::CIAO::Servant_Impl_Base::describe_simplex_receptacle<
      ...
      > ("read_message",
         ...
         this->context_->ciao_uses_read_message_,
         safe_retval,
         0UL);
                   ...
                   ::Components::InvalidConnection))
  {
    ...
    this->add_receptacle ("read_message", c, 0);
  }
  ...
  ::Components::EventConsumerBase_ptr
  Receiver_Servant::disconnect_consumer (
  ...
  Receiver_Servant::get_all_publishers (
    ACE_ENV_SINGLE_ARG_DECL)
  ACE_THROW_SPEC (( ::CORBA::SystemException))
  {
  ...
  Receiver_Servant::get_all_emitters (
    ACE_ENV_SINGLE_ARG_DECL)
  ACE_THROW_SPEC (( ::CORBA::SystemException))
  {
  ...
  ::CORBA::Object_ptr
  Receiver_Servant::get_facet_executor (
    const char *name
    ACE_ENV_ARG_DECL)
  ACE_THROW_SPEC (( ::CORBA::SystemException))
  {
