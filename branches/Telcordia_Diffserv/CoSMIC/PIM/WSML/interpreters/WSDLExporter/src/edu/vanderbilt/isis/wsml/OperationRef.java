...
/**
 * Domain specific class of <code>OperationRef</code>.
 */ 
public class OperationRef extends MgaObject
{
	// meta information
	public static final String META_TYPE = "OperationRef";
	 ...
	 */ 
	protected OperationRef(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>OperationRef</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static OperationRef create(Binding parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new OperationRef(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
