  ...
  if (event_count > 0)
    {
      ...
      return this->handle_socket_events (max_wait_time,
                                         guard);
    }
...
int
ACE_TP_Reactor::handle_socket_events (ACE_Time_Value *max_wait_time,
                                      ACE_TP_Token_Guard &guard)
{
  ...
  int result =
    this->dispatch_i (max_wait_time, dispatch_info);
