...
#define NUM_EVENTS_MSG_QUEUE 17
...
#define BEFORE_ENQUEUE_PRIO_LOCK_ACQUIRE 13
#define AFTER_ENQUEUE_PRIO_LOCK_ACQUIRE 14
#define BEFORE_ENQUEUE_I_CALL 15
#define AFTER_ENQUEUE_I_CALL 16
