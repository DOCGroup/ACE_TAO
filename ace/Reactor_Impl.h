...
public:
   ...
   * time.  This method returns a timer id that uniquely identifies
   * the <event_handler> in an internal list.  This timer id can be
   ...
   * (which is guaranteed never to be a valid timer id.
   */
