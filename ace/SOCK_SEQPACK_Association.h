...
public:
   ...
   * <ACE_Addr>, which should have the specified <size>.  If
   * successful, returns 0, otherwise returns -1.
   */
  int get_local_addrs (ACE_Addr *addrs, size_t size) const;
   ...
   * successful, returns 0, otherwise returns -1.
   */
  int get_remote_addrs (ACE_Addr *addrs, size_t size) const;
