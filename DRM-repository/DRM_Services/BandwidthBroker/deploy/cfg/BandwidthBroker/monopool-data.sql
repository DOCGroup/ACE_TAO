...
VALUES
  ...
  ('FastEthernet5/9', 'up', 'up', 10000, 'phy', 1, NULL),
  ('FastEthernet5/10', 'up', 'up', 10000, 'phy', 1, NULL),
  ('FastEthernet5/11', 'up', 'up', 10000, 'phy', 1, NULL),
  ('FastEthernet5/12', 'up', 'up', 10000, 'phy', 1, NULL),
  ('FastEthernet5/13', 'up', 'up', 10000, 'phy', 1, NULL);
...
VALUES
  ...
  ('FastEthernet5/9', 'up', 'up', 61, 8, 1),
  ('FastEthernet5/10', 'up', 'up', 61, 9, 1),
  ('FastEthernet5/11', 'up', 'up', 61, 10, 1),
  ('FastEthernet5/12', 'up', 'up', 61, 11, 1),
  ('FastEthernet5/13', 'up', 'up', 61, 12, 1);
...
VALUES
    ...
    ('192.168.81.101', '255.255.255.0', 1, 'Pool-1A', 2, '192.168.81.1', 'checkmate'),
    ('192.168.81.102', '255.255.255.0', 1, 'Pool-1A', 3, '192.168.81.1', 'uberpc'),
    ('192.168.81.103', '255.255.255.0', 1, 'Pool-1A', 4, '192.168.81.1', 'champion'),
    ('192.168.81.106', '255.255.255.0', 1, 'Pool-1A', 5, '192.168.81.1', 'javelin'),
    ('192.168.81.107', '255.255.255.0', 1, 'Pool-1A', 6, '192.168.81.1', 'chaparal'),
    ('192.168.81.108', '255.255.255.0', 1, 'Pool-1A', 7, '192.168.81.1', 'hogfish'),
