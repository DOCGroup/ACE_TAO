...
#Insert HostSubnet
INSERT INTO HostSubnet (hostSubnetAddr, hostSubnetMask, l3InterfaceID, poolName, l2InterfaceID, l3Gateway)
VALUES
    ('192.168.81.100', '255.255.255.0', 1, 'Pool-1A', 1, '192.168.81.1'),
    ('192.168.81.101', '255.255.255.0', 1, 'Pool-1A', 2, '192.168.81.1'),
    ('192.168.81.0', '255.255.255.0', 1, 'Pool-1A', NULL, NULL),			
    ('192.168.82.0', '255.255.255.0', 2, 'Pool-1B', NULL, NULL),	
    ('192.168.83.0', '255.255.255.0', 3, 'Pool-2A', NULL, NULL);	
