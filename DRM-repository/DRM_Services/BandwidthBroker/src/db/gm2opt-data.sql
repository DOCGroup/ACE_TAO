...
INSERT INTO PTP (name, adminState, operationalState, rate, phyAddress,
  switchID, routerID)
VALUES
  ('ethA', 'up', 'up', 10000, 'phy', NULL, 1),
  ('ethB', 'up', 'up', 10000, 'phy', NULL, 1),
...
VALUES
  ('ethA', 'up', 'up', '192.168.81.1', '255.255.255.0', NULL, 1, 1),
  ('ethB', 'up', 'up', '192.168.82.1', '255.255.255.0', NULL, 2, 1),
...
VALUES
    ...
    ('192.168.82.101', '255.255.255.0', 2, 'Pool-1B', 2, '192.168.82.1', 'javelin'),
