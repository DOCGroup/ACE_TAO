...
public class NetworkMonitorClientEmulab
{
	...
	if( args.length < 1 ) 
		...
		System.out.println( "Usage: java "+
				    " com.telcordia.research.BandwidthBroker.networkmonitor.client.NetworkMonitorClientEmulab"+
	...
	latencyBetnHosts[0] = new LatencyBetnHosts ("rondomon08", 
						    "rondo-monnnn09", 
						    latencyPerQoSSeq);
	
	me.hostsLatencyInfo (latencyBetnHosts);
	MeasurementEndpointsHolder latencyInfo = new MeasurementEndpointsHolder (me);
	System.out.println ("Delay measurement request between hosts rondomon08 and rondomonnnn09"+
	...
	me.hostsLatencyInfo (latencyBetnHosts);
	MeasurementEndpointsHolder latencyInfo = new MeasurementEndpointsHolder (me);
	System.out.println ("Delay measurement request between hosts rondomon08 and rondomon09"+
	...
	latencyBetnHosts[1] = new LatencyBetnHosts ("alpha", 
						    "beta", 
						    latencyPerQoSSeq);
	me.hostsLatencyInfo (latencyBetnHosts);
	MeasurementEndpointsHolder latencyInfo = new MeasurementEndpointsHolder (me);
	/*System.out.println ("Delay measurement request between hosts rondomon08 and rondomon09"+
			    " for highPriority and  hosts alpha and beta for highReliability QoS flows"+
			    " launched with measurement period of 60 seconds and averaging window of 190 seconds.");*/
