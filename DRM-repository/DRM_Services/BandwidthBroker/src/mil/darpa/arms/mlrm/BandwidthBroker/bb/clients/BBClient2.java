...
// This class tests the reserve and commit feature of flow requests to the BB
...
public class BBClient2
{
      ...
      try 
	{
	  ...
	  QOSRequired qos = QOSRequired.highPriority;
