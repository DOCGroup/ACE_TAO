...
/**
 * Returns the ifTable Table model.
 ...
 */
public SnmpTableModel getIfTableModel()
  {
//<Begin_getIfTableModel> 
return comm.getTableModel(".1.3.6.1.2.1.2.2");
 ...
 * @return a </code>SnmpTableModel</code> instance.
 */
public SnmpTableModel getIfTableColumnModel(String[] oid)
  {
//<Begin_getIfTableColumnModel_String[]> 
return comm.getColumnModel(oid);
  
//<End_getIfTableColumnModel_String[]>
  } 
