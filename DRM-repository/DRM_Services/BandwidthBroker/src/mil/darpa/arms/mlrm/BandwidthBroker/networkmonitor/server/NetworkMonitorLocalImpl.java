...
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControl;
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControlHelper;
import mil.darpa.arms.mlrm.BandwidthBroker.CommonDef.QOSRequired;
import mil.darpa.arms.mlrm.BandwidthBroker.NetworkMonitorPackage.Latency;
import mil.darpa.arms.mlrm.BandwidthBroker.NetworkMonitorPackage.LatencyBetnFlowEndpoints;
import mil.darpa.arms.mlrm.BandwidthBroker.NetworkMonitorPackage.LatencyBetnHosts;
import mil.darpa.arms.mlrm.BandwidthBroker.NetworkMonitorPackage.LatencyBetnPools;
import mil.darpa.arms.mlrm.BandwidthBroker.NetworkMonitorPackage.LatencyPerQoS;
import mil.darpa.arms.mlrm.BandwidthBroker.NetworkMonitorPackage.MeasurementEndpoints;
...
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControlPackage.ProbeControlException;
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControlPackage.ProbeControlSpec;
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControlPackage.ProbeEndpoints;
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControlPackage.ProbeParameters;
import mil.darpa.arms.mlrm.BandwidthBroker.ProbeControlPackage.ProbeParametersHolder;
import mil.darpa.arms.mlrm.BandwidthBroker.bb.server.NRDB;
import mil.darpa.arms.mlrm.BandwidthBroker.bb.server.db.AttributeValues;
import mil.darpa.arms.mlrm.BandwidthBroker.bb.server.db.CDBException;
import mil.darpa.arms.mlrm.BandwidthBroker.bb.server.db.FlowRecord;
import mil.darpa.arms.mlrm.BandwidthBroker.bb.server.db.NetworkMonitorEventSubscriptions;
import mil.darpa.arms.mlrm.BandwidthBroker.bb.server.db.ObjectList;
import mil.darpa.arms.mlrm.BandwidthBroker.networkmonitor.server.db.Measurement;
...
public class NetworkMonitorLocalImpl 
...
//					      "BandwidthBroker" + 
//					      System.getProperty ("file.separator") + 
	    String bbConfigFile = new String ("/bbconfig.prop");
	   ...
	   */
//	    public NetworkMonitorLocalImpl (String nmConfigFile, String [] args)
	    public NetworkMonitorLocalImpl ()
		       throws NetworkProbesException
	    {
	    	
		    // Use the resource in the jar file - MRC

	    	System.err.println("In Networkmonitorlocalimpl");
			String nmConfigFile = new String("/nmconfig.prop");
		...
		System.err.println("Starting Network Monitor Evictor");
	      ...
	      throws NetworkProbesException
	  {
		...
		PropertyResourceBundle properties=null;
		 try
			...
			properties = new PropertyResourceBundle(getClass().getResourceAsStream(nmConfigFile));
